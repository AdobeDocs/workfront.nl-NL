...
1. Selecteren **Goedkeuringen** in het linkerdeelvenster. Alle bestaande fiatteurs en revisoren worden hier weergegeven.
...
1. Omlaag schuiven naar de **Goedkeuringen** in het deelvenster Documentoverzicht, waarin alle bestaande fiatteurs en revisoren worden weergegeven. Om een fiatteur toe te voegen, zorg ervoor dat **Fiatteur** Selectievakje is ingeschakeld en typ vervolgens in het vak **Revisoren** tekstvak. U kunt Workfront-gebruikers of -teams op naam toevoegen. Als u een controleur wilt toevoegen, schakelt u de optie **Fiatteur** Schakel het selectievakje in voordat u gaat typen.
