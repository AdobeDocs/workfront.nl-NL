...
1. Nadat het document is geüpload, klikt u erop en opent u het deelvenster Documentoverzicht.
...
1. Als u snel revisoren en fiatteurs uit de vorige versie wilt toevoegen, klikt u op de knop Toevoegen naast de namen die hieronder worden vermeld.
   <!--need screenshot when working-->

1. (Optioneel) wijzig de rol van fiatteur/revisor.

1. Om nieuwe fiatteurs en recensenten toe te voegen, klik **Recensent** of **Approver** en begin het typen van de gebruiker of het team.
