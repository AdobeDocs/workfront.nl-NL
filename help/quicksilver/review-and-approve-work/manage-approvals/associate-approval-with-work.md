...
Voor meer algemene informatie over goedkeuringsprocessen raadpleegt u [Overzicht van goedkeuringsproces](../../review-and-approve-work/manage-approvals/approval-process-in-workfront.md).
...
1. Voeg een globaal goedkeuringsproces aan het project, de taak, of de kwestie toe.
   ...
   Zie de sectie [Een algemeen goedkeuringsproces koppelen aan een tijdelijk onderdeel](#associate-a-global-approval-process-with-a-work-item) in dit artikel.
...
1. Klik op een van de volgende pictogrammen in de rechterbovenhoek van de sectie Goedkeuringen, afhankelijk van het type goedkeuring dat aan het item is gekoppeld:
   ...
   * **Verwijderen** pictogram ![](assets/remove-icon---x-in-circle.png) voor algemene goedkeuringen of goedkeuringen op groepsniveau.
   * **Verwijderen** pictogram ![](assets/delete.png) voor goedkeuringen voor eenmalig gebruik.
