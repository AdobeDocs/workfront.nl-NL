...
## Goedkeuringsprocessen voor oudere documenten


Goedkeuringen van oudere documenten worden gebruikt voor een meer algemene goedkeuring. Feedback wordt vastgelegd in chatindeling op het tabblad Updates. Met de goedkeuringsknoppen kunt u wijzigingen goedkeuren, afwijzen of goedkeuren.

Om fiatteurs aan een document toe te voegen nadat het aan Workfront is geupload, zie [ Verzoek om een goedkeuring van het erfenisdocument ](../../review-and-approve-work/manage-approvals/request-document-approvals.md).

>[!NOTE]
>
>Er zijn momenteel verschillende opties voor documentgoedkeuring in Workfront. Voor meer informatie, zie [ Beschikbare functionaliteit voor documentgoedkeuringen ](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md).
