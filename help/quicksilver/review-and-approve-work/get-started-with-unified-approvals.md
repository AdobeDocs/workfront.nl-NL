...
title: Ga aan de slag met de verenigde revisie en goedkeuring
...
* [Overzicht Workspace: Projecten](https://help.frame.io/en/articles/9101001-workspace-overview#h_d9f8654895)
...
* **goedkeuringen voor enig-gebruik**: In het project of de taak waar het middel zich bevindt, kan de projectcoördinator revisoren en fiatteurs toewijzen en een deadline voor voltooiing stellen. Revisoren en fiatteurs worden 72 uur voor de deadline, 24 uur voor de deadline en vervolgens op de deadline zelf per e-mail herinnerd.
...
* **keur** goed: Het element hoeft niet te worden gewijzigd en is klaar voor gebruik.
* **Goedgekeurd met veranderingen**: Het actief is meestal volledig, maar moet enigszins worden gewijzigd voordat het kan worden gebruikt. Nadat de opgegeven wijzigingen zijn aangebracht, is het element gereed en hoeft het niet opnieuw te worden goedgekeurd.
* **het werk van behoeften**: Het element moet worden gewijzigd en is niet gebruiksklaar. Nadat de opgegeven wijzigingen zijn aangebracht, moet het element worden geüpload als een nieuwe versie en moet een nieuwe goedkeuringsronde worden doorlopen. <!--is the same approval workflow automatically applied? Does the coordinator have to do anything to get the approval going? -->
...
* **Eigen dashboard**: Creeer een rapportdashboard in het gebied van de Dashboards van het Canvas om zowel hoog als gedetailleerde informatie over overzichten en goedkeuringen met Verenigde functionaliteit van Goedkeuringen te tonen. Voor informatie over hoe te begonnen worden, zie [ een rapportdashboard voor overzicht en goedkeuringen ](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/create-review-and-approval-dashboard.md) creëren.
