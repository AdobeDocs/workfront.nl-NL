...
description: Met de knop Gereed kunt u automatisch de status van een taak of een uitgave instellen. Standaard markeert Adobe Workfront een taak als Voltooid wanneer een toegewezen persoon op Gereed op het werkitem klikt.
author: Courtney
...
# De knop [!UICONTROL Done] configureren voor taken
...
Gebruikers met bepaalde machtigingen kunnen de knop [!UICONTROL Done] zo configureren dat deze wordt gekoppeld aan bepaalde statussen in het systeem. Er zijn twee verschillende manieren waarop de knop [!UICONTROL Done] werkt voor taken in [!UICONTROL Workfront] :

* Als de gebruiker een toegewezen Home Team heeft, kan een [!DNL Workfront] beheerder of een gebruiker met een [!UICONTROL Plan] licentie de [!UICONTROL Done] knop configureren om bepaalde statussen voor teamleden weer te geven. Zie [ de [!UICONTROL Done] knoop voor een Team ](#configure-the-uicontrol-done-button-for-a-team) in dit artikel vormen.
...
U kunt met de knop [!UICONTROL Done] wijzigen welke status op het werkitem wordt toegepast. U kunt ook meerdere statussen instellen en de gebruiker toestaan te kiezen welke status geschikt is.

{{step1-to-team}}

1. Klik op het pictogram **[!UICONTROL Switch team]** en selecteer vervolgens een nieuw team in de vervolgkeuzelijst of zoek naar een team in de zoekbalk.
...
1. Selecteer in de sectie **[!UICONTROL Organization]** het veld **[!UICONTROL Home Team]** . Typ de naam van het team waarvan u de instellingen aan de gebruikers wilt koppelen. Klik op de naam van het team wanneer u het in de lijst ziet.
