  ...
  <tr> 
   ...
   <td> <p>Schakel deze optie in om het FTP-servercertificaat te verifiëren. Als de verificatie mislukt, wordt er geen verbinding gemaakt. Om voor de verificatie te slagen, moet het certificaat aan een van de volgende criteria voldoen:</p> 
    <ul> 
     ...
     <li>worden ondertekend door een intermediaire certificeringsinstantie (zie bv. <a href="https://knowledge.digicert.com/solution/SO16297.html">Hoe certificaatketens werken</a> voor nadere uitleg). In dit geval moeten alle tussentijdse certificaten op de FTP-server zijn geïnstalleerd.</li> 
