...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Selecteer de sleutel die de verificatiereferenties van uw clientcertificaat bevat of klik op <strong>[!UICONTROL Add]</strong> om uw referenties aan een nieuwe sleutel toe te voegen. </p> <p>Opmerking: U kunt meer geloofsbrieven toevoegen om tussen elke verbinding gemakkelijk te schakelen.</p> </td> 
  </tr> 
  <tr> 
