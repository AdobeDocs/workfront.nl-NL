...
Wanneer u vormt [!UICONTROL HTTP] >[!UICONTROL Make a Basic Authorization request] module, [!DNL Adobe Workfront Fusion] geeft de onderstaande velden weer. Een bolde titel in een module wijst op een vereist gebied.
