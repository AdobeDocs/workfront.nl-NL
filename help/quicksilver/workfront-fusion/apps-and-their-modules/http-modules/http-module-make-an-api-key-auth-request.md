...
Voor informatie over [!UICONTROL Adobe Workfront Fusion] vergunningen, zie [ de vergunningen van de Fusie van Adobe Workfront ](../../../workfront-fusion/get-started/license-automation-vs-integration.md)
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Gebruik deze optie om foutafhandeling in te stellen.</p> <p>Voor meer informatie, zie <a href="../../../workfront-fusion/errors/error-handling.md" class="MCXref xref"> de behandeling van de Fout in de Fusie van Adobe Workfront </a>.</p> </td> 
  </tr> 
  <tr> 
