...
description: Dit [!DNL Adobe Workfront Fusion] actiemodule verzendt een HTTPS-aanvraag naar een opgegeven URL waarvoor een API-sleutelautorisatie is vereist en verwerkt de reactie.
author: Becky
...
Dit [!DNL Adobe Workfront Fusion] actiemodule verzendt een HTTPS-aanvraag naar een opgegeven URL waarvoor een API-sleutelautorisatie is vereist en verwerkt de reactie.
...
Voor informatie over [!UICONTROL Adobe Workfront Fusion] licenties, zie [Adobe Workfront Fusion-licenties](../../../workfront-fusion/get-started/license-automation-vs-integration.md)

## [!UICONTROL HTTP] >[!UICONTROL Make an API Key Authorization request] moduleconfiguratie

Wanneer u vormt [!UICONTROL HTTP] >[!UICONTROL Make an API Key Authorization request] module, [!DNL Adobe Workfront Fusion] geeft de onderstaande velden weer. Een bolde titel in een module wijst op een vereist gebied.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Selecteer de sleutel die uw API-sleutelverificatiereferenties bevat. Als u een nieuwe toets wilt toevoegen, klikt u op <strong>[!UICONTROL Add]</strong> en configureert u de volgende gegevens:</p> 
    <ul> 
  ...
  <tr> 
   ...
   <td> <p>Gebruik deze optie om foutafhandeling in te stellen.</p> <p>Zie voor meer informatie <a href="../../../workfront-fusion/errors/error-handling.md" class="MCXref xref">Foutafhandeling in Adobe Workfront Fusion</a>.</p> </td> 
  </tr> 
  <tr> 
