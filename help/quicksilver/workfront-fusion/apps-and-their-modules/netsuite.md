...
description: In een Adobe Workfront Fusion-scenario kunt u workflows automatiseren die [!DNL NetSuite]en deze verbinding maken met meerdere toepassingen en services van derden.
author: Becky
...
In een [!DNL Adobe Workfront Fusion] scenario, kunt u werkschema&#39;s automatiseren die gebruiken [!DNL NetSuite]en deze verbinding maken met meerdere toepassingen en services van derden.
...
Te gebruiken [!DNL NetSuite] modules, moet u een [!DNL NetSuite] account.



## [!DNL NetSuite] modules en hun velden

Wanneer u [!DNL NetSuite] modules, [!DNL Workfront Fusion] geeft de onderstaande velden weer. Samen met deze [!DNL NetSuite] er worden mogelijk velden weergegeven, afhankelijk van factoren zoals uw toegangsniveau in de app of service. Een bolde titel in een module wijst op een vereist gebied.
...
Deze actiemodule laat u een douane voor authentiek verklaarde vraag aan het maken [!DNL NetSuite] API. Op deze manier kunt u een automatisering van de gegevensstroom maken die niet door de ander kan worden uitgevoerd [!DNL NetSuite] modules.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Voor instructies over het aansluiten van uw [!DNL NetSuite] account aan Workfront Fusion, zie<a href="#create-a-connection-to-netsuite-in-a-workfront-fusion-netsuite-module" class="MCXref xref">Verbinding maken met [!DNL NetSuite] in een Workfront Fusion NetSuite-module</a> in dit artikel.</p> </td> 
  </tr> 
  <tr> 
