...
description: In een [!DNL Adobe Workfront Fusion] scenario, kunt u werkschema's automatiseren die Trello gebruiken, evenals het met veelvoudige derdetoepassingen en de diensten verbinden.
author: Becky
...
In een [!DNL Adobe Workfront Fusion] scenario, kunt u werkschema&#39;s automatiseren die gebruiken [!UICONTROL Trello]en deze verbinding maken met meerdere toepassingen en services van derden.
...
Te gebruiken [!DNL Trello] modules, moet u een [!UICONTROL Trello] account.

## Verbinden [!UICONTROL Trello] tot [!DNL Workfront Fusion]

Voor instructies over het aansluiten van uw [!UICONTROL Trello] account aan [!DNL Workfront Fusion], zie [Verbinding maken met [!DNL Adobe Workfront Fusion] - Basisinstructies](../../workfront-fusion/connections/connect-to-fusion-general.md)

## [!UICONTROL Trello] modules en hun velden

Wanneer u [!UICONTROL Trello] modules, [!DNL Workfront Fusion] geeft de onderstaande velden weer. Samen met deze [!UICONTROL Trello] er worden mogelijk velden weergegeven, afhankelijk van factoren zoals uw toegangsniveau in de app of service. Een bolde titel in een module wijst op een vereist gebied.
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Voor instructies over het aansluiten van uw [!UICONTROL Trello] account aan [!DNL Workfront Fusion], zie <a href="../../workfront-fusion/connections/connect-to-fusion-general.md" class="MCXref xref" data-mc-variable-override="">Verbinding maken met [!DNL Adobe Workfront Fusion] - Basisinstructies</a></p> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>De raden hebben verschillende stem en commentaarregels voor elk toestemmingsniveau. Bijvoorbeeld: als uw raad [!UICONTROL Private] en u stelt de regels voor stemmen en opmerkingen in als [!UICONTROL All], er is een fout opgetreden. </p> <p>Stemmen en opmerkingen zijn beperkt tot de volgende groepen voor elk machtigingsniveau:</p> 
    <ul> 
     <li><strong>[!UICONTROL Private]</strong>: —&gt;Leden, leden en waarnemers</li> 
     <li><strong>[!UICONTROL For organization]</strong>: —&gt;Leden, leden en waarnemers, leden van de organisatie</li> 
     <li><strong>[!UICONTROL Public]</strong>: —&gt;Leden, leden en waarnemers, organisatieleden, alle</li> 
    </ul> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Voting]</p> </td> 
   <td> <p>Selecteer een optie om aan te geven wie op dit bord kan stemmen. Zie de [!UICONTROL Permission level] veld voor stembeperkingen op machtigingsniveaus.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Comments]</p> </td> 
   <td> <p>Selecteer een optie om op te geven wie opmerkingen kan plaatsen op de kaarten voor dit bord. Zie de [!UICONTROL Permission level] veld voor het plaatsen van opmerkingen bij beperkingen op machtigingsniveaus.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selecteer of de teamleden zich bij de raad kunnen aansluiten of zij moeten worden uitgenodigd.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selecteren <strong>[!UICONTROL Yes]</strong> als u kaarthoeken voor het bord wilt inschakelen.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Background]</p> </td> 
   <td> <p>Selecteer de kleur van de achtergrond of de aangepaste achtergrond.</p> <p>Opmerking: Aangepaste achtergronden zijn alleen beschikbaar voor [!UICONTROL Trello Gold and Business Class] abonnees.</p> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>Selecteer een optie tussen twee manieren voor kaartveroudering. </p> 
    <ul> 
     ...
     <li><strong>[!UICONTROL Pirate]</strong>: Kaarten scheuren, geel en kraken als een oude piratenkaart terwijl ze oud zijn.</li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>De unieke sleutel invoeren of toewijzen [!UICONTROL Trello] Id van het bord dat u de module wilt maken. U kunt de kaart-id ophalen met behulp van een andere module, zoals de module Controlebord</p> <p> <img src="assets/watch-boards.png"> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Organization ID]</p> </td> 
   <td> <p>De unieke sleutel invoeren of toewijzen [!UICONTROL Trello] Id van het board dat u de module wilt bewerken. U kunt de kaart-id ophalen met een andere module, zoals de [!DNL Watch Activities] module.</p> <p> <img src="assets/org-id.png"> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p> Als u een aangepaste achtergrond in het dialoogvenster [!UICONTROL Background] Voer de id van de achtergrond die u wilt gebruiken in of wijs deze toe.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Card aging]</p> </td> 
   <td> <p>Selecteer een optie tussen twee manieren voor kaartveroudering. </p> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Typ of wijs de naam (of een deel van de naam) van het bord toe waarover u informatie wilt opvragen.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Maximum number of returned boards]</td> 
   <td> <p> Voer het maximale aantal tekengebieden in [!DNL Workfront Fusion] wordt tijdens één uitvoeringscyclus geretourneerd. Deze waarde moet kleiner zijn dan of gelijk zijn aan 1000.</p>  </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Partial] </p> </td> 
   <td> <p>Standaard zoekt deze module naar lidinhoud voor exacte overeenkomsten van elk woord in uw query. Wanneer [!UICONTROL Partial] wordt toegelaten, zoekt de module inhoud die met om het even welk woord in uw vraag begint.</p> <p> Bijvoorbeeld als u het woord "ontwikkeling"gebruikt om een raad te zoeken getiteld "Mijn Rapport van de Status van de Ontwikkeling,"door gebrek, zou u naar het volledige woord moeten zoeken. Als u [!UICONTROL Partial] Als deze optie is ingeschakeld, kunt u zoeken naar "dev", maar niet naar "development".</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Selecteer het type lid dat u aan de raad wilt toevoegen.</p> 
    <ul> 
     ...
     <li><strong>[!UICONTROL Observer]</strong>: Een waarnemer is lid met alleen-lezen toegang tot de raad. <br>Waarnemers zijn alleen beschikbaar voor teams met [!UICONTROL Trello Business Class].</li> 
    </ul> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id wilt invoeren van de lijst die u wilt kopiëren.</p> 
    <ul> 
     <li> <p><strong>Handmatig invoeren</strong> </p> <p>In de <strong>[!UICONTROL List ID]</strong> Voer de id in van de lijst die u wilt kopiëren.<br></p> </li> 
     <li> <p><strong>Selecteren</strong> </p> <p>Selecteer het bord met de lijst die u wilt kopiëren en selecteer vervolgens de lijst.</p> </li> 
    </ul> </td> 
  </tr> 
 </tbody> 
</table>
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Schakel deze optie in als u het actieve lid wilt abonneren op de lijst.</p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td> <p>Selecteer de locatie die u voor kaarten wilt controleren.</p> 
    <ul> 
     ...
     <li> <p><strong>Kaarten aan specifieke boord</strong> </p> <p>Selecteer de kaart die u wilt controleren voor kaarten</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id wilt invoeren in de lijst waar u een kaart wilt toevoegen.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL List ID]</strong> Voer de id in van de lijst waar u een kaart wilt toevoegen of wijs deze toe.<br></p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Voer voor elk label dat u aan de kaart wilt toevoegen, de id van het label in. De id kan bijvoorbeeld worden opgehaald met de [!UICONTROL Retrieve Labels] module.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Position] </td> 
   <td> <p>Selecteer of u de kaart bovenaan wilt toevoegen of [!UICONTROL append] de kaart onder aan de lijst.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Due date]</td> 
   <td> <p> Voer een vervaldatum in voor de kaart. Voor een lijst met ondersteunde datum- en tijdnotaties raadpleegt u <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref">Afgedwongen typegebruik in [!DNL Adobe Workfront Fusion]</a>.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>Voer gegevens in of wijs deze toe aan een bestand dat u als bijlage aan de kaart wilt toevoegen.</p> 
    <ul> 
     ...
     <p>Opmerking: Voor elke bijlage geldt een uploadlimiet van 10 MB. Maar [!UICONTROL Business Class] en [!UICONTROL Trello Gold] leden hebben een maximale bestandsupload van 250 MB per bijlage.</p> 
     </li> 
    </ul> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id wilt invoeren van de kaart die u wilt kopiëren.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id in van de kaart die u wilt kopiëren.<br></p> </li> 
...
Deze actiemodule bewerkt een bestaande kaart.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id wilt invoeren van de kaart die u wilt bewerken.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id in van de kaart die u wilt bewerken.<br></p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id wilt invoeren van de kaart waarover u gegevens wilt ophalen.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id in van de kaart waarover u gegevens wilt ophalen.<br></p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Voer de zoekquery in. U kunt uw zoekopdracht verfijnen met de volgende zoekoperatoren:</p> 
    <ul> 
     <li><code><strong>-operator</strong></code> <p>U kunt "-" aan om het even welke exploitant toevoegen om een negatieve onderzoek te doen zoals <code>[!UICONTROL -has:members]</code> om te zoeken naar kaarten waaraan geen leden zijn toegewezen.</p> </li> 
     <li><code><strong>@name</strong></code> <p>Keert kaarten terug die aan een lid worden toegewezen. U kunt ook <code>member:</code>. Gebruiken <code>@me</code> om alleen uw kaarten op te nemen.</p> </li> 
     <li><code><strong>#label</strong></code> <p>Retourneert gelabelde kaarten. U kunt ook <code>label:</code>. Bijvoorbeeld: <code>label:"FIX IT"</code> retourneert kaarten met het label "FIX IT".</p> </li> 
     <li><code><strong>board:id</strong></code> <p>Keert kaarten binnen een specifieke raad terug. Bijvoorbeeld: <code>board:Trello</code> retourneert kaarten op borden met [!UICONTROL Trello] in de naam van het bord.</p> </li> 
     <li><code><strong>list:name</strong></code> <p>Retourneert kaarten in de lijst met de naam "name".</p> </li> 
     <li><code><strong>has:attachments</strong></code> <p>Retourneert kaarten met bijlagen. De <code>has</code>: operator kan ook worden gebruikt met andere kenmerken, zoals <code>has:description</code>, <code>has:cover</code>, <code>has:members</code>, of <code>has:stickers</code>.</p> </li> 
     <li><code><strong>due:day</strong></code> <p>Retourneert kaarten die binnen 24 uur verschuldigd zijn. De <code>due:</code> operator kan ook worden gebruikt met andere tijdframes, zoals <code>due:week</code>, <code>due:month</code>, of <code>due:overdue</code>. U kunt ook zoeken naar een specifiek dagbereik. Bijvoorbeeld: toevoegen <code>due:14</code> om te zoeken bevat kaarten die in de komende 14 dagen verschuldigd zijn.</p> </li> 
     <li><code><strong>created:day</strong></code> <p>Retourneert kaarten die in de laatste 24 uur zijn gemaakt. De<code> created:</code> operator kan ook worden gebruikt met andere tijdframes, zoals <code>created:week</code> of <code>created:month</code>. U kunt ook zoeken naar een specifiek dagbereik. Bijvoorbeeld: toevoegen <code>created:14</code> bevat kaarten die in de laatste 14 dagen zijn gemaakt.</p> </li> 
     <li><code><strong>edited:day</strong></code> <p>Retourneert kaarten die in de laatste 24 uur zijn bewerkt. De <code>edited:</code> operator kan ook worden gebruikt met andere tijdframes, zoals <code>edited:week</code> of <code>edited:month</code>. U kunt ook zoeken naar een specifiek dagbereik. Bijvoorbeeld: toevoegen <code>edited:21</code> bevat kaarten die in de laatste 21 dagen zijn bewerkt.</p> </li> 
     ...
     <li><code><strong>is:open</strong> and <strong>is:archived</strong></code> <p>Retourneert kaarten die zijn geopend of gearchiveerd. Als geen van beide is opgegeven, [!UICONTROL Trello] retourneert beide typen.</p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id wilt invoeren van de kaart waarover u gegevens wilt ophalen.</p> 
    <ul> 
     <li> <p><strong>Handmatig invoeren</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id in van de kaart waarover u gegevens wilt ophalen.<br></p> </li> 
     <li> <p><strong>[!UICONTROL Select]</strong> </p> <p>Selecteer het bord met de kaart waarover u gegevens wilt ophalen, selecteer vervolgens de lijst met de kaart en selecteer vervolgens de kaart.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
Zie &quot;[!UICONTROL Assign a Member to a Board]&quot; onder [Borden](#boards).

+++

+++ **[!UICONTROL Unassign a Member from a Board]**

Zie &quot;[!UICONTROL Unassign a Member from a Board]&quot; onder [Borden](#boards).
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Kies hoe u de kaart-id en de lid-id wilt invoeren.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>Voer de <strong>[!UICONTROL Card ID]</strong> en de <strong>[!UICONTROL Member ID]</strong>.</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id van de kaart wilt invoeren waaraan u een controlelijst wilt toevoegen.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id van de kaart in waar u een controlelijst wilt toevoegen.<br></p> </li> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Position] </td> 
   <td> <p>Selecteer of u de controlelijst bovenaan wilt toevoegen of [!UICONTROL append the] checklist onder aan de kaart.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id van de controlelijst wilt invoeren waar u een item wilt toevoegen.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Checklist ID]</strong> Voer de id van de kaart in waar u een controlelijst wilt toevoegen.<br></p> </li> 
  ...
  <tr> 
   ...
   <td> <p>Voer een naam in of wijs een naam toe aan het nieuwe item.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"> <p>[!UICONTROL Position]</p> </td> 
   <td> <p>Selecteer of u het item bovenaan wilt plaatsen of [!UICONTROL append] onder aan de controlelijst.</p> </td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id van de kaart wilt invoeren en checklist waar u een item wilt bewerken.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Checklist ID]</strong> Voer de id van de kaart in waar u een controlelijst wilt toevoegen.</p> <p>In de <strong>[!UICONTROL Checklist Item ID]</strong> , voert u de id van de controlelijst in of wijst u deze toe.</p> </li> 
     <li> <p><strong>[!UICONTROL Select]</strong> </p> <p>Selecteer het bord met de kaart waaraan u een controlelijst wilt toevoegen, selecteer vervolgens de lijst met de kaart, selecteer vervolgens de kaart en selecteer vervolgens de controlelijst.</p> </li> 
    </ul> </td> 
  </tr> 
  <tr> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id van de kaart wilt invoeren waaraan u een controlelijst wilt toevoegen.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id van de kaart in waar u een controlelijst wilt toevoegen. In de<strong>[!UICONTROL Label ID]</strong> voert u de id in van het label dat u wilt toevoegen.<br></p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td role="rowheader">[!UICONTROL Limit] </td> 
   <td> <p>Het maximum aantal opmerkingen [!DNL Workfront Fusion] wordt tijdens één uitvoeringscyclus geretourneerd.</p> </td> 
  </tr> 
 </tbody> 
</table>
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Selecteer hoe u de id van de kaart wilt invoeren waaraan u een opmerking wilt toevoegen.</p> 
    <ul> 
     <li> <p><strong>[!UICONTROL Enter manually]</strong> </p> <p>In de <strong>[!UICONTROL Card ID]</strong> Voer de id van de kaart in waar u een opmerking wilt toevoegen.<br></p> </li> 
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> Voer het maximale aantal opmerkingen in [!DNL Workfront Fusion] wordt tijdens één uitvoeringscyclus geretourneerd.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Since] </td> 
   <td> <p>Stel de begindatum in van de periode waarin de opmerking is gemaakt. Voor een lijst met ondersteunde datum- en tijdnotaties raadpleegt u <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref">Afgedwongen typegebruik in [!DNL Adobe Workfront Fusion]</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader">[!UICONTROL Before] </td> 
   <td> <p>Stel de einddatum in van de periode waarin de opmerking is gemaakt. Voor een lijst met ondersteunde datum- en tijdnotaties raadpleegt u <a href="../../workfront-fusion/mapping/type-coercion.md" class="MCXref xref">Afgedwongen typegebruik in [!DNL Adobe Workfront Fusion]</a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* [Hoe u de id of de snelkoppeling van een kaart kunt vinden in [!DNL Trello]](#how-to-find-the-id-or-the-shortlink-of-a-card-in-trello)
* [Id&#39;s van andere objecten zoeken in [!DNL Trello]](#how-to-find-ids-of-other-objects-in-trello)

### Hoe u de id of de snelkoppeling van een kaart kunt vinden in [!DNL Trello]

Als u een kaart wilt bewerken of een nieuwe opmerking wilt maken, moet u de id van de kaart of de bijbehorende snelkoppeling weten. U kunt deze gegevens ophalen uit de uitvoer van het dialoogvenster [!UICONTROL New Card] trigger. De snelkoppeling voor een kaart kan ook worden verkregen door de kaart te openen en op de [!UICONTROL Share] knop. De snelkoppeling vindt u in het dialoogvenster [!UICONTROL Link to this card] aan het einde van de URL na `https://trello.com/c/`.

![](assets/share-and-more-350x575.png)

### Id&#39;s van andere objecten zoeken in [!DNL Trello]

ID&#39;s voor toetsenbord, lijst en opmerking kunnen alleen worden verkregen met behulp van triggers. De [!DNL trello.com] deze id&#39;s worden niet weergegeven op de website.
