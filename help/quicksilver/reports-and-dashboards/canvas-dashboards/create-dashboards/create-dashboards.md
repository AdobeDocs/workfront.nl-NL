   ...
   <table style="table-layout:auto">
    ...
    <tbody>
     ...
     <tr>
      ...
      <br> de Gebruikers kunnen tussen verschillende munttypes schakelen wanneer het filtreren van het dashboard. Voor meer informatie, zie <a href="/help/quicksilver/reports-and-dashboards/canvas-dashboards/manage-canvas-dashboards/filter-canvas-dashboard.md"> een dashboard door munttype </a> filtreren.</td>
     </tr>
    </tbody>
   </table>
