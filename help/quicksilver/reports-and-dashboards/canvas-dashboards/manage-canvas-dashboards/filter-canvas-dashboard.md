...
U kunt een filter op het dashboard toepassen dat herinneringen __________ bevat
...
1. Volg onderstaande stappen om een vraag toe te voegen:
   ...
   1. Klik **Uitgezochte gebied**, dan specificeer het gebied u _______ wilt.
...
1. Volg onderstaande stappen om een aangepaste prompt toe te voegen:
   ...
   1. Ga ____ in het **gebied van de Waarde van de Optie** in.
