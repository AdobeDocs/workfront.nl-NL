...
title: Een canvasdashboard verwijderen
description: U kunt rangschikken hoe rapporten worden weergegeven in een canvasdashboard nadat ze aan een canvasdashboard zijn toegevoegd.
author: Courtney
...
Als u geen Canvas-dashboard meer nodig hebt, kunt u het verwijderen uit Adobe Workfront.
...
U moet een dashboard maken voordat u het kunt verwijderen.
...
>[!WARNING]
>
> Zodra een dashboard wordt geschrapt, kunnen het dashboard en elk van zijn aangepaste rapporten en/of visualisaties niet worden teruggekregen.<br>
> Als u een dashboard verwijdert dat een klassiek rapport bevat, wordt het klassieke rapport niet verwijderd.

{{step1-to-dashboards}}

1. In het linkerpaneel, klik **de Dashboards van het Canvas**.

1. Op de **pagina van de Dashboards van het Canvas**, selecteer het dashboard u wilt schrappen.

1. In de hoger-juiste hoek, selecteer **Meer** ![ Meer pictogram ](assets/more-icon.png) pictogram, dan selecteer **Dashboard van de Schrapping**.
   ![ Schrap dashboard ](assets/delete-dashboard.png)

1. In het **dashboard van de Schrapping** dialoogvakje, selecteer **ik bevestig ik dit dashboard** checkbox wil schrappen.
