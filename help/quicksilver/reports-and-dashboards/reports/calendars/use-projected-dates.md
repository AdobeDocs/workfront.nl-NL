...
title: Geprojecteerde datums in een kalenderrapport gebruiken
...
# Gebruiken [!UICONTROL Projected Dates] in een kalenderverslag
...
1. Klik op de knop **[!UICONTROL Main Menu]** pictogram ![](assets/main-menu-icon.png) in de rechterbovenhoek van Adobe Workfront klikt u op **[!UICONTROL Calendars]**.
