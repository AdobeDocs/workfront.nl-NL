...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>(Niet-hoofdlettergevoelig) Dit is de niet-hoofdlettergevoelige versie van <strong>contains</strong>. Met "cicontains inf" worden bijvoorbeeld alle waarden vastgelegd die "Inf" of "inf" bevatten.</p> <p> <p>Opmerking: Adobe Workfront zoekt naar het exacte woord of de exacte woordgroep die u opgeeft voor elke filterinstructie. Als u bijvoorbeeld zoekt naar een project dat de uitdrukking "nieuw project" in de naam bevat, geeft Workfront geen projecten weer die alleen "nieuw" of alleen "project" of "nieuw hoofdproject" in de naam hebben. Het filter vindt slechts projecten met de nauwkeurige uitdrukking "nieuw project"in de naam.</p> </p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> <p> </p> </td> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>(Niet-hoofdlettergevoelig) Dit is de niet-hoofdlettergevoelige versie van <strong>niets</strong>.</p> <p>Deze optie kan alleen worden gebruikt in tekstmodusfilters. Zie voor meer informatie over het maken van filters in de tekstmodus <a href="../../../reports-and-dashboards/reports/text-mode/edit-text-mode-in-filter.md" class="MCXref xref">Een filter bewerken in de tekstmodus</a>.</p> </td> 
  </tr> 
  <tr valign="top"> 
   <td> </td> 
  ...
  <tr valign="top"> 
   ...
   <td> <p>(Hoofdlettergevoelig) Hiermee wordt op vergelijkbare wijze gezocht naar delen van een tekstreeks <strong>contains</strong>. Maar <strong>leuk</strong> hiermee kunt u jokertekens invoegen om de tekst te verbreken.</p> <p>Als u bijvoorbeeld zoekt naar notities en "bijvoorbeeld %Current% %Dead%" gebruikt, wordt een notitie geretourneerd met de uitdrukking "Current to Dead" (Huidig om te worden verwijderd). Notities met de tekst "Dead to Current" worden hier niet in opgenomen. Elke waarde wordt doorzocht in de volgorde waarin deze wordt vermeld. Het percentage vertegenwoordigt een jokerteken waarmee tekens of tekstsegmenten worden vervangen.</p> <p>Deze optie kan alleen worden gebruikt in tekstmodusfilters. Zie voor meer informatie over de tekstmodus in filters <a href="../../../reports-and-dashboards/reports/text-mode/edit-text-mode-in-filter.md" class="MCXref xref">Een filter bewerken in de tekstmodus</a>.</p> </td> 
  </tr> 
  <tr valign="top"> 
