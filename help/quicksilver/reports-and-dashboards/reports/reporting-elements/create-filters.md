 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
    ...
    <p>Standaard of Plan om een filter in een rapport te wijzigen</p>
   </td>
  </tr> 
  <tr> 
   <td role="rowheader">Configuraties op toegangsniveau</td> 
   <td> <p>Toegang tot filters, weergaven, groepen bewerken</p> <p>Toegang tot rapporten, dashboards, kalenders bewerken</p>
   </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Objectmachtigingen</td> 
   <td> <p>Rechten voor een filter beheren</p>
   </td> 
  </tr> 
 </tbody> 
</table>
...
1. Klik het **pictogram van de Filter** filter ![&#x200B; om de bouwerinterface te openen.](assets/filter-nwepng.png)
...
1. Klik op het vervolgkeuzemenu met velden om een lijst weer te geven met onlangs gebruikte velden en aanbevolen velden waarop u wilt filteren. De voorgestelde velden worden momenteel weergegeven in de lijst waarop u filtert.
...
1. Klik op de vervolgkeuzelijst met opties om een wijzigingstoets te selecteren. De standaardoptie is &quot;is gelijk aan&quot;.
   ...
   >[!TIP]
   >
   >Terwijl u het filter maakt, worden de resultaten direct in de lijst weergegeven. Als het filterdeelvenster de lijst beslaat, kunt u deze sluiten om de weergave te zien. De informatie die u hebt ingevoerd, blijft in de builder aanwezig wanneer u het deelvenster opnieuw opent.
...
1. Klik het **pictogram van de Filter** ![&#x200B; pictogram van de Filter &#x200B;](assets/filter-nwepng.png) &lbrace;, dan klik het **Meer** pictogram ![&#x200B; Meer pictogram &#x200B;](assets/more-icon.png) en klik **Ga terug naar Verouderde Filters**.
   ...
   >[!TIP]
   >
   >De maker van het rapport moet toestaan dat filters worden bewerkt om de vervolgkeuzelijst Filter in een rapport te kunnen bekijken. Het filter Standaard rapporteren wordt standaard toegepast op een rapport. Het filter Standaard rapporteren kan alleen worden aangepast wanneer u het rapport bewerkt.

1. Klik op **+ Nieuw filter** boven aan de lijst met filters.

   Of

   Plaats over de filter dat u wilt wijzigen en **klikken geeft** pictogram ![&#x200B; uit uitgeven pictogram &#x200B;](assets/edit-icon.png) uit.

   De builder voor het aanpassen van het filter wordt gestart.
