...
# Weergeven: externe URL met aangepast gegevensveld

<!--Audited: 11/2024-->

U kunt een verbinding aan een interne douane URL tonen door a **Berekend Douane Gebied** genoemd &quot;Douane URL&quot;in a **Mening van de Taak te gebruiken**.

Zo kunt u snel vanuit bepaalde objecten een koppeling tot stand brengen met bepaalde onderdelen van de toepassing, rechtstreeks vanuit uw rapporten.
...
Als u toegang hebt om een aangepast formulier te maken, kunt u een berekend aangepast veld maken voor taken met de naam &quot;Aangepaste URL&quot;. Dit gebied verbindt direct met het **Overzicht** subtab binnen de **Details van de Taak** tabel.
...
De taak **Mening** in het voorbeeld toont hieronder het **Berekende Gewas van de Douane** geroepen &quot;Douane URL&quot;als directe verbinding aan het **Overzicht** subtab binnen de taak **Details** lusje, evenals het **URL** gebied van de taak.
...
1. Breid **drop-down van de Mening** bij de bovenkant van uw taaklijst uit.
1. Klik **pas Mening** aan.
...
1. Verwijder de tekst in **geeft de Wijze van de Tekst** vakje uit en vervangt het met de volgende code:
   ...
   In dit voorbeeld wordt &#39;&#39;column.1&#39;&#39; De lijnen tonen de waarde op het gebied van de &quot;Douane URL&quot;als verbinding in het 0&rbrace; Overzicht van de taak **sectie; &quot;column.2.&quot;** toont de waarde die in het **wordt opgeslagen Veld URL** van de taak.
