...
* Projectinformatie weergeven in een indeling met meerdere rijen.\
  ...
  -tag gebruiken om meerdere velden onder dezelfde kolomkop te combineren. Zie voor meer informatie over deze tag [Weergave: gegevens uit meerdere kolommen samenvoegen in één gedeelde kolom](../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-merge-columns.md).
...
1. Maak een nieuwe projectweergave. Ga voor meer informatie over hoe u een nieuwe weergave maakt naar [Overzicht van weergaven in Adobe Workfront](../../../reports-and-dashboards/reports/reporting-elements/views-overview.md).
