...
1. (Facultatief) klik het **pictogram van de Opnieuw laden** ![ pictogram van de Opnieuw laden ](assets/unshimmed-report-refresh-icon.png) om de resultaten in een rapport te verfrissen als het rapport in uw browser voor een tijdje is getoond.
...
* Klik het **pictogram van de Opnieuw laden** ![ pictogram opnieuw laden ](assets/unshimmed-report-refresh-icon.png)
