...
* U kunt maximaal 10 herhaalde rapportleveringen voor een bepaald rapport plannen.
* U kunt een rapport alleen plannen om te worden geleverd als u de maker van het rapport bent. Als u een rapport moet verzenden dat u niet hebt gemaakt, kunt u het handmatig verzenden.

## Exportlimieten

Er zijn verschillende groottelimieten die van invloed zijn op de manier waarop rapporten worden weergegeven in Workfront en hoe ze worden geëxporteerd via een handmatige export, een geleverd rapport of de API:

* **10MB dossiergrootte:** de groottelimiet van het Dossier voor om het even welk uitgevoerd rapport dat voor levering wordt gepland. Als een geëxporteerd bestand dat is gekoppeld aan een e-mailbericht groter is dan 5 MB, wordt een koppeling naar het bestand dat kan worden gedownload per e-mail verzonden in plaats van het bijgevoegde geëxporteerde rapport.
