...
1. Vervang **naam van het 0&rbrace; inzamelingsvoorwerp &lbrace;met de naam van uw inzamelingsvoorwerp in de** lijn, aangezien het in `listmethod` API Ontdekkingsreiziger [&#x200B; verschijnt.](../../../wf-api/general/api-explorer.md)
