...
description: Rapporten geven inzicht in wat er gebeurt met gebruikers en werken. Met rapporten kunt u informatie over objecten weergeven in Adobe Workfront.
author: Courtney
...
Rapporten geven inzicht in wat er gebeurt met gebruikers en werken. Met rapporten kunt u informatie over objecten weergeven in Adobe Workfront.
...
* U moet één object definiëren waarover u wilt rapporteren. Rapporten zijn objectspecifiek in Workfront en u moet eerst een objecttype selecteren voordat u kunt beginnen met het samenstellen van het rapport. U kunt alleen rapporteren over objecten die beschikbaar zijn in de Workfront-interface.

### Eigendom rapporteren {#report-ownership}

Wanneer u een rapport maakt in Workfront, wordt u de standaardeigenaar van het rapport en wordt het weergegeven in de sectie Mijn rapporten. U kunt de eigenaar van een rapport niet wijzigen.
...
Wij adviseren dat u de interface van het rapportgebouw eerst gebruikt om een nieuw rapport te bouwen. De interface biedt een gestroomlijnde set tools waarmee je elementen samenstelt om het gewenste rapport te maken. U hebt objecten en velden die u kunt selecteren in lijsten en toevoegen aan alle rapportelementen.\
...
### Rapporten maken in tekstmodus {#create-reports-in-text-mode}
...
### Tabblad Matrix {#matrix-tab}

Rapporten met een matrixgroepering hebben een tabblad Matrix.

Dezelfde informatie die op het tabblad Details wordt weergegeven in de vorm van een lijst, wordt weergegeven in een tabelindeling, gegroepeerd op de groepen in het rapport op het tabblad Matrix.
...
Overweeg een grafiek in je rapporten op te nemen voor invloedrijke dashboards voor je managers. Grafieken zijn een beknopte manier om de informatie in een rapport weer te geven. U kunt een diagramelement uitbreiden door erop te klikken om de punten te tonen inbegrepen in dat element.
...
>Bijvoorbeeld, voltooide een gebruiker in Californië een taak bij 9 :30 pm PST op 12 Februari. Wanneer een gebruiker in New York een rapport bekijkt dat deze taakvoltooiing omvat, toont de Ware Datum van de Voltooiing als 13 Februari in zowel het lusje van Details als de details van de Grafiek omdat het om 12 :30 am EST op 13 Februari werd voltooid. Nochtans, in de grafiek, is het inbegrepen in de 12 Februari groepering tot u het grafiekelement uitbreidt.
...
U kunt een andere gebruiker toestemming geven om een rapport dat u maakt, weer te geven of te beheren. U kunt een andere gebruiker een machtigingsniveau geven dat gelijk is aan of lager is dan dat van u. U kunt een rapport ook openbaar maken met behulp van deelmachtigingen. Voor informatie over het delen van een rapport, zie [&#x200B; Deel een rapport in Adobe Workfront &#x200B;](../../../reports-and-dashboards/reports/creating-and-managing-reports/share-report.md).

### Een rapportlevering plannen {#schedule-a-report-delivery}

U kunt een rapport voor levering plannen. De gebruikers met wie u het rapport deelt, ontvangen een e-mail met een bijlage van de rapportresultaten. De bijlage kan de volgende notaties hebben:
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td>Een Bean vertegenwoordigt een herbruikbaar-programmeringselement. De term Bean identificeert relaties tussen verschillende objecten in de Workfront-toepassing. Het is belangrijk dat u bekend bent met deze relaties wanneer u aanvullende kenmerken over een object probeert weer te geven die niet beschikbaar zijn in de standaardrapportagetools.</td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td>Camel Case</td> 
   <td> <p>Camel Case verwijst naar een specifieke manier om programmeringselementen aan koord samen te schrijven multi-word attributen. Wanneer u een kenmerk in Camel Case spelt, is de eerste letter van het eerste woord kleine letters, er is geen ruimte tussen de woorden en de eerste letter van elk volgend woord is hoofdletters.</p> <p>Bijvoorbeeld, zou de Groep van het Huis als <em> homeGroup </em> worden geschreven, zou de Pool van het Middel <em> resourcePool </em> zijn, en de Ware Datum van het Begin zou <em> actualStartDate </em> zijn.</p> </td> 
  </tr> 
  <tr> 
   <td>Diagram</td> 
   <td> <p>Een tabblad in de rapportbuilder, een rapporttabblad, nadat u het rapport hebt opgeslagen, en een optioneel element van een rapport waarmee u een grafiek aan een willekeurig rapport kunt toevoegen. U moet een Groepering in het rapport definiëren voordat u een grafiek kunt maken.</p> <p>De volgende diagramtypen kunnen aan elk rapport worden toegevoegd:<br></p> 
    <ul> 
     <li>Kolom</li> 
     <li>Balk</li> 
     <li>Schijf</li> 
  ...
  <tr> 
   <td>Expressie</td> 
   <td>Een expressie is een geschreven formule in Tekstmodus om informatie over te brengen waarnaar moet worden gezocht of die moet worden weergegeven wanneer de tekstmodus-interface wordt gebruikt. Het is doorgaans één regel in een grotere instructie Tekstmodus.</td> 
  </tr> 
  <tr> 
   <td>Velden</td> 
   <td> <p>Verwijst naar de kenmerken van uw objecten. 'Status' is bijvoorbeeld een veld voor projecten, taken of problemen. "Portfolio Manager" is een veld voor het object Portfolio.</p> <p>U kunt ook aangepaste velden hebben die u zelf maakt en aan aangepaste formulieren toevoegt.<br> voor informatie over het creëren van douaneformulieren, zie het artikel <a href="/help/quicksilver/administration-and-setup/customize-workfront/create-manage-custom-forms/form-designer/design-a-form/design-a-form.md"> een douaneformulier </a> creëren.</p> </td> 
  </tr> 
  <tr> 
   <td>Veldnaam </td> 
  ...
  <tr> 
   <td>Rapport </td> 
   <td>De combinatie van een weergave, een filter en (soms) een groep. Het doel van een rapport is gegevens constant over de interface te tonen, informatie te verdelen, en de behoefte te elimineren om het zelfde onderzoek of de vraag op een regelmatige basis in werking te stellen.</td> 
  </tr> 
  <tr> 
   <td>Instructie</td> 
   <td>Bestaat uit verschillende expressies die zijn samengesteld om te bepalen welke informatie wordt weergegeven in een rapport wanneer Tekstmodus wordt gebruikt. Een verklaring kan voor een mening, filter, groepering, of voor een Herinnering van de Douane in een rapport worden gecreeerd.</td> 
  </tr> 
  <tr> 
   <td>Samenvatting</td> 
   <td>Dit is één van de lusjes van een rapport, nadat u sparen het rapport. Dit lusje wordt gecreeerd slechts wanneer u het groeperen voor het rapport bepaalt. Het vat informatie samen die op de groepering wordt gebaseerd die tijdens rapportverwezenlijking wordt bepaald en geeft een snel overzicht van de bijeengevoegde voorwerpen van het rapport. Niet elk object in het rapport wordt weergegeven, alleen de objecten die worden samengevoegd.</td> 
  </tr> 
  <tr> 
   <td>Tekstmodusinterface</td> 
   <td>Biedt de mogelijkheid om de code van aangepaste weergaven, filters, groepen en aanwijzingen te maken of te wijzigen die oorspronkelijk zijn gemaakt via de Builder-interface. Voorgesteld wordt dat rapportelementen eerst worden gemaakt via de Builder-interface en vervolgens worden omgezet in de tekstmodus nadat deze zijn opgeslagen om de codering van geavanceerde weergaven, filters, groeperingen of aanwijzingen te vereenvoudigen.</td> 
  </tr> 
  <tr> 
   <td>Gebruikersinterface (UI)</td> 
   <td>Verwijst naar de componenten of bouwstenen van wat op het scherm van een gebruiker op een bepaald ogenblik toont.</td> 
  </tr> 
  <tr> 
