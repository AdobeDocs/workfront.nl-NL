---
title: Vorm een KPI visualisatie in het Melden van Canvas
description: Vorm een KPI visualisatie in het Melden van Canvas
author: Nolan
...
# Vorm een KPI visualisatie in het Melden van Canvas

Een KPI-visualisatie (Key Performance Indicator) kan u helpen de huidige prestaties van uw organisatie in één oogopslag over te brengen.
...
## Een KPI-visualisatie configureren

>[!TIP]
>
>Al uw veranderingen worden automatisch bewaard aangezien u de blokken in uw rapport bouwt en uitgeeft.

1. Beginnen met het toevoegen van een visualisatieblok met de **KPI** visualisatietype naar een rapport, zoals wordt uitgelegd in [Een visualisatieblok toevoegen of bewerken in Rapportcanvas](../../../reports-and-dashboards/reporting-canvas/visualization-blocks/add-or-edit-report-visualization.md).
   ...
   1. Op de **Instellingen** tab:
      ...
      <table style="table-layout:auto">
       ...
       <tbody>
        ...
        <tr>
         <td role="rowheader">Bronveld</td>
         <td>Selecteer de gegevens die u wilt weergeven in de visualisatie.</td>
        </tr>
        <tr>
         <td role="rowheader">Type aggregatie</td>
         <td><p> Geef aan hoe de waarden moeten worden samengevat:</p>
          <ul>
           ...
           <li><p>Maximum: alleen de hoogste waarde</p></li>
          </ul></td>
        </tr>
       </tbody>
      </table>
