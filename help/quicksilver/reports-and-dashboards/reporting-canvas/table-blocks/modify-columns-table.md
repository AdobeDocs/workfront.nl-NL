...
1. (Optioneel) Voeg kolommen aan de tabel toe, verplaats deze of verwijder deze. Voor meer informatie over het bewerken van de velden in een tabel raadpleegt u [Een tabelblok toevoegen of bewerken in het rapportcanvas](../../../reports-and-dashboards/reporting-canvas/table-blocks/add-or-edit-report-table.md)

   | Een nieuwe kolom toevoegen | Als u een kolom aan een tabel wilt toevoegen, klikt u op een veld en sleept u het veld van het gereedschap **Velden** rechts van de pagina op de tabel waar u de pagina wilt plaatsen of dubbelklik op een veld om de pagina toe te voegen als de rechterkolom. |
   |---|---|
