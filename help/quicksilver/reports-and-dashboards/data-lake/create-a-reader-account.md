...
1. Kies een verificatiemethode voor de verbinding:
   ...
   * [Programmatische Token van de Toegang authentificatie](#programmatic-access-token-authentication)
   * [RSA-sleutelverificatie](#rsa-key-authentication)

### Wachtwoordverificatie

1. Klik **Wachtwoord**, dan **produceer Verbinding**.
...
### Programmatische Token van de Toegang authentificatie

1. Klik **Token van de Toegang Programmatic**.

1. Ga een vervaldatum voor uw teken op het **gebied van de Vervaldatum** in. U kunt een vervaldatum kiezen die in de toekomst maximaal 365 dagen kan duren.

1. Klik **produceren Verbinding**.
...
1. Ga een openbare sleutel van RSA op het **Openbare Zeer belangrijke** gebied van RSA in.

1. Klik **produceren Verbinding**.

1. Er wordt een verbinding gegenereerd en de URL van de Snowflake-omgeving wordt opgegeven. U kunt de RSA sleutel en de gebruikersbenaming gebruiken u om met Snowflake van uw derdevisualisatiehulpmiddel of gegevensverwerker te verbinden.



U moet de sleutel van RSA met de gebruikersbenaming gebruiken u verkoos om binnen aan Snowflake te ondertekenen, zodat houdt u een verslag van het evenals URL bij. Controleer de doos die u verklaart dit hebt gedaan, dan klik **dicht**.

    ![de zeer belangrijke dialoog van RSA] (Assets/rsa-test.png) 
