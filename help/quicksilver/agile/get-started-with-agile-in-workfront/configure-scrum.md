...
description: U kunt de volgende opties configureren voor Scrum Agile-teams tijdens of na het maken van het team.
author: Courtney
feature: Agile
...
U kunt een team van de Groot in [!DNL Adobe Workfront] tot stand brengen zoals die in [&#x200B; wordt beschreven leidt tot een Agile team &#x200B;](/help/quicksilver/agile/get-started-with-agile-in-workfront/create-an-agile-team.md). Tijdens het creëren van een Agile-team kun je de methodologie kiezen die het team gebruikt om hun werk te voltooien. U kunt uit de volgende opties kiezen:

* Scrum
* Kanban

In dit artikel wordt beschreven hoe u de instellingen voor een Scrum-team configureert. Nadat u een Agile-team hebt gemaakt en de Scrum-methodologie hebt gekozen, kunt u naar dit artikel verwijzen om de volgende instellingen bij te werken:

* Hiermee wordt bepaald of verhalen in punten of uren worden geschat
* De statuskolommen op de whitelist voor iteraties en projecten
* Aanvullende velden die moeten worden weergegeven op artikelkaarten op het Angile-artikelbord
* Kleurindicatoren gebruiken voor artikelen op het Angile-artikelbord
...
U kunt als volgt de statussen definiëren die beschikbaar zijn voor het artikelbord dat is gekoppeld aan het team van Agile:

{{step1-to-team}}

1. Klik het **[!UICONTROL Switch team]** pictogram ![&#x200B; het teampictogram van de Schakelaar &#x200B;](assets/switch-team-icon.png), dan of selecteer een nieuw team van het drop-down menu of onderzoek naar een team in de onderzoeksbar.

1. Selecteer het Agile-team dat u wilt beheren.
1. Klik op het menu **[!UICONTROL More]** en selecteer vervolgens **[!UICONTROL Edit]** .

   Alleen teamleden met een [!UICONTROL Plan] - of [!UICONTROL Work] -licentie zien deze optie.
...
### Configureer statuskolommen voor projecten {#configure-status-columns-for-projects}

Voor informatie over hoe te om statuskolommen voor een project te vormen, zie de sectie [&#x200B; creeer of pas een [!UICONTROL Agile] mening &#x200B;](../../reports-and-dashboards/reports/reporting-elements/create-edit-views.md#customizing-an-agile-view) in het artikel [&#x200B; toe of geef meningen in  [!DNL Adobe Workfront]](../../reports-and-dashboards/reports/reporting-elements/create-edit-views.md) uit.

## Aanvullende velden configureren voor weergave op artikelkaarten op het Angile-artikelbord

Als u velden toevoegt aan artikelkaarten, zijn velden alleen-weergeven en alleen-weergeven als het veld is gevuld.

Standaard worden de volgende gegevenstypen op de artikelkaart weergegeven voor taken en problemen:

* Artikelnaam met een koppeling die rechtstreeks naar de taak of uitgave verwijst
* De projectnaam met een koppeling rechtstreeks naar het project
...
* Het volledige percentage weergeven en bewerken door het percentage aan te passen dat is voltooid of door het aantal punten of uren aan te passen dat is voltooid
...
>[!NOTE]
>
>Als u een aangepast veld op een artikelkaart gebruikt, mag dit geen punt of punt in de naam bevatten.

U kunt als volgt artikelkaarten configureren die aan het team van Agile zijn toegewezen om extra velden weer te geven:
