...
1. In de [!UICONTROL Agile] sectie, in [!UICONTROL **wanneer een Punt van het Werk aan een gebied van de Herhaling {wordt toegevoegd, selecteer van de volgende opties:**]
