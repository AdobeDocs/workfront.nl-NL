...
1. Toegang tot een board. Voor informatie, zie [&#x200B; creeer of geef een board &#x200B;](../../agile/get-started-with-boards/create-edit-board.md) uit.
...
1. Kies een project en kies vervolgens een taak of uitgave die u als kaart aan de kaart wilt toevoegen.
   ...
   >[!NOTE]
   >
   >* Alleen objecten waarvoor u machtigingen hebt, zijn beschikbaar in de zoekresultaten. Als een item grijs wordt weergegeven, is het al aan het board toegevoegd.
   >* Wanneer u filtert op **[!UICONTROL Projects I Own]** of **[!UICONTROL Projects I'm On]** , worden projecten die overeenkomen met de status Voltooid, Dode of Afgewezen niet in de selectie opgenomen. U kunt nog steeds naar die projecten zoeken met het filter **[!UICONTROL All]** .

1. Klik op **[!UICONTROL Add]**.

   ![&#x200B; Onderzoek naar taak of kwestie om te verbinden &#x200B;](assets/boards-tasksissues-350x94.png)
...
>
>Als u een aangesloten kaart loskoppelt van een ander boardtype dat een inlaatkolom heeft, verschijnt de kaart opnieuw in de inlaatkolom wanneer u het board vernieuwt als de verbonden taak of uitgave nog niet is gemarkeerd als voltooid.
>
>In beide scenario&#39;s beschikt u na een vernieuwingsbewerking over twee kaarten voor dezelfde taak of uitgave: een ad-hockaart en een aangesloten kaart.

Een kaart op het niveau van het board loskoppelen:
...
1. Open het board en open de aangesloten kaart.
1. Klik het **[!UICONTROL More]** menu ![&#x200B; Meer menu &#x200B;](assets/more-icon-spectrum.png) in het gebied van de Verbinding van de kaartdetails, en selecteer **[!UICONTROL Disconnect]**.
1. Klik op **[!UICONTROL Disconnect]** in het bevestigingsbericht.

## Een ad-hockaart omzetten in een aangesloten kaart
...
1. Zoek naar en selecteer een project om de taak of kwestie aan toe te voegen.
   ...
   >* Wanneer u filtert op **[!UICONTROL Projects I Own]** of **[!UICONTROL Projects I'm On]** , worden projecten die overeenkomen met een status [!UICONTROL Complete] , [!UICONTROL Dead] of [!UICONTROL Rejected] niet opgenomen. U kunt nog steeds naar die projecten zoeken met het filter **[!UICONTROL All]** .
...
1. Klik op **[!UICONTROL Close]** om terug te gaan naar het board.

## Uren vastleggen op een aangesloten kaart

U moet over de juiste machtigingen beschikken om de uren te registreren voor de verbonden taak of uitgave.

De velden voor tijdregistratie worden standaard niet weergegeven op verbonden kaarten. U moet [!UICONTROL **Uren**] op het [!UICONTROL Configure] gebied onder [!UICONTROL Cards] toelaten. Voor meer informatie, zie [&#x200B; aanpassen welke gebieden op een kaart &#x200B;](/help/quicksilver/agile/get-started-with-boards/customize-fields-on-card.md) worden getoond.
