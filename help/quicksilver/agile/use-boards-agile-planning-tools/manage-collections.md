...
1. Typ een naam die u wilt vervangen **[!UICONTROL Untitled Workstream]** en druk op Enter.
   ...
   U kunt borden aan de werkstroom toevoegen of [!UICONTROL **klikken Alle Borden**] om aan het dashboard terug te keren.
...
1. Klik het [!UICONTROL **Borden**] lusje als het niet reeds wordt getoond.
