...
description: Herhalingen vormen een sleutelcomponent voor teams van de Groep van de Trommel bij het plannen van het werkcapaciteit. [!DNL Adobe Workfront]  staat de teams van de Groep van de Trommel toe om hun werk te beheren door veelvoudige herhalingen te creëren om teambehoeften aan te passen.
author: Jenny
feature: Agile
...
Herhalingen vormen een sleutelcomponent voor teams van de Groep van de Trommel bij het plannen van het werkcapaciteit. Met [!DNL Adobe Workfront] kunnen teams van Scrum Agile hun werk beheren door meerdere versies te maken die aan de teambehoeften voldoen.
   ...
   <table style="table-layout:auto">
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td><p>Voer de datum in waarop de herhaling moet worden beëindigd. [!DNL Workfront] raadt u aan een einddatum in te stellen die niet langer mag zijn dan 4 weken na de begindatum.</p><p>Tip: kies een werkdag als einddatum. In de uitbouwgrafiek worden slechts werkdagen gebruikt voor de berekeningen.<br> door gebrek, gebruikt het burndown diagram het standaardprogramma om werkdagen (zoals die in <a href="../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/create-schedules.md" class="MCXref xref"> worden beschreven leidt tot een programma </a>) te bepalen. Of, om team-specifieke niet-het werk dagen op te nemen, kunnen de teams van de Gelijkheid verkiezen om een afwisselend programma te gebruiken (zoals die in "het Bepalen van een Afwisselend Programma van het Team voor Grafieken"in <a href="../../../agile/get-started-with-agile-in-workfront/create-an-agile-team.md" class="MCXref xref"> wordt beschreven leidt tot een team van de Gelijkheid </a>).</p></td> 
     </tr> 
     <tr> 
...
1. Geef de volgende informatie op:
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      <td role="rowheader"><strong>[!UICONTROL End Date]</strong> </td> 
      <td><p>Geef de datum op waarop de herhaling moet worden beëindigd. [!DNL Workfront] raadt u aan een einddatum in te stellen die niet langer mag zijn dan 4 weken na de begindatum.</p><p>Tip: kies een werkdag als einddatum. In de uitbouwgrafiek worden slechts werkdagen gebruikt voor de berekeningen.<br> door gebrek, gebruikt het burndown diagram het standaardprogramma om werkdagen (zoals die in <a href="../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/create-schedules.md" class="MCXref xref"> worden beschreven leidt tot een programma </a>) te bepalen. Of, om team-specifieke niet-het werk dagen op te nemen, kunnen de teams van de Gelijkheid verkiezen om een afwisselend programma (zoals die in <a href="../../../agile/use-scrum-in-an-agile-team/burndown/use-alt-team-schedule-burndown-charts.md" class="MCXref xref"> wordt beschreven Gebruik een afwisselend teamprogramma voor burndown grafieken </a>) te gebruiken.</p></td> 
     </tr> 
     <tr> 
      <td role="rowheader"><strong>[!UICONTROL Focus]</strong></td> 
