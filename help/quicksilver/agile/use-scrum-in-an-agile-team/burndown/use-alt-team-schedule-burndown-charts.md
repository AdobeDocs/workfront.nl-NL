...
Door gebrek, gebruikt de burndown grafiek het standaardprogramma. Naast het standaardschema, kunnen de teams van de Gelijkheid verkiezen om een afwisselend programma ook te gebruiken om team-specifieke niet-werkdagen op te nemen. Dit afwisselende programma wordt dan weerspiegeld in de burndown grafiek van om het even welke herhaling die aan het team wordt toegewezen. Het afwisselende programma beïnvloedt slechts de burndown grafiek. (Voor meer informatie over het standaardprogramma, evenals hoe de [!DNL Workfront] beheerder een team-specifiek programma kan tot stand brengen, zie [&#x200B; een programma &#x200B;](../../../administration-and-setup/set-up-workfront/configure-timesheets-schedules/create-schedules.md) creëren.)
