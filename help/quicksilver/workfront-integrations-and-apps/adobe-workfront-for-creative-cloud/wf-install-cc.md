...
1. Verwijder de map waarin het domein voor de plug-in is opgeslagen.
   ...
   >[!TIP]
   >
   >Voor Mac, ga naar Vinder, druk **Command+Shift+.** om verborgen omslagen te tonen, navigeer aan **/Users/username/Library/Application Support**, dan schrap de **Workfront** omslag. U moet `username` vervangen door uw Mac-gebruikersnaam.
