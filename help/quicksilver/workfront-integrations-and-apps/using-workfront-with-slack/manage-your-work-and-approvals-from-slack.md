...
Goedkeuringen verwijzen naar goedkeuringen van oudere documenten. Goedkeuringen van Unified Document worden momenteel niet ondersteund in [!DNL Microsoft Teams] . Voor meer informatie over de verschillende goedkeuringssystemen in Workfront, zie [ Beschikbare functionaliteit voor documentgoedkeuringen ](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md).
