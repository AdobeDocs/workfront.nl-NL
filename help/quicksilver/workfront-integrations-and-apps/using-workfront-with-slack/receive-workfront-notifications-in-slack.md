...
1. Standaard zijn alle meldingen ingeschakeld.\
   ...
   * [!UICONTROL I receive a new approval or access request]
     ...
     >[!NOTE]
     >
     >Goedkeuringen verwijzen naar goedkeuringen van oudere documenten. Goedkeuringen van Unified Document worden momenteel niet ondersteund in [!DNL Slack] . Voor meer informatie over de verschillende goedkeuringssystemen in Workfront, zie [&#x200B; Beschikbare functionaliteit voor documentgoedkeuringen &#x200B;](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md).
