...
title: Filter, Groep en Sorteer uw werk met Prioriteiten
...
# Filter, groepeer en sorteer uw werk met Prioriteiten
...
1. Klik **Groepering** in de hoogste linkerzijde van de werklijst.
...
1. Groepeer uw werk door **Status** of **Mijn Focus**.
...
Om uw werk binnen een groepering te sorteren, open **Groepering** en selecteer als u in het stijgen of dalende orde wilt sorteren.

![&#x200B; Soort in groeperingen &#x200B;](assets/sort-in-groups.png)
...
Om alle groepssecties uit te breiden of samen te vouwen, open **Groep** en klik **breid allen** uit als de groeperingen worden doen ineenstorten of **allen** samenvouwen als de groeperingen worden uitgebreid.
