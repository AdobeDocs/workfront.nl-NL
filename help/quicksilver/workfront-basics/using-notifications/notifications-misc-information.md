...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>De Naam van het project <br> Naam van de Naam van Portfolio 1&rbrace; het Aantal van de Verwijzing van het Project <br> Naam van de gebruiker die de persoon aan het project <br> Naam van de gebruiker toevoegde die aan het project <br> <br> Project [!UICONTROL Planned Start Date]<br> volledig [!UICONTROL Planned Completion Date]<br> Namen van anderen op de Status van het Project <br> van het Project {<br> knoop van de Eigenaar van het Project 10} werd toegevoegd<br><br><strong>[!UICONTROL See More Details]</strong><br><br><br></p> </td> 
   <td><strong> Onmiddellijk </strong> </td> 
  </tr> 
  <tr> 
