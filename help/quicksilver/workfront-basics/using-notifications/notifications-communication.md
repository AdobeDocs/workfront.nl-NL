...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> De Naam van objecten waar de update <br> Namen van het Aantal van de Verwijzing van 1} Voorwerp van de Naam van het Voorwerp <br> van alle gebruikers en teams inbegrepen in de geleide update <br> Datum en Tijd werd gemaakt <br> Tekst van geleide update <br> knoop <br><strong>[!UICONTROL Comment]</strong>*Totaal aantal ontvangen commentaren <br>*Aantal commentaren voor elk voorwerp <br>* <br> knoop <strong>[!UICONTROL See All Notifications]</strong>*Datum van de dagelijkse samenvatting<br><br></td> 
