...
title: Overzicht van Experience Cloud-berichten
description: Adobe Workfront heeft alle DX-producten (Digital Experience) samengevoegd via één consistent meldingssysteem, de zogenaamde Experience Cloud Notifications.
author: Courtney
...
Workfront maakt deel uit van de Adobe-suite met producten voor digitale beleving. De overstap naar Experience Cloud biedt verschillende voordelen, waaronder de volgende:

* Ervaring met Unified Meldingen: u kunt nu één interface ervaren die op alle Adobe DX-oplossingen werkt.
* Door op de hoogte te blijven: het verenigen van meldingen op één plaats vermindert het risico dat meldingen ontbreken.
* Minder gecompliceerde interface: Het hebben van één pictogram van Meldingen vermindert verwarring en verwijdert de behoefte om tussen berichtsecties af te wisselen.
* Platform voor de toekomst: hiermee wordt uw organisatie voorbereid op zowel huidige als toekomstige innovatie in Adobe-tools.
...
* U ontvangt meldingen in de app tijdens de eerste fase van de overgang en vervolgens zowel in-app- als e-mailmeldingen later.

* Bestaande meldingsvoorkeuren worden automatisch overgedragen.
...
1. (Facultatief) om alle berichten te merken zoals gelezen, klik **allen als gelezen** bij de bodem van het paneel.

1. (Facultatief) om alle berichten voor uw rekening te bekijken, klik **Mening allen** bij de bodem van het paneel, dat **opent Alle berichten** pagina.

1. Klik buiten het deelvenster om het te sluiten.

## Je Workfront-meldingsinstellingen bewerken
...
+++Zullen mijn bestaande meldingen verloren gaan?

Nee. Je historische berichten blijven toegankelijk in Workfront, maar nieuwe berichten worden verzonden via Experience Cloud zodra de overgang is voltooid.
+++
