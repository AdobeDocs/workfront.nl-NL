...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> De Naam van objecten waar het document <br> Aantal van de Verwijzing van het 1} Bovenliggende Voorwerp {van het Document <br> Naam van het Document van de gebruiker werd geupload die de 3} Naam van het Document <br> op Datum <br> Toegevoegde Details van het Document (formaat, grootte, Aantal van de Versie) <br> duimnagel van het Document <br> en <br> knopen <br><strong>[!UICONTROL Preview]</strong>*Aantal van de Verwijzing van het Project <strong>[!UICONTROL Download]</strong>*Totaal aantal geüploade documenten <br>*Naam van document <br>*De Naam van het Voorwerp van de ouder <br>*Naam van de gebruiker die het document <br>*Datum van de dagelijkse samenvatting toevoegde<br><br><br> </td> 
  ...
  <tr> 
   ...
   <td> De Naam van het StandaardProject van de taak <br> Naam van het Project (Persoonlijk Project van de gebruiker die de persoonlijke taak ontving) <br> Aantal van de Taakverwijzing <br> Naam van de Taakeigenaar <br> Nieuwe Datum en Tijd van de Taak toen de taak <br> Vorige Status van de Taak <br> knoop werd voltooid<br><strong>[!UICONTROL See More Details]</strong><br><br><br></td> 
   <td><strong> Onmiddellijk </strong> </td> 
  </tr> 
  <tr> 
   ...
   <td> De Naam van het project van de kwestie <br> Naam van de Verwijzing van 1} Uitgave <br> Naam van de gebruiker die de kwestie <br> Nieuwe Status <br> Datum en Tijd voltooide toen de kwestie <br> Vorige Status van de Uitgave <br> knoop <br><strong>[!UICONTROL See More Details]</strong>*De Naam van het Project <br> * Aantal van de Verwijzing van het Project <br>*Totaal aantal voltooide kwesties <br>*Naam van de Uitgave <br>*Naam van de gebruiker die de gebruiker voltooide die de Uitgave van de Uitgave  Uitgave van de Uitgave van de gebruiker {1Status {11Naam {11111111111}  knoop  knoop   <br>  knoop <br>  12}*Datum van de dagelijkse samenvatting </td> 
   <td><strong> Onmiddellijk </strong> </td> 
  </tr> 
  <tr> 
   ...
   <td> De Naam van het project <br> Naam van Portfolio <br> Verwijzing van de Uitgave Uw Naam van de Naam <br> Uitgave <br> Datum ingegaan <br> Prioriteit van de Uitgave <br> Toegewezen aan Naam <br> Primaire Contact <br> * Naam van het Project <br>*Aantal van de Verwijzing van het Project <br>*Totaal aantal toegevoegde kwesties <br>*Naam van de Uitgave <br>*Datum van dagelijks overzicht<br><br> </td> 
  ...
  <tr> 
   ...
   <td> <p>De Naam van het project (de Naam van de Rij van het Verzoek) <br> Naam van de Verwijzing van Portfolio <br> de Naam van de Uitgave <br> Gegane Datum van de Uitgave <br> Status van de Uitgave <br> toewees aan Naam <br> Primair Contact <br> * Aantal van de Verwijzing van het Project <br>*De Naam van het Project <br>*Totaal aantal ingediende verzoeken <br>*Naam van het 12}*Verzoek {}*Datum van de dagelijkse samenvatting<br><br><br><br></p> </td> 
   <td> <p><strong> Onmiddellijk </strong> </p> <p><strong> en Dagelijks </strong> </p> </td> 
  </tr> 
  <tr> 
   ...
   <td> De Naam van het verzoek <br> Naam van het Project van de Naam van het 1} Verzoek {<br> Naam van de Verwijzing van de gebruiker die de Status van de Uitgave van het Verzoek <br> <br> Datum en Tijd sloot toen het Verzoek <br> Vorige Status van het Verzoek <br> knoop <br><strong>[!UICONTROL See More Details]</strong> * Aantal van de Verwijzing van het Project <br>*De Naam van het Project <br>*Totaal aantal gesloten verzoeken <br>*Naam van 1Naam van het Verzoek <br>*Naam van de Naam van het verzoek van het verzoek {}*Datum van de dagelijkse samenvatting<br><br> </td> 
   <td><strong> Onmiddellijk </strong> </td> 
  </tr> 
  <tr> 
   ...
   <td> <p>De Naam van het dossier <br> Naam van het Project van de 1} Uitgave van het Referentienummer <br> het Type van het Verzoek <br> Toegelaten Datum van het Verzoek <br> <br> Uitgave Prioriteit 6} Primair contact <br> Geplande Status van de Voltooiing <br> zie Meer Details <br> knoop <br>*De Naam van het Project <br><strong>*Het Aantal van de Verwijzing van het Project </strong>*Totaal van 13} Uitgave van 13} Uitgeven aan verzoeken 4}*Naam van verzoek <br>*Toegewezen aan Naam <br>*Datum van dagelijkse samenvatting<br><br><br><br></p> </td> 
   <td><strong> Dagelijks </strong> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> De Naam van het verzoek {<br> Naam van het 1} Verzoek van de Naam van het Project {<br> van de gebruiker die de Status van de Nieuwe Status van het Verzoek <br> <br> Datum en Tijd wijzigde toen de Status van het Verzoek <br> Vorige Status van het Verzoek <br> knoop <br><strong>[!UICONTROL See More Details]</strong> * Naam van het Project <br>*Het Aantal van de Verwijzing van het Project <br>*Totaal aantal verzoeken waarvan status <br>*Naam van 111111111111111}*11111111}*111111}*111111111111111}*11 12}*Nieuwe Status van het Verzoek <br>*Naam van de gebruiker die de status <br>*Datum van de dagelijkse samenvatting veranderde<br><br><br><br></td> 
