...
description: De toegang tot van  [!DNL Workfront]  door de Onderneming van Adobe CX geeft u een naadloze, verenigde ervaring voor het beheren van al uw toepassingen van Adobe.
author: Courtney
...
Als u [!DNL Workfront] tot en met [!DNL Adobe CX Enterprise] opent, hebt u een naadloze, uniforme ervaring voor het beheer van al uw [!DNL Adobe] -toepassingen. Met Single Identity Management kunt u zich op één locatie aanmelden, zonder meerdere URL&#39;s of aanmeldings-id&#39;s.
...
* Kies **[!UICONTROL Dark theme]** opmaak voor [!DNL Adobe CX Enterprise] .
* Stel **[!UICONTROL Preferences]** in voor [!DNL Adobe CX Enterprise] , inclusief voorkeuren voor primaire en secundaire talen.
...
[Zie dit artikel voor het wijzigen van je Adobe-wachtwoord.](https://helpx.adobe.com/nl/account/individual/sign-in-and-security/security-and-recovery/reset-adobe-password.html){target="_blank"}
