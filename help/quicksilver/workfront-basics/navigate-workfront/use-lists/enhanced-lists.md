...
* Weergave: definieert de kolommen, filters en groepen in de lijst met vooraf ingestelde instellingen
* Filters: beperkt de hoeveelheid informatie die in de lijst wordt weergegeven
* Groepen: de lijstitems ordenen op basis van gemeenschappelijke velden
* Sorteren: rangschikt de items in een lijst op basis van de volgorde die u voor een bepaald veld instelt
* Zoeken: snel een item zoeken met een trefwoord voor zoeken
