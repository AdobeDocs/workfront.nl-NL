...
description: U kunt een lijst met objecten uit Adobe Workfront exporteren. Als de lijst met objecten in Workfront meer dan 2000 items bevat, is het exporteren van de lijst de enige manier om alle items in de lijst op één pagina te bekijken.
...
Voor informatie over de de uitvoerformaten en grenzen, zie [ gegevens van de Uitvoer ](../../../reports-and-dashboards/reports/creating-and-managing-reports/export-data.md).
...
1. Klik de **[!UICONTROL Export]** pictogram ![ Uitvoer ](assets/export.png).
...
1. Selecteer een van de volgende indelingen:
   ...
   * Door tabs gescheiden
     ...
     Hiermee wordt een kopie van de lijst naar een van deze indelingen geëxporteerd en op uw computer opgeslagen.
