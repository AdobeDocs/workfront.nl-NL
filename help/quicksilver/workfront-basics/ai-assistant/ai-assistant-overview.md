...
1. Voer de naam en het e-mailadres in van de persoon in uw organisatie die de Adobe Gen AI-overeenkomst zal ondertekenen.
   ...
   >* Neem contact op met de klantenondersteuning van Workfront als u geen AI Assistant-opties ziet die beschikbaar zijn in de instantie van uw organisatie nadat deze is ingeschakeld.
