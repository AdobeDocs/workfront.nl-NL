...
* **kaarten van het Tarief**: Voor informatie, zie [&#x200B; een tariefkaart &#x200B;](/help/quicksilver/administration-and-setup/manage-enterprise-operations/share-rate-cards.md) delen.
  ...
  <tr> 
   ...
   <td> <p>U kunt de volgende handelingen op het object uitvoeren:</p> 
    <ul> 
     ...
     <li><p>Kostentarieven, factureringstarieven of algemene financiële informatie over het object weergeven</p></li> 
  ...
  <tr> 
   ...
   <td> <p>U kunt de volgende handelingen op het object uitvoeren:</p> 
    <ul> 
     ...
     <li>Verwijderen</li> 
     <li>Kostentarieven, factureringstarieven of algemene financieringsinformatie in het beheer</li> 
    </ul> </td> 
  </tr> 
  <tr> 
