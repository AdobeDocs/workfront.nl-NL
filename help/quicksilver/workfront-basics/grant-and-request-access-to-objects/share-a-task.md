...
1. In de **taaktoegang van de Verlening tot** gebied, begin het typen van de naam van de gebruiker, het team, de rol, de groep, het bedrijf, <span class="preview"> of het bedrijfsprofiel </span> u de taak met wilt delen, dan klik de naam wanneer het in de drop-down lijst verschijnt.
...
1. In de **taaktoegang van de Verlening tot** gebied, begin het typen van de naam van de gebruiker, het team, de rol, de groep, het bedrijf, <span class="preview"> of het bedrijfsprofiel </span> u de taken met wilt delen, dan klik de naam wanneer het in de drop-down lijst verschijnt.
