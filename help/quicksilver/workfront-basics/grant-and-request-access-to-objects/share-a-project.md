...
1. In de **projecttoegang van de Verlening tot** gebied, begin typend de naam van de gebruiker, het team, de rol, de groep, het bedrijf, <span class="preview"> of het bedrijfsprofiel </span> u het project met wilt delen, dan klik de naam wanneer het in de drop-down lijst verschijnt.
...
1. In de **projecttoegang van de Verlening tot** gebied, begin typend de naam van de gebruiker, het team, de rol, de groep, het bedrijf, <span class="preview"> of het bedrijfsprofiel </span> u de projecten met wilt delen, dan klik de naam wanneer het in de drop-down lijst verschijnt.
...
<table border="1" cellspacing="15" cellpadding="1"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p>Factureringssnelheden bewerken*</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>  </p> </td> 
   <td> <p>  </p> </td> 
  </tr> 
  <tr> 
   <td> <p>Kostentarieven bewerken*</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>  </p> </td> 
   <td> <p>  </p> </td> 
  </tr>
  <tr> 
   <td> <p>Algemene financiën bewerken*</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>  </p> </td> 
   <td> <p>  </p> </td> 
  </tr>
  ...
  <tr> 
   <td> <p>Factureringssnelheden weergeven*</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>✓</p> </td> 
  </tr>
  <tr> 
   <td> <p>Kostentarieven weergeven*</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>✓</p> </td> 
  </tr>
  <tr> 
   <td> <p>Algemene financiën weergeven*</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>✓</p> </td> 
   <td> <p>✓</p> </td> 
  </tr> 
