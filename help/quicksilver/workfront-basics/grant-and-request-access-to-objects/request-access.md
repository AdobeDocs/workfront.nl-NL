...
>
>* Scenario Planner is van plan in het Adobe Workfront Scenario Planner. Voor meer informatie, zie [ toestemmingen van het Verzoek aan een plan in de Planner van het Scenario ](../../scenario-planner/request-access-to-plan.md). Hiervoor is een aanvullende licentie vereist.
>
