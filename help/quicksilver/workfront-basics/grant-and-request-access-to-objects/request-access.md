...
## Standaardedelingsregels begrijpen
...
1. Klik op de knop **Meer** menu inline met de projectnaam, dan klik **Meer toegang aanvragen**.\
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>Portfolio</td> 
   <td>De eigenaar is de eigenaar van de Portfolio. <p>Ze zijn mogelijk niet dezelfde persoon als de maker van de portefeuille. </p></td> 
  </tr> 
  <tr> 
   <td>Documenten</td> 
