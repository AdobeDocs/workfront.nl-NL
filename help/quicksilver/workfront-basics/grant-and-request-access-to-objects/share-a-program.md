...
1. In het **programma van de Verlening toegang tot** gebied, begin typend de naam van de gebruiker, het team, de rol, de groep, het bedrijf, of het bedrijfsprofiel u het programma met wilt delen, dan klik de naam wanneer het in de drop-down lijst verschijnt.
...
1. In het **programma van de Verlening toegang tot** gebied, begin typend de naam van de gebruiker, het team, de rol, de groep, het bedrijf, of het bedrijfsprofiel u de programma&#39;s met wilt delen, dan klik de naam wanneer het in de drop-down lijst verschijnt.
