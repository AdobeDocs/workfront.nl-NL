...
Gebruikers kunnen toegang aanvragen tot objecten in Adobe Workfront. Voor meer informatie over het vragen van toegang, zie  [Toegang tot objecten aanvragen](../../workfront-basics/grant-and-request-access-to-objects/request-access.md).
...
Als u nog steeds geen toegang hebt, vraagt u de Workfront-beheerder of deze aanvullende beperkingen op uw toegangsniveau instelt. Voor informatie over hoe een beheerder van Workfront uw toegangsniveau kan wijzigen, zie <a href="../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Aangepaste toegangsniveaus maken of wijzigen</a>.</p> </td>
  ...
  <tr> 
   ...
   <td> <p>Machtigingen of hoger weergeven voor projecten, taken, problemen of documenten</p> <p>Voor informatie over het aanvragen van aanvullende toegang raadpleegt u <a href="../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Toegang tot objecten aanvragen </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
U kunt configureren of u e-mailmeldingen ontvangt voor toegangsverzoeken. Uw Workfront-beheerder kan deze functionaliteit uitschakelen (zoals beschreven in [Gebeurtenismeldingen configureren voor iedereen in het systeem](../../administration-and-setup/manage-workfront/emails/configure-event-notifications-for-everyone-in-the-system.md)).

1. Klik op de knop **Hoofdmenu** pictogram ![](assets/main-menu-icon.png) in de rechterbovenhoek van Adobe Workfront klikt u op **Instellen** ![](assets/gear-icon-settings.png).

1. Klikken **Voorkeuren** of blader naar de sectie Voorkeuren.
1. In de **Stuur mij een e-mail** vervolgkeuzelijst, selecteren of deselecteren **Iemand vraagt mij om toegang**, afhankelijk van of u e-mailmeldingen wilt ontvangen wanneer een andere gebruiker toegang van u vraagt of niet.
