...
1. Voer een van de volgende handelingen uit, afhankelijk van uw doel en uw toegangsniveau in het systeem:
   ...
   * **Standaard of van het Plan gebruiker die tijd registreren voor zich vormt:** klik uw profielbeeld in het hoogste navigatiegebied, dan klik **[!UICONTROL Workfront Profile]**. Dan, klik het **Meer** pictogram naast uw naam en selecteer **uitgeven**.
...
1. In het de dialoogvakje van het gebruikersprofiel, in de **Planning van het Middel** sectie, bepaal de plaats van de **tijd van het Logboek binnen** optie.
