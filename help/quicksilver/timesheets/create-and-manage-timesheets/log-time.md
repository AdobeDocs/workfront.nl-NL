...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> 
   <ul><li><p>Licht of hoger aan logboekuren op een taak, kwestie, <span class="preview"> project </span>, of Algemene Uren op een timesheet</p></li>
...
* Een norm of vergunning van het Plan met administratieve toegang tot Tijdopnamen &amp; uren, <span class="preview"> of een Lichte vergunning met Edit toegang tot Projecten </span>. Voor meer informatie over het verlenen van administratieve toegang tot Chronologie &amp; uren, zie [&#x200B; gebruikers administratieve toegang van de Verlening tot bepaalde gebieden &#x200B;](../../administration-and-setup/add-users/configure-and-grant-access/grant-users-admin-access-certain-areas.md). <span class="preview"> Administratieve toegang tot Chronologie &amp; uren is niet beschikbaar voor Lichte vergunningen.</span>
