---
title: Verbeteringen voor bedrijfsactiviteiten in tweede kwartaal 2026
description: Verbeteringen voor bedrijfsactiviteiten in tweede kwartaal 2026
author: Becky
...
# Verbeteringen voor bedrijfsactiviteiten in tweede kwartaal 2026
...
De geavanceerde mogelijkheden van ondernemingsverrichtingen van Adobe Workfront zijn een verenigde en scalable manier om financiën, projecten, en ondernemingstoegang te beheren. Deze mogelijkheden bieden de zichtbaarheid en de controle die bedrijven nodig hebben om rendabel en efficiënt te werken.

### Geavanceerd financieel beheer

>[!NOTE]
>
>Deze functies zijn alleen beschikbaar voor organisaties in het Workflow Ultimate-pakket.
...
* Een opnieuw ontworpen **Geavanceerde ervaring van Taken** met uitgebreide configurability brengt grotere zicht en controle over tarieven, tijdkaders en eigenschappen.
  ...
  >[!NOTE]
  >
  >Vóór de versie van de Productie op 16 april, zal een schakelaar worden toegevoegd om u toe te staan om tussen de oude en nieuwe Geavanceerde ervaringen van Toewijzingen te kiezen. De oude ervaring blijft de standaardwaarde.
...
>[!NOTE]
>
>* Projectmomentopnamen zijn alleen beschikbaar voor organisaties in het Workflow Ultimate-pakket.
>* De momentopnamen van het product zullen geen Voorproef hebben, en zullen direct aan Productie op 16 April worden vrijgegeven.
...
>[!NOTE]
>
>Voor organisaties zijn aparte kosten- en factureringsmachtigingen beschikbaar voor alle Workfront- en workflowpakketten.
...
* Nieuwe **geavanceerde logische types**: geavanceerde vertoning, standaardwaarde, voorwaardelijk formatteren, en editability
  ...
  >[!NOTE]
  >
  >De nieuwe logische typen zijn alleen beschikbaar voor organisaties in de pakketten Workflow Prime of Ultimate.

* Verbeteringen aan de interface van de formulierontwerper:
   * De formuliernaam wordt nu linksboven in de ontwerper weergegeven, zodat u de naam kunt zien op een lang formulier wanneer u schuift.
  ...
  >[!NOTE]
  >
  >Deze functies zijn beschikbaar voor organisaties op alle Workfront- en workflowpakketten.
...
* De mogelijkheid om aangepaste formulieren toe te voegen aan teams, scorekaarten en taakrollen.
  ...
  >[!NOTE]
  >
  >* Voor het toevoegen van aangepaste formulieren aan classificatiekaarten en taakrollen is het Workflow Ultimate-pakket vereist.
  >* Het toevoegen van aangepaste formulieren aan teams is beschikbaar voor organisaties in alle Workfront- en workflowpakketten.
...
* A **het toestemmingstype van de Financiën** het plaatsen op munt-geformatteerde gebieden, om toegang slechts tot gebruikers toe te staan die bepaalde toestemmingen hebben die in hun toegangsniveaus worden geplaatst.
  ...
  >[!NOTE]
  >
  >Deze functie is beschikbaar voor organisaties op alle Workfront- en workflowpakketten.

### Verbeteringen van lay-outsjablonen
...
>[!NOTE]
>
>Deze functie is alleen beschikbaar voor organisaties in de pakketten Workflow Prime of Ultimate.

Met aangepaste lokalisatie kunt u aangepaste termen en woordgroepen definiëren in verschillende talen. Workfront geeft deze termen vervolgens weer in de taal die is ingesteld in de browserinstellingen.
...
>
>Deze functie is beschikbaar voor organisaties op alle Workfront- en workflowpakketten.
>Merk op dat tariefkaarten alleen beschikbaar zijn voor organisaties in het Workflow Ultimate-pakket.

Met Workfront kunt u ruimte laten tussen datumbereiken voor facturering en kostentarieven, maar u ontvangt een waarschuwing om te bevestigen dat dit opzettelijk is.

Er kunnen verschillen zijn tussen de datumbereiken waar de tarieven bestaan:

* Tarieven voor een functie
* Tarieven voor een gebruikersprofiel
