---
title: Overzicht eerste release 2026, eerste kwartaal
description: Deze pagina bevat informatie over de functionaliteit die is opgenomen in de release Eerste kwartaal 2026. Deze verbeteringen zullen naar verwachting in het hele kwartaal beschikbaar komen in de productieomgeving.
author: Courtney
...
# Overzicht eerste release 2026, eerste kwartaal

Deze pagina verstrekt informatie over functionaliteit die in Eerste Kwartaal 2026 die voor Januari 2026 wordt gepland inbegrepen is.

De verbeteringen op deze pagina zijn beschikbaar in de voorvertoningsomgeving. Deze pagina zal met extra verhogingen worden bijgewerkt aangezien de Eerste Kwartaal 2026 versie zijn geplande versie van de Productie nadert.
   ...
   <tr>
    ...
    <tr>
        <td>
            ...
            <p>De ingangsdatum en de ingevoerde gegevens met de id worden nu opgeslagen op aangepaste formulieren, velden en secties. U kunt deze gegevensopties in rapporten als filters, meningen, of groeperingen gebruiken. Als u deze wilt weergeven in de lijst met aangepaste formulieren, velden of secties in Setup, voegt u Invoerdatum en Ingevoerd door: Naam als kolommen toe aan een nieuwe of bestaande weergave.</p>
        </td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-admin-and-setup.md" class="MCXref xref" xrefformat="{para}"> Updates aan knoopnamen wanneer het uitgeven van een lay-outmalplaatje </a>
            <p>Voor meer consistentie met andere delen van Setup, zoals de aangepaste formulierontwerper, zijn de knoppen die u ziet bij het bewerken van een lay-outsjabloon gewijzigd in Toepassen, Opslaan en Sluiten en Annuleren. Met de nieuwe optie Toepassen kunt u uw wijzigingen in de lay-outsjabloon opslaan en doorgaan met bewerken. Eerder waren de beschikbare opties Opslaan en Annuleren. </p>
        </td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 13 november 2025</td>
        <td>vrijdag 15 januari 2026</td>
    </tr>  
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-admin-and-setup.md" class="MCXref xref" xrefformat="{para}"> Verbeterd veldbeheer met actieve markering op aangepaste velden </a>
            <p>Als het systeem een groot aantal aangepaste velden bevat, kan het moeilijk zijn deze velden in aangepaste formulieren en rapporten te beheren. U kunt douanevelden nu inactief met de nieuwe <b> Actieve </b> vlag merken. Deze markering is beschikbaar wanneer u met een veld werkt op een aangepast formulier of wanneer u een veld uit de lijst Velden toevoegt of bewerkt. </p>
        </td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 13 november 2025</td>
        <td>vrijdag 15 januari 2026</td>
...
### Verbeterde documenten en goedkeuringen
...
<table style="table-layout:auto">
  <tbody>
   <tr>
       ...
       <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}"> Kies een Workfront-project wanneer u een revisie verzendt in Creative Cloud Express<p>[!BADGE Off schema]{type=Neutral}</p> </a>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}"> steun van de dwars-organisatie voor Adobe Express met het Bewijzen van Workfront<p>[!BADGE Off schema]{type=Neutral}</p> </a>
            <p>We introduceren ondersteuning voor verschillende organisaties voor Adobe Express met Workfront Proofing. Dankzij deze uitbreiding kunnen klanten die in meerdere IMS-organisaties werken, probleemloos proofing-workflows gebruiken en beheren.</p>
        </td>
        <td>vrijdag 13 november 2025</td>
        <td>vrijdag 13 november 2025</td>
        <td>vrijdag 13 november 2025</td>
     ...
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}"> Adobe Experience Manager nu beschikbaar met de integratie Frame.io <p>[!BADGE Off schema]{type=Neutral}</p> </a>
            <p>U kunt nu de Experience Manager Assets-​ gebruiken om uw digitale middelen te beheren en op te slaan die de controle- en goedkeuringscyclus hebben doorlopen. Dankzij deze integratie kunt u de mogelijkheden van Adobe Experience Manager, Frame.io en Workfront benutten om uw contentbeheer en samenwerkingsprocessen te stroomlijnen. </p>
        </td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 30 oktober 2025</td>
  ...
  <tbody>
   <tr>
        ...
        <td>15 december 2025</td>
         ...
         <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-integrations.md" class="MCXref xref" xrefformat="{para}"> Bijgewerkte elementenkiezer voor de geïntegreerde Adobe Workfront for Experience Manager Assets </a>
            <p>We hebben de assetkiezer geüpgraded in de Adobe Workfront for Experience Manager Assets-integratie. Met deze upgrade kunt u nu AEM Collections selecteren en rechtstreeks naar Workfront trekken. </p>
        </td>
        <td>vrijdag 20 november 2025</td>
        <td>11 december 2025</td>
        <td>vrijdag 15 januari 2026</td>
    </tr>   
     <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-integrations.md" class="MCXref xref" xrefformat="{para}"> Nieuwe versie van de integratie van Salesforce nu beschikbaar </a>
            <p>Om up-to-date te blijven met recente wijzigingen in de Workfront API, hebben we een nieuwe Salesforce-integratie gemaakt. De nieuwe integratie heeft dezelfde functionaliteit als de vorige versie en is bijgewerkt om te voorkomen dat de functionaliteit in de API verloren gaat.</p><p>OPMERKING: De Workfront for Salesforce-integratie, inclusief de nieuwe versie, is niet beschikbaar na **28 februari 2026**. </p>
        </td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 30 oktober 2025</td>
  ...
  <tbody>
   <tr>
        ...
        <td><strong>Driemaandelijks</strong></td>
         ...
         <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-projects.md" class="MCXref xref" xrefformat="{para}"> Lichte gebruikers kunnen tijd op projecten </a> registreren
            <p>Lichte gebruikers kunnen nu tijd rechtstreeks bij projecten aanmelden. Eerder konden alleen standaardgebruikers van licenties uren aanmelden voor projecten.</p>
        </td>
        <td>11 december 2025</td>
        <td>vrijdag 15 januari 2026</td>
        <td>vrijdag 15 januari 2026</td>
...
<table style="table-layout:auto">
 ...
 <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}"> updates van de Valuta in de Dashboards van het Canvas </a>
            <p>We hebben de volgende wijzigingen aangebracht voor valutavelden:<ul><li>Wanneer in Workfront meerdere valuta's zijn gedefinieerd, kunt u nu tijdens het maken een standaardvaluta voor het dashboard kiezen. </li><li>Wanneer u een rapport maakt, kunt u een valutaveld vergrendelen. Dit zorgt ervoor dat de valutanotatie op dashboardniveau geen invloed heeft op de weergave van deze waarden.</li><li>Als gebruikers een dashboard bekijken, kunnen ze schakelen tussen gedefinieerde valuta's in Workfront. Deze wijzigingen gelden voor het hele dashboard, met uitzondering van vergrendelde valutavelden</li></ul></p>
        </td>
        <td>18 december 2025</td>
        <td>donderdag 14 januari 2026</td>
        <td>vrijdag 15 januari 2026</td>
 ...
 <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-reporting.md" class="MCXref xref" xrefformat="{para}"> Resultaten van snelle zoektabellen in Canvasdashboards </a>
            <p>We hebben een snelle zoekopdracht toegevoegd aan Tabelrapporten. Deze zoekopdracht werkt op alle pagina's, zodat u gegevens kunt zoeken, zelfs als deze momenteel niet zichtbaar zijn.</p>
        </td>
        <td>18 december 2025</td>
        <td>donderdag 14 januari 2026</td>
        <td>vrijdag 15 januari 2026</td>
    ...
    <tr>
     ...
     <tr>
        <td>
            ...
            <p>Om het gemakkelijker te maken om verzoeken tot stand te brengen en voor te leggen, hebben wij de capaciteit toegevoegd om concepten aan de nieuwe het vragen ervaring op te slaan. Wanneer u nu een verzoek invult en sluit, wordt het verzoek opgeslagen in de status Concept en vindt u het op het aanvraagformulier dat wordt gebruikt om het concept te maken. U kunt het concept vervolgens opnieuw openen, bijwerken en verzenden wanneer u dat uitkomt. </p>
        </td>
        <td>vrijdag 20 november 2025</td>
        <td>donderdag 14 januari 2026</td>
        <td>vrijdag 15 januari 2026</td>
        ...
        <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md" class="MCXref xref" xrefformat="{para}"> Schrap voorgelegde verzoeken in de nieuwe het vragen ervaring </a>
            <p>Om het gemakkelijker te maken om uw verzoeken georganiseerd en ongecompliceerd te houden, hebben wij de capaciteit toegevoegd om verzoeken aan de nieuwe het vragen ervaring te schrappen. Nu kunt u verzoeken verwijderen die u hebt verzonden. Workfront-beheerders en Workfront Planning Workspace-beheerders kunnen aanvragen ook verwijderen.</p>
        </td>
        <td>vrijdag 20 november 2025</td>
        <td>donderdag 14 januari 2026</td>
        <td>vrijdag 15 januari 2026</td>
        ...
        <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-1-q1-requests.md" class="MCXref xref" xrefformat="{para}"> creeer nieuwe verzoeken door eerder voorgelegde verzoeken in de nieuwe het vragen ervaring te kopiëren </a>
            <p>Om het gemakkelijker te maken om verzoeken voor te leggen, hebben wij de capaciteit toegevoegd om verzoeken aan de nieuwe het vragen ervaring te kopiëren. Nu kunt u een aanvraag kopiëren, velden bewerken en verzenden als een nieuwe aanvraag. </p>
        </td>
        <td>vrijdag 20 november 2025</td>
        <td>11 december 2025</td>
        <td>vrijdag 15 januari 2026</td>
...
<table>
        ...
        <td><strong>Driemaandelijks</strong></td>
                 ...
                 <tr>
                    <td>
                        <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-other.md" class="MCXref xref" xrefformat="{para}"> blik-en-voelt updates tijdens Eerste Kwartaal 2026 vrijgavetijdframe </a>
                        <p>Kleine updates van het uiterlijk van verschillende onderdelen van de Adobe Workfront-toepassing worden uitgevoerd binnen de releaseperiode van het eerste kwartaal van 2026. </p>
                    </td>
                    <td><p>Tijdens het eerste kwartaal van 2026 is de releaseperiode<br /></p>
                ...
                <tr>
                 <td>
                <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-other.md" class="MCXref xref" xrefformat="{para}"> Selectiegrenzen voor velden met meerdere selecties </a>
              <p>Velden die meerdere selecties mogelijk maken, zoals selectievakjes en meerkeuzevelden, zijn nu beperkt tot 5000 selecties wanneer een gebruiker het formulier invult.</p>
             </td>
        <td>vrijdag 30 oktober 2025</td>
        <td>vrijdag 13 november 2025</td>
        <td>vrijdag 15 januari 2026</td>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-other.md" class="MCXref xref" xrefformat="{para}"> Adobe Verenigde Ervaring nu beschikbaar voor meer organisaties van Workfront </a><p></p>
...
#### Afschrijving van de overschrijvingsvaluta op functies met de release 25.11

In het kader van de vereenvoudiging van het financiële model zullen we de overschrijvingsvaluta afschaffen voor functies in Voorvertoning op 30 oktober en in Productie voor alle klanten met de release van 25.11. Deze verandering beïnvloedt hoe de munten en de tarieven op baanrollen in het gebied van de Opstelling worden gevormd.

* De **gebieden van de Valuta van de met voeten treden** op een baanrol zullen niet meer beschikbaar zijn.
* Elke functie heeft één munt met de bijbehorende kosten en factureringsgraad.
* Alle bestaande overschrijfvaluta&#39;s en hun wisselkoerswaarden worden automatisch gemigreerd tot de enige valuta en de enige koersen voor die functie.
...
**de versie van de Productie voor alle klanten: 11 December, 2025**

De Desktop Proofing Viewer is bijgewerkt van 2.1.52 naar 2.1.54. Deze update bevatte interne gereedschapsupdates die geen invloed hadden op de functionaliteit van de eindgebruiker.

De versie 2.1.53 bevatte ook interne wijzigingen in de gereedschappen.
