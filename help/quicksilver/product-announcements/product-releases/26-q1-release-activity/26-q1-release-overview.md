   ...
   <tr>
    ...
    <tr>
        <td>
            ...
            <p><span class="preview">Tijdelijk niet beschikbaar in de voorvertoningsomgeving</span></p>
...
<table style="table-layout:auto">
  <tbody>
   <tr>
       ...
       <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}"> de opstellingsmerken voor de AI recensent in Workfront<p>[!BADGE Off schema]{type=Neutral}</p> </a>
            <p>U kunt nu merken instellen voor de AI-revisor in het gedeelte Workfront Setup. Op deze manier kunt u het AI-controleproces aanpassen op basis van de brandingrichtlijnen van uw organisatie.</p>
            <p>De AI-revisor bevindt zich momenteel in bètaversie.</p>
        </td>
        <td>vrijdag 8 januari 2026</td>
        <td>vrijdag 8 januari 2026</td>
        <td>vrijdag 8 januari 2026</td>
    </tr> 
    </tr>
