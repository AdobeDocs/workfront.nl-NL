...
<table style="table-layout:auto">
  <tbody>
   <tr>
       ...
       <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/26-q1-release-activity/26-q1-documents-approvals.md" class="MCXref xref" xrefformat="{para}"> Kies een Workfront-project wanneer u een revisie verzendt in Adobe Express<p>[!BADGE Off schema]{type=Neutral}</p> </a>
