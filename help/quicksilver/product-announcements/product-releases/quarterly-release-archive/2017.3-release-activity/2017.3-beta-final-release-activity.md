...
* [Inclusief problemen op de scrublog voor een flexibel team](#include-issues-on-the-scrum-backlog-for-an-agile-team)
...
* [Nieuwe Groepering voor Bron begrote Uren rapporteert: Toewijzingsdatum](#new-grouping-for-resource-budgeted-hour-reports-allocation-date)
...
>[!NOTE]
Deze functionaliteit wordt niet vrijgegeven in de productieomgeving met de release 17.3; het zal in Voorproef tot begin 2018 blijven.
...
Voor meer informatie over het runnen van een rapport van het Gebruik, zie [Overzicht van het verslag over het gebruik van hulpbronnen](../../../../reports-and-dashboards/reports/using-built-in-reports/resource-utilization-report.md) in [Overzicht van het verslag over het gebruik van hulpbronnen](../../../../reports-and-dashboards/reports/using-built-in-reports/resource-utilization-report.md).
...
*De optie om gebruikers van de ene stap naar de andere te verplaatsen met behulp van slepen en neerzetten wordt opnieuw geïntroduceerd met de release van 2018.1.*
...
* Eén opmerking maken met markeringen op meerdere pagina&#39;s in de weergave Eén
   ...
   Dit was eerder mogelijk slechts wanneer in de Ononderbroken mening of mening van het Tijdschrift

* Door proefdrukken navigeren via de proefdrukminiaturen

   * Het deel van het bewijs dat wordt herzien, gemakkelijk identificeren. Dit is belangrijk, vooral wanneer gebruikers met grotere proefdrukken in formaat en lange webpagina&#39;s werken, of wanneer het grotere zoomniveau nodig is om de details te zien.
...
We hebben de beschrijvingen voor onze systeemrapporten in Workfront bijgewerkt, zodat ze informatie bevatten over het type rapport en de opgenomen velden.  
...
We hebben een nieuwe instelling in het gedeelte Goedkeuringsinstellingen op systeemniveau geïntroduceerd, zodat Workfront-beheerders kunnen beslissen of ze gebruikers moeten toestaan een probleem op te lossen of een verzoek in te dienen waarvan de eerste status in afwachting is van goedkeuring. Indien het terugroepen is toegestaan, wordt de kwestie geschrapt; als het terugroepen niet wordt toegestaan, kunnen de gebruikers geen knoop van de Herhaling zien wanneer de eerste status van een kwestie in afwachting van goedkeuring is.
...
* [Bronnen: Gegevens weergeven op FTE](#resource-planner-show-data-by-fte)
* [Bronnen: Gegevens per week en per kwartaal weergeven](#resource-planner-show-data-by-week-and-quarter)
* [Bronnen: Weergeven op gebruiker](#resource-planner-view-by-user)
* [Bronnen: Sleep en zet projecten neer om prioriteit vast te stellen](#resource-planner-drag-and-drop-projects-to-establish-priority)
* [Bronnen: De gegevens in de Planner van het Middel naar Excel uitvoeren](#resource-planner-export-the-data-in-the-resource-planner-to-excel)
...
* Open een lijst met uw projecten
...
Ga voor meer informatie over toegang tot Workfront vanaf Slack naar [Workfront gebruiken met Slack.](https://support.workfront.com/hc/en-us/sections/115000458033)

## Outlook 365-verbeteringen {#outlook-365-improvements}

We hebben de volgende verbeteringen aangebracht in de invoegtoepassing Workfront voor Outlook 365:

* Voeg een taak of een kwestie aan een project in Workfront toe: U kunt nu een e-mailbericht naar een taak of een uitgave in Workfront converteren met de Outlook 365-invoegtoepassing. In dit proces, kunt u een project specificeren u de taak of de kwestie wilt worden toegevoegd aan, evenals een ontvanger en een vervaldatum. Voorafgaand aan deze verhoging, kon u een verzoek aan een verzoekrij slechts voorleggen of een persoonlijke taak toevoegen aan uw het Werken aan lijst van Vooruitzichten 365. 
* Een koppeling naar Workfront-objecten behouden in de oorspronkelijke e-mail die is geconverteerd naar taken, problemen of verzoeken: Wanneer u een e-mail van Vooruitzichten 365 in een taak, een kwestie, of een verzoek omzet, behouden de Vooruitzichten 365 een verbinding aan de taak of kwestie die van dat e-mail binnen originele e-mail werd omgezet. Voorafgaand aan deze verandering, was er geen aanwijzing in Vooruitzichten of een e-mail in een taak was omgezet of als verzoek ingediend. 
...
Voor een overzicht van de wijzigingen die zijn aangebracht in de Workfront API raadpleegt u [Updates voor API versie 8](../../../../wf-api/api/new-api-version-8-updates.md).

### Verwijderde en verwijderde versies van de API {#removed-and-deprecated-versions-of-the-api}

### Bijgewerkte berichtindeling voor abonnementen op gebeurtenissen

Om nuttiger informatie voor uw integratie te verstrekken die de API van de Abonnementen van de Gebeurtenis van Workfront omvatten, hebben wij het uitgaande berichtformaat voor gesteunde middelen veranderd door de oude en nieuwe waarden te omvatten verbonden aan die middelen. Om mislukkingen te voorkomen, moeten integraties die u hebt met de Workfront Event Subscriptions API worden bijgewerkt in de nieuwe indeling, zoals beschreven in [Event Subscription API](../../../../wf-api/general/event-subs-api.md).
