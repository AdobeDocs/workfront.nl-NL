...
Voor meer informatie over de bouw van de de wijzemening van de douanetekst die de informatie van de originele kwestie vangt, zie [ Mening: toon originele uitgifteinformatie over taak en projectlijsten ](../../../../reports-and-dashboards/reports/custom-view-filter-grouping-samples/view-display-original-issue-info-task-project-list.md).
