...
* [@Tags zijn momenteel niet beschikbaar in de voorvertoningsomgeving](#tagging-currently-not-available-in-the-preview-environment)
...
U kunt kolommen in een rapport of lijst nu opnieuw rangschikken en resize, zonder het moeten het rapport uitgeven. (Deze functionaliteit werd verwijderd met de veroudering van de omgeving Vroege Toegang eerder dit jaar. Het wordt nu opnieuw ingevoerd.)
...
Voorafgaand aan deze verandering, kon u een project van een malplaatje slechts op het lusje van Projecten in het gebied van Projecten van Workfront tot stand brengen, door te gebruiken **Nieuw project van sjabloon** optie.
