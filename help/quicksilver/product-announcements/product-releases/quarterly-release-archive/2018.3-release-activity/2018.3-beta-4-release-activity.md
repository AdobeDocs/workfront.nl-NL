...
* [Verbeteringen voor projectlijst](#project-list-improvements)
...
Zie voor meer informatie de [Informatie exporteren uit de bronnenplanner](../../../../resource-mgmt/resource-planning/export-resource-planner.md).
...
Voor informatie over het uitgeven van taken in de Grafiek van de Gantt, zie [Informatie bijwerken in de Gantt-grafiek van de takenlijst](../../../../manage-work/gantt-chart/use-the-gantt-chart/update-info-task-list-gantt.md).
