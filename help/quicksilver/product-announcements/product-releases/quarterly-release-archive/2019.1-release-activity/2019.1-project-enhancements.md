...
* [Voeg Taken en Kwesties van een Lijst aan een Herhaling toe](#add-tasks-and-issues-from-a-list-to-an-iteration)
...
* [De Informatie van de Taak van de mening in de Grafiek van Gantt van de Lijst van het Project in een Programma of Portfolio](#view-task-information-in-the-project-list-gantt-chart-in-a-program-or-portfolio)
...
Eerder kon u taken alleen vanaf de achtergrond toevoegen aan het Kanban-bord. Je kunt geen uitgaven toevoegen.
...
Projecten, tabblad in een Portfolio
...
We hebben de naam van de projectweergave in het Gantt-diagram gewijzigd in &quot;Alles passend maken&quot;. De weergaveoptie werkt nog steeds zoals voorheen. De nieuwe naam moet beschrijfelijker zijn wat u bekijkt wanneer de optie wordt geselecteerd.
