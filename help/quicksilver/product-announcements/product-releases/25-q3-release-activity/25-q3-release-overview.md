...
>|----|----|
>| <ul><li>25.5 (15 mei 2025)</li><li>25.6 (12 juni 2025)</li><li>25.7 (17 juli 2025)</li></ul> | <ul><li>25.7 (17 juli 2025)</li></ul> |
>
...
<table style="table-layout:auto">
  <tbody>
    ...
    <tr>
        <td>
            <a href="/help/quicksilver/product-announcements/product-releases/25-q3-release-activity/25-q3-document-mgmt-enhancements.md" class="MCXref xref" xrefformat="{para}"> verenigde goedkeuringen Geleidelijke Uitvoer </a><p>[!BADGE Off schema]{type=Neutral}</p>
