...
De pagina&#39;s met de bijgewerkte werkbalk zijn:
...
Zie voor meer informatie [Dashboards maken en beheren](../../../reports-and-dashboards/dashboards/creating-and-managing-dashboards/create-and-manage-dashboards.md).
...
Zie voor meer informatie [Taken kopiëren en dupliceren](../../../manage-work/tasks/manage-tasks/copy-and-duplicate-tasks.md).
...
Zie voor meer informatie [Taken verplaatsen](../../../manage-work/tasks/manage-tasks/move-tasks.md).
...
>[!NOTE]
>
>Deze functie is op 4 maart 2022 tijdelijk verwijderd uit de productieomgeving. Het werd later vrijgegeven in een gefaseerde uitrol die begon op 28 april 2022. De uitrol is op 5 mei 2022 voltooid. Dit is nu beschikbaar in Voorbeeld en Productie voor alle klanten. (Voor de meest recente updates over de status van deze functie die betrekking heeft op Productie, raadpleegt u [22.3 Overzicht van de release](../../../product-announcements/product-releases/22.3-release-activity/22-3-release-overview.md).)
...
Om de efficiency van uw werk te verhogen en het voor u gemakkelijker te maken om kwesties in een snel-afgewerkt milieu om te zetten, hebben wij de capaciteit toegevoegd om een kwestie in een project om te zetten gebruikend een malplaatje van een lijst, een rapport, of een dashboard.
...
Zie voor meer informatie [Een documentmap delen](../../../workfront-basics/grant-and-request-access-to-objects/share-a-document-folder.md).
