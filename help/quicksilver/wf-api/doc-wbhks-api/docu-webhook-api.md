...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td>ApiKey</td> 
   <td>  <p>(Alleen ApiKey) Wordt gebruikt om geoorloofde API-aanroepen uit te voeren naar de websiteprovider. De API-sleutel wordt uitgegeven door de websiteprovider.</p></td> 
  </tr> 
 </tbody> 
</table>
