...
* Rapport
* Personeelsformatie
* Parameterwaarde personeelsbestand
* Personeelsformatie
* Resourceattribuut van personeelsplan
* Resourcekenmerkwaarde personeelsbestand instellen
* Resourceparameterwaarde personeelsplan
* Taak
* Sjabloon
* Tijdschema
* Gebruiker
   ...
   * **Koord** - objCode van het voorwerp dat aan veranderingen wordt ingetekend. De mogelijke waarden voor objCode worden in de onderstaande tabel weergegeven.
     ...
     <table style="table-layout:auto"> 
      ...
      <tbody> 
       ...
       <tr> 
        <td scope="col"><p>Documentversie</p></td> 
      ...
      <tr> 
       ...
       <tr> 
        <td scope="col"><p>Goedkeuring proefdrukken</p></td> 
       ...
       <tr> 
        <td scope="col"><p>Personeelsformatie</p></td> 
        <td scope="col"><p>STAFFP</p></td> 
       </tr> 
       <tr> 
        <td scope="col"><p>Parameterwaarde personeelsbestand</p></td> 
       ...
       <tr> 
        <td scope="col"><p>Resourceattribuut van personeelsplan</p></td> 
        <td scope="col"><p>SPAVAL</p></td> 
       </tr> 
       <tr> 
        <td scope="col"><p>Resourcekenmerkwaarde personeelsbestand instellen</p></td> 
        <td scope="col"><p>SAVSET</p></td> 
       </tr> 
       <tr> 
        <td scope="col"><p>Resourceparameterwaarde personeelsplan</p></td> 
...
### Filtergroepen gebruiken

Met filtergroepen kunt u geneste logische (AND/OR) voorwaarden maken in uw gebeurtenisabonnementfilters.

Elke filtergroep kan het volgende hebben:

* Zijn eigen schakelaar (AND of OR).
* Meerdere filters, elk met dezelfde syntaxis en hetzelfde gedrag als zelfstandige filters.

>[!IMPORTANT]
>
>Een groep moet minimaal twee filters hebben.


Alle filters binnen een groep ondersteunen het volgende:
...
1. Connector op hoofdniveau (filterConnector: EN):
   * De buitenste connector tussen de bovenste filters is AND. Dit betekent dat zowel het filter op hoofdniveau als de groep moeten worden doorgegeven voordat de gebeurtenis overeenkomt.

1. Het abonnement wordt geactiveerd wanneer aan de volgende voorwaarden is voldaan:
