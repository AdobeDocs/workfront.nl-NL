...
>[!NOTE]
>
>De in dit gedeelte beschreven procedure is alleen van toepassing op organisaties die nog niet aan boord waren van het Adobe Business Platform. Omdat alle organisaties nu aan het BedrijfsPlatform van Adobe zijn geregistreerd, **het programma openen aan Workfront door Workfront API is niet meer beschikbaar**.
>
