...
1. In het linkerpaneel, klik **Systeem** > **Info van de Klant**.
   ...
   Afhankelijk van het Workfront-pakket dat u hebt aangeschaft, ontbreken sommige secties mogelijk op de pagina Klantgegevens. Neem contact op met uw accountvertegenwoordiger als u wilt weten welk Workfront-pakket uw organisatie gebruikt.
