...
title: Een lijst met groepen exporteren
description: Wanneer u groepen weergeeft die u beheert, kunt u een lijst met deze groepen exporteren.
author: Lisa
...
# Een lijst met groepen exporteren

Wanneer u groepen weergeeft die u beheert, kunt u een lijst met deze groepen exporteren.
...
1. Als u de volledige groep groepen wilt exporteren die u beheert, klikt u op het pictogram Exporteren ![](assets/export.png) .

   of

   Als u enkele groepen wilt exporteren die u beheert, selecteert u de groepen en klikt u op het pictogram Exporteren ![](assets/export.png) .
