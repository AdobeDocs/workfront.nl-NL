...
1. (Facultatief) om bedrijven uit te geven of te schrappen, om minstens één bedrijf te selecteren, dan de toolbarknopen gebruiken om ![ uit te geven pictogram ](assets/edit-icon.png) uitgeven of ![ schrap pictogram ](assets/delete.png) het.
   ...
   >[!NOTE]
   >
   >Als u een bedrijf verwijdert en het bedrijf is ingesteld als een primair bedrijf of wordt gebruikt in een ander object, wordt u gevraagd een ander bedrijf te kiezen om het bedrijf te vervangen dat u verwijdert. Het bedrijf u selecteert wordt het Primaire bedrijf, of vervangt het geschrapte bedrijf op de voorwerpen het bedrijf wordt toegewezen aan.
