...
1. (Voorwaardelijk) om een nieuwe status tot stand te brengen, klik **voeg een Nieuwe Status** toe.
   ...
   ![ status van de Groep ](assets/group-statuses-edit-new.png)
...
1. Klik checkbox voor de status u wilt uitgeven, dan klik **uitgeven** in de banner bij de bodem van het scherm.


   ![ geeft status ](assets/group-statuses-edit-new.png) uit
