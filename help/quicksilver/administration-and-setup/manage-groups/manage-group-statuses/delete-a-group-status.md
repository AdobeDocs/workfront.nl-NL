...
1. In de lijst van statussen die toont, klik checkbox voor de status u wilt schrappen, dan **Schrapping** in de banner bij de bodem van het scherm klikken.

   ![&#x200B; Schrapping &#x200B;](assets/delete-status.png)
