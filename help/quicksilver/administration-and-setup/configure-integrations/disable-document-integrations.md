...
Als [!DNL Adobe] [!DNL Workfront] beheerder, kunt u de verbinding tussen [!DNL Workfront] en een van de externe documentproviders.

Wanneer u de verbinding tussen [!DNL Workfront] en een documentprovider, verdwijnen de koppelingen naar de documenten uit [!DNL Workfront]. Gebruikers kunnen de gekoppelde documenten niet meer zien, ze kunnen geen wijzigingen aanbrengen in de documenten via de [!DNL Workfront] en kunnen niet meer documenten aan die provider toevoegen.
...
Documentintegratie uitschakelen voor [!UICONTROL Workfront DAM], [!DNL Box], [!DNL Dropbox], [!DNL Google Drive], [!DNL Microsoft OneDrive], [!DNL WebDAM]:

1. Aanmelden bij [!DNL Workfront] als [!DNL Workfront] beheerder.
...
## De opdracht [!DNL SharePoint] integratie

1. Aanmelden bij [!DNL Workfront] als [!DNL Workfront] beheerder.
1. Klik op de knop **[!UICONTROL Main Menu]** pictogram ![](assets/main-menu-icon.png) in de rechterbovenhoek van [!DNL Adobe Workfront]en klik vervolgens op **[!UICONTROL Setup]** ![](assets/gear-icon-settings.png).

1. Uitbreiden **[!UICONTROL Documents]** en klik vervolgens op **[!UICONTROL [!DNL SharePoint] Integration]**.
1. Selecteer [!DNL SharePoint] integratie die u wilt uitschakelen.
1. Klik op **[!UICONTROL Disable]**.\
   Gebruikers kunnen geen verbinding maken met de [!DNL SharePoint] site die u hebt uitgeschakeld en ze kunnen geen documenten meer koppelen van [!DNL SharePoint] tot [!DNL Workfront].
...
1. Klik op **[!UICONTROL Disable]**.
   ...
   Gebruikers kunnen geen verbinding maken met de externe documentprovider die u hebt uitgeschakeld en ze kunnen geen documenten meer koppelen van die cloud provider naar [!DNL Workfront].
