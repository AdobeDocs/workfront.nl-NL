 ...
 <tr> 
   ...
   <td> 
    <ul> 
     ...
     </td>  <td><ul><li>U moet licenties hebben voor zowel Workfront als GenStudio for Performance Marketing.</li><li>Workfront en GenStudio for Performance Marketing moeten worden geïmplementeerd in dezelfde IMS Org.</li></ul></td> 
