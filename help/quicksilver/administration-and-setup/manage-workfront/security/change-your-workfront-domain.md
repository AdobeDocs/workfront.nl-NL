...
1. Klik op de knop **Ondersteuning** op de Workfront One-pagina en maak vervolgens een ondersteuningscase.
...
1. Klik in de linkerzijbalk op **Systeem** > **Single Sign-On (SSO)**.
