...
1. Werk de volgende informatie in de **BasisInfo** sectie bij:
   ...
   * **Naam**: Type een naam voor het bedrijf.
   ...
   * **is Primair**: Wijst het bedrijf als primair bedrijf van uw organisatie toe. Het primaire bedrijf vertegenwoordigt doorgaans uw Workfront-account waar de meeste gebruikers werken.
...
1. Klik checkbox naast het bedrijf u wilt schrappen, dan het pictogram van de Schrapping ![&#x200B; pictogram van de Schrapping &#x200B;](assets/delete-icon.png) dichtbij de bovenkant van de pagina klikken.
1. Als u een bedrijf verwijdert dat is ingesteld als een primair bedrijf of dat in gebruik is in een ander object, selecteert u een bedrijf dat het bedrijf moet vervangen dat u verwijdert. Het bedrijf u selecteert wordt het Primaire bedrijf, of vervangt het geschrapte bedrijf op de voorwerpen het bedrijf wordt toegewezen aan.
1. Klik **Schrapping**.
