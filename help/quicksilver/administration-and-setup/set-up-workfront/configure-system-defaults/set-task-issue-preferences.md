...
<table style="table-layout:auto"> 
  ...
  <tbody> 
    ...
    <td> <p>Bepaalt het verband tussen het aantal middelen (en hun toewijzingspercentage) en de duur of de totale inspanning voor de taak. Voor meer informatie, zie {de Duur van de Taak 0} en de Types van Duur <a href="../../../manage-work/tasks/taskdurtn/task-duration-duration-type.md" class="MCXref xref"></a></p> </td> 
    </tr> 
    <tr> 
