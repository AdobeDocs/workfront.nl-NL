...
>[!IMPORTANT]
>
>De procedure die in deze sectie wordt beschreven, is alleen van toepassing op organisaties die nog niet aan boord van de [!DNL Adobe Admin Console] zijn gegaan. Aangezien alle organisaties nu zijn aangemeld bij de [!DNL Adobe Admin Console] , is geen actie nodig.
>
...
>
>Deze sectie wordt in de nabije toekomst verwijderd.
