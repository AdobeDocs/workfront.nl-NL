...
>[!IMPORTANT]
>
>Omdat alle organisaties nu naar de Adobe Admin Console zijn verplaatst, wordt dit artikel in de nabije toekomst verwijderd.
...
Voor een lijst van andere acties die verschillend zijn gebaseerd op of uw organisatie aan Adobe Admin Console is genegeerd, zie [&#x200B; de verschillen van het Beleid tussen Adobe Workfront en Adobe Bedrijfs Platform &#x200B;](../../administration-and-setup/get-started-wf-administration/actions-in-admin-console.md).
