...
>
>U zou verschillende opties in het Belangrijkste Menu kunnen zien nadat uw organisatie op de Adobe Workfront Verenigde Ervaring is ingezien. Voor informatie, zie [ Adobe Verenigde Ervaring voor Workfront ](/help/quicksilver/workfront-basics/navigate-workfront/workfront-navigation/adobe-unified-experience.md).
...
1. Doe om het even welke volgend voor de **Native** punten:

   * Verberg ![ pictogram van de Verbergen ](assets/remove-icon---x-in-circle.png) punten die u niet op het Belangrijkste Menu wilt tonen.
   * Toon ![ pictogram ](assets/add-icon-plus-in-circle.png) punten tonen die u op het Belangrijkste Menu wilt tonen.
   * Sleep ![ het pictogram van de belemmering ](assets/move-icon---dots.png) punten om hun vertoningsorde op het Belangrijkste Menu te veranderen.

1. Doe om het even welk van het volgende voor de **punten van het Systeem**:
   ...
   * Toon ![ pictogram ](assets/add-icon-plus-in-circle.png) punten tonen die u op het Belangrijkste Menu wilt tonen.
   ...
   >[!NOTE]
   >
   >U kunt de volgorde van systeemitems niet wijzigen. Deze items worden altijd onder aan het hoofdmenu weergegeven wanneer ze actief zijn.
