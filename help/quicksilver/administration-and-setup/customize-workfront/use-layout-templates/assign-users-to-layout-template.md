...
<span class="preview"> voor informatie over lay-outmalplaatjes en bedrijfsprofielen, zie [ Overzicht Bedrijfs van profielen ](/help/quicksilver/administration-and-setup/add-users/create-and-manage-users/business-profiles.md).</span>
...
1. In de doos die verschijnt, klik **een gebruiker, baanrol, team, groep, <span class="preview"> of toegangsniveau</span>** toevoegen, begin de naam van een gebruiker, baanrol, team, groep, <span class="preview"> of toegangsniveau </span> te typen, dan de naam te klikken wanneer het in drop-down verschijnt.
   ...
   Een pictogram van Info ![ pictogram van Info ](assets/info-icon.png) toont rechts van de naam van om het even welke gebruiker, baanrol, team, groep, <span class="preview"> of toegangsniveau </span> dat reeds aan een ander lay-outmalplaatje wordt toegewezen. Als u de muisaanwijzer op het pictogram plaatst, ziet u de naam van de lay-outsjabloon en bepaalt u of u de bestaande toewijzing wilt overschrijven.

1. Herhaal de twee vorige stappen om het lay-outmalplaatje aan andere gebruikers, baanrollen, teams, groep, <span class="preview"> of toegangsniveau </span> toe te wijzen zoals nodig.
...
* <span class="preview"> aan een bepaald toegangsniveau wordt de gebruiker toegewezen aan </span>
...
* <span class="preview"> Toegangsniveau: als de persoon geen lay-outmalplaatje als individuele gebruiker, noch als gebruiker met een primaire baanrol, noch als lid van een team van het Huis, noch als lid van een groep van het Huis wordt toegewezen, zien zij het malplaatje dat aan hun toegangsniveau wordt toegewezen.</span>
