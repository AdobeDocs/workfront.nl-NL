...
>[!IMPORTANT]
>
>Het aanpassen van objecten kopballen is momenteel beschikbaar voor projecten, taken, kwesties, <span class="preview"> portefeuilles, programma&#39;s, malplaatjes, het factureren verslagen, teams, groepen, gebruikers, bedrijven, groepen, en tariefkaarten.</span>
...
1. In **pas aan wat de gebruikers** drop-down menu zien, selecteer een voorwerp de waarvan kopbal u wilt aanpassen.
