...
1. Configureer rechts in het scherm de opties die beschikbaar zijn voor het type aangepast veld dat u toevoegt:
   ...
   <table>
    ...
    <tr>
      ...
      <td><p><span class="preview">Selecteer het type financiële machtiging dat gebruikers moeten hebben voordat ze dit aangepaste veld kunnen weergeven of bewerken. De notatie Valuta moet zijn geselecteerd.</span></p>
      <ul>
