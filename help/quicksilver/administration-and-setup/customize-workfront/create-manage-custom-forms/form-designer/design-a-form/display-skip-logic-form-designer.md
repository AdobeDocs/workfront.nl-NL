 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Geavanceerde weergave-, standaardwaarde-, voorwaardelijke opmaak- of bewerkbaarheidslogica toepassen: Workflow Prime of hoger</p>
         <p>Alle andere logische typen toepassen: Een Workfront- of workflowpakket</p> </td> 
  </tr> 
  <tr> 
...
Met de geavanceerde weergaverelogica voor aangepaste formuliervelden kunt u complexe logica maken met behulp van formules. U kunt deze logica op de volgende gebiedstypes toepassen: tekst van één regel, alinea, tekst met opmaak, vervolgkeuzelijst met één keuze, vervolgkeuzelijst met meerdere keuzen, externe zoekopdracht, externe zoekopdracht met meerdere keuzen, eigen veldverwijzing, typekop, berekend, datum, groep met selectievakjes en keuzerondjes.
...
U kunt geavanceerde standaardwaardelogica op de volgende gebiedstypes toepassen: één regel tekst, paragraaf, enig-uitgezochte drop-down, multi-select dropdown, externe raadpleging, multi-select externe raadpleging. Native veldverwijzing, typeahead, groep selectievakjes en keuzerondjes.
...
U kunt validatielogica toepassen op de volgende veldtypen: één regel tekst, paragraaf, enig-uitgezochte drop-down, multi-select dropdown, externe raadpleging, multi-select externe raadpleging, typeahead, datum, checkbox groep, en radioknopen.
...
U kunt opmaaklogica toepassen op de volgende veldtypen: tekst op één regel, alinea, vervolgkeuzelijst met één keuze, vervolgkeuzelijst met meerdere selecties, externe zoekopdracht, externe zoekopdracht met meerdere selecties, typekop, berekende datum, groep selectievakjes en keuzerondjes.
...
U kunt logica voor bewerkbaarheid toepassen op de volgende veldtypen: tekst van één regel, alinea, tekst met opmaak, één geselecteerd vervolgkeuzemenu, meerkeuzevrijheid, externe zoekopdracht, meerkeuzevrijheid, typekop, datum, groep selectievakjes en keuzerondjes.
