...
1. (Voorwaardelijk) als u creeert of een status voor gebruik systeembreed uitgeeft, zorg ervoor dat **de Statussen van het Systeem** in de doos in de hoger-juiste hoek wordt geselecteerd.
   ...
   ![ status van het Systeem ](assets/system-statuses-in-upper-rt-corner-new-png.png)
   ...
   ![ de statussen van het Systeem voor groep ](assets/system-statuses-in-upper-rt-corner-group-new-png.png)
...
1. Als u een nieuwe status creeert, voegt de klik **een Nieuwe Status** toe.
   ...
   Als u een bestaande status uitgeeft, klik checkbox voor die status, dan klik **uitgeven** in de banner bij de bodem van het scherm.

   ![ geef douanestatus ](assets/edit-in-banner.png) uit
