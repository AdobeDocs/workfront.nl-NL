...
Deze blauwdruk bevat een sjabloon die de [!DNL Workfront] -organisatie voor professionele services al jaren gebruikt tijdens implementatieafspraken met financiële teams om het einde van de maand waarin de boeken worden gesloten, te organiseren. Het model bevat een checklist van gemeenschappelijke activiteiten die elke maand moeten worden voltooid om nauwkeurig te rapporteren over en de gezondheid van het bedrijf te bevorderen.
...
Met deze [!UICONTROL Print: Direct Mail Asset Production] -blauwdruk ordent u het werk voor een productieproces voor afdrukelementen. Deze blauwdruk is bedoeld als ingangspunt voor het beheer van afdrukmateriaal, met name direct mail, in Workfront.

**[!UICONTROL Print: Direct Mail Content Creation and Campaign Execution]**
Met deze [!UICONTROL Print: Direct Mail Content Creation and Execution] -blauwdruk ordent u het werk voor een productieproces voor afdrukelementen. Deze blauwdruk is bedoeld als ingangspunt voor het beheer van afdrukmateriaal, met name direct mail, in Workfront. Deze sjabloon is uniek omdat het ook taken bevat om het element af te drukken en de campagne voor direct mail onafhankelijk van andere campagneactiviteiten uit te voeren.
...
Het [!UICONTROL Social Asset Production] -pakket bevat een sjabloon die het werk ordent om een sociaal artefact te maken. Dit pakket is bedoeld als toegangspunt voor het beheer van de creatie van sociale activa in Workfront. Met dit pakket kunt u een basis leggen voor alle processen voor het maken van sociale inhoud door deze aan te passen aan de behoeften van andere creatieve processen voor sociale inhoud.

**[!UICONTROL Software Implementations/App Development]**
Deze blauwdruk bevat een sjabloon die de [!DNL Workfront] Professional Services-organisatie al jaren gebruikt tijdens implementatieafspraken met IT-teams, waarin het werk wordt georganiseerd om oplossingen van derden te installeren of om interne hulpprogramma&#39;s en toepassingen te maken.
...
Deze blauwdruk bevat één sjabloon waarmee het werk wordt geordend dat een [!DNL Workfront] -klant moet doen om de [!DNL Workfront] -toepassing op een elegante manier uit te voeren.
