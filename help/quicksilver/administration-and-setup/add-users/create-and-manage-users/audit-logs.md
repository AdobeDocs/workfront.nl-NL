...
Het systeem produceert een ingang van het de controlelogboek van het BedrijfsProfiel wanneer een gebruiker één van het volgende doet:

* Creeert een bedrijfsprofiel
* Bewerkt een bedrijfsprofiel:
* Hiermee wordt een bedrijfsprofiel verwijderd
...
>[!NOTE]
>
>Omdat alle organisaties aan Adobe Admin Console zijn geregistreerd, is deze eigenschap niet meer beschikbaar.Zie uw netwerk of beheerder van IT als u meer informatie nodig hebt.
