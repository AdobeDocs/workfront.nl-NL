...
>[!IMPORTANT]
>
>De functionaliteit in dit artikel is alleen beschikbaar nadat het exemplaar van Workfront van uw organisatie is aangemeld bij het Adobe Business Platform.
>
...
* Adobe Admin Console-beheerders kunnen automatische toewijzingsregels instellen om het toewijzen van Adobe-producten aan gebruikers in hun organisatie te automatiseren. Voor meer informatie en instructies, zie [&#x200B; automatische toewijzingsregels beheren &#x200B;](https://helpx.adobe.com/nl/enterprise/using/automatic-assignment-rules.html) in de documentatie van Adobe.
  ...
  >[!NOTE]
  >
  >Als u bij het configureren van automatische toewijzingen een vertrouwde organisatie selecteert, kunt u de organisatie vinden in de sectie Gebruikers in geselecteerde mappen of domeinen. Klik de drop-down pijl naast het **Uitgezochte folder** gebied en selecteer de organisaties. Vertrouwde organisatie is gemarkeerd met een vertrouwde badge.
...
1. In **voeg gebruikers aan dit productprofiel** doos toe, ga het e-mailadres of de naam van een gebruiker in u wilt toevoegen, dan selecteren **sparen**.
   ...
   De gebruiker wordt in Workfront gemaakt met het toegangsniveau van de aanvrager of medewerker, afhankelijk van het Workfront-pakket van uw organisatie.
...
>[!NOTE]
>
>* Als een gebruiker deel uitmaakt van een gebruikersgroep(en) van Admin Console en het productprofiel is toegevoegd aan een of meer van deze gebruikersgroepen, worden deze gebruikers niet daadwerkelijk uit het product verwijderd als de gebruiker uit Workfront wordt gedeactiveerd. De gebruiker moet uit de Gebruikersgroep(en) in Admin Console worden verwijderd.
>* Als u een gebruiker uit de Adobe Admin Console verwijdert, wordt de gebruiker in Workfront gedeactiveerd, maar worden de gebruikers niet uit Workfront verwijderd.

Voor instructies bij het schrappen van gebruikers in Adobe Admin Console, zie [&#x200B; leiden foldergebruikers &#x200B;](https://helpx.adobe.com/nl/enterprise/using/manage-directory-users.html) in de documentatie van Adobe.
