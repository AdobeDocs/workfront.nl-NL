...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td><p>Het profiel van een gebruiker bewerken: een Workfront- of workflowpakket</p>
       <p>Om tariefattributen en de kostentariefopheffing te plaatsen: Workflow Ultimate</p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>U moet een van de volgende opties hebben:</p> 
    ...
    <p>Als u de facturerings- en kostensnelheden voor een gebruiker wilt bewerken, moet u ook de opties Factureringssnelheden bewerken en Kosttarieven verfijnen hebben ingeschakeld.</p> </td> 
  </tr> 
 </tbody> 
</table>
...
* **E-mailadres**: Het e-mailadres voor een gebruiker is ook hun gebruikersbenaming in Workfront. Dit veld is hoofdlettergevoelig en moet uniek zijn. Als een gebruiker drie keer probeert een niet-uniek e-mailadres toe te voegen binnen een venster van 10 minuten, wordt een reCAPTCHA-reactie weergegeven.
  ...
  Omdat uw organisatie naar de Adobe Admin Console is gemigreerd, kunt u het e-mailadres van een gebruiker niet bewerken in Workfront. Het e-mailadres van de gebruiker wordt ingesteld in de Adobe Admin Console.
...
* **&lt;SSO Configuration> UserName**: Als uw Workfront-beheerder een SSO-integratie met Workfront heeft ingeschakeld, wordt de SSO-gebruikersnaam in dit veld weergegeven. Het type SSO-configuratie dat voor uw Workfront-instantie is ingeschakeld, is zichtbaar in dit veld.
* **OnlyAllow &lt;SSO Configuration> Authentificatie**: Als uw beheerder van Workfront een integratie SSO met Workfront toeliet en alle gebruikers voor SSO heeft bijgewerkt, wordt dit gebied door gebrek geselecteerd. Het type SSO-configuratie dat voor uw Workfront-instantie is ingeschakeld, is zichtbaar in dit veld.
...
* **Info van het Contact**: Het de telefoonaantal van de gebruiker (in het **aantal van de Telefoon**, **Uitgang.**, en **Mobiel aantal** gebieden) en adres (in het **Adres**, **Stad**, **Staat**, **Postcode**, en **Land** gebieden).
  ...
  Het **gebied van het Land** in de sectie van Info van het Contact keurt slechts landcodewaarden (bijvoorbeeld, VS, GB, IN) goed.
...
>[!NOTE]
>
>De optie &quot;Automatisch proefdrukken genereren bij het uploaden van documenten&quot; is verwijderd.
...
* **de tariefopheffing van de Kosten toegestaan**: Zet deze optie aan om kostentariefoverschrijvingen voor deze gebruiker op projecten toe te staan. Voor meer informatie, zie [ gebruikerskostentarieven op het projectniveau ](/help/quicksilver/manage-work/projects/project-finances/override-user-cost-rates.md) met voeten treden.
...
Snelheidskenmerken worden ondersteund in gebieden van Workfront waar tarieven bestaan, zoals taakrollen en gebruikers. Wanneer kenmerken op het profiel van een gebruiker worden toegepast, worden de toewijzingen automatisch omgezet in de juiste snelheden.

1. Klik **toevoegen nieuwe reeks**.
1. Selecteer de kenmerkwaarden.

   Uw Workfront-beheerder stelt de beschikbare kenmerken in. Deze kunnen agentschap, plaats, kostenplaats, klant, of andere attributen omvatten noodzakelijk voor uw organisatie.

1. (Optioneel) Een andere set kenmerken met effectieve datums toevoegen:

   1. Klik **toevoegen nieuwe reeks**.
   1. Selecteer een **Datum van het Eind** voor de huidige geplaatste attributen.

      De **Datum van het Begin** voor de volgende reeks wordt automatisch toegevoegd.

   1. Voeg de kenmerkwaarden voor de volgende kenmerkset toe. Deze waarden worden van kracht op de begindatum.
