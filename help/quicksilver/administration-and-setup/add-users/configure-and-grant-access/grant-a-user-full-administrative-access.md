...
>[!IMPORTANT]
>
>De op deze pagina beschreven procedure is alleen van toepassing op organisaties die nog niet aan boord van de Admin Console zijn. Nadat uw organisatie aan de Adobe Admin Console is binnengekomen, moet u deze actie door de Adobe Admin Console uitvoeren.
>
>**omdat alle organisaties nu aan Adobe Admin Console zijn gemigreerd, is de informatie in dit artikel niet meer relevant, en zal in de nabije toekomst worden verwijderd.**
>
