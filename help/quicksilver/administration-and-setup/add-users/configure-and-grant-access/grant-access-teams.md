...
## De toegang van gebruikers tot bewerkingsteams configureren met behulp van een aangepast toegangsniveau
...
Voor informatie over welke gebruikers in elk toegangsniveau met teams kunnen doen, zie de sectie [&#x200B; Teams &#x200B;](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md#teams) in de artikel [&#x200B; Functionaliteit beschikbaar voor elk objecten type &#x200B;](../../../administration-and-setup/add-users/access-levels-and-object-permissions/functionality-available-for-each-object-type.md).
