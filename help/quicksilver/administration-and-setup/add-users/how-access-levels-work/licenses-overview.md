...
>[!NOTE]
>
>De informatie in dit artikel verwijst naar de nieuwe toegangsniveaus. Voor informatie over de niveaus van de erfenistoegang, zie [ overzicht van de niveaus van de Toegang ](/help/quicksilver/administration-and-setup/add-users/access-levels-and-object-permissions/access-levels-overview.md).
...
|--- |--- |
| Standard | Systeembeheerder, standaard |
| Licht | Licht |
