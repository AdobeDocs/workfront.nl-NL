...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td> <p><strong>[!DNL Mac]:</strong> cmd++ <br> of <br> cmd+shift+scroll omhoog</p> <p><strong>[!DNL Windows]:</strong> Ctrl++</p> </td> 
   <td> <p> Inzoomen</p> </td> 
   <td> <p>Inzoomen </p> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>[!DNL Mac]:</strong> cmd+- <br> of <br> cmd+shift+scroll neer</p> <p><strong>[!DNL Windows]:</strong> Ctrl+-</p> </td> 
   <td> <p>Uitzoomen </p> </td> 
   <td> <p>Uitzoomen</p> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>[!DNL Windows]:</strong> spatiebalk ingedrukt houden tijdens het slepen van de afbeelding</p> </td> 
   <td> <p> Pannen</p> </td> 
   <td> <p> Pannen</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td> <p><strong>[!DNL Mac]:</strong> cmd+g</p> <p><strong>[!DNL Windows]:</strong> Ctrl+g</p> <p><strong>[!DNL Mac] en [!DNL Windows]:</strong> Druk op Enter in het veld Zoeken.</p> </td> 
   <td> <p> </p> </td> 
   <td> <p>Volgende zoekresultaat</p> </td> 
  </tr> 
  <tr> 
   <td> <p><strong>[!DNL Mac]:</strong> cmd+Shift+g</p> <p><strong>[!DNL Windows]:</strong> Ctrl+Shift+g</p> <p><strong>[!DNL Mac] en [!DNL Windows]:</strong> Druk op Shift+Enter in het veld Zoeken.</p> </td> 
   <td> <p> </p> </td> 
