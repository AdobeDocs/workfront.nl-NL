...
Een van de leuke dingen van [!DNL Workfront Proof] is dat iedereen een bewijs kan bekijken, dat je niet je eigen [!DNL Workfront Proof] hoeft te hebben om dat te doen. Ontvangers ontvangen een e-mail met een persoonlijke URL waarmee ze rechtstreeks naar de proefdrukpagina gaan, zonder dat ze zich hoeven aan te melden bij [!DNL Workfront Proof] .

Nochtans, als u hogere niveaus van veiligheid voor uw overzicht en goedkeuringsproces vereist, kunt u login aan de proef gebruiken. Dit betekent dat alleen [!DNL Workfront Proof] -gebruikers aan de proefdruk kunnen worden toegevoegd. En ze moeten hun e-mail en wachtwoord invoeren voordat ze het kunnen openen.

>[!NOTE]
>
>* *opdat iemand zich aan de proef (wanneer vereist Login is toegelaten) aanmelden, moeten zij aan de proef zijn toegevoegd.*
>* *als vereiste Login wordt toegelaten, kunnen de Abonnementen niet worden toegelaten.*
...
1. Selecteer **[!UICONTROL Require login]** onder **[!UICONTROL Proof settings]** voor een nieuwe proefdruk.\
   of\
   Selecteer **[!UICONTROL Login required]** onder **[!UICONTROL Settings]** voor een bestaande proefdruk.
...
1. Schakel onder **[!UICONTROL Proof settings]** de optie **[!UICONTROL Download original file]** uit voor een nieuwe proefdruk.\
   of\
   Selecteer **[!UICONTROL Download of original file]** onder **[!UICONTROL Settings]** voor een bestaande proefdruk.
...
1. Schakel onder **[!UICONTROL Proof settings]** de optie **[!UICONTROL Subscribe to proof via public URL or embed code]** uit voor een nieuwe proefdruk.\
   of\
   Selecteer **[!UICONTROL Subscription]** onder **[!UICONTROL Settings]** voor een bestaande proefdruk.
