...
1. Voer een van de volgende handelingen uit om conflicten met taakrollen op te lossen:
   ...
   * Houd de cursor boven de naam van de taakrol en klik op het **[!UICONTROL delete]pictogram** ![](assets/delete.png) om de taakrol uit het initiatief te verwijderen.
