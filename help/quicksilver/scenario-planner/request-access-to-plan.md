...
title: Machtigingen aanvragen voor een abonnement in het scenario Scenario Planner
...
# Rechten aanvragen voor een abonnement in de [!DNL Scenario Planner]

<!--Audited: 11/2025-->

U kunt machtigingen aanvragen voor een abonnement in de [!DNL Adobe Workfront Scenario Planner] wanneer de koppeling naar het abonnement met u wordt gedeeld.
...
## Machtigingen aanvragen voor plannen in de [!DNL Workfront Scenario Planner]
...
1. Klik op een koppeling naar een abonnement.
   ...
   ![ de toestemmingen van het Verzoek om ](assets/request-access-to-plan-350x277.png) te plannen
