...
title: Vorm hoe Workfront middeluur en FTE beschikbaarheid voor het Plannende gebied berekent
description: De Adobe Workfront-beheerder bepaalt hoe Workfront de beschikbaarheid van bronnen en de gebruikerstoewijzing op systeemniveau berekent (rekening houdend met uren en beschikbaarheid van FTE) wanneer ze de voorkeuren voor het beheer van bronnen configureren.
author: Alina
...
# Vorm hoe Workfront middeluur en FTE beschikbaarheid voor het Plannende gebied berekent
...
De Adobe Workfront-beheerder bepaalt hoe Workfront de beschikbaarheid van bronnen en de gebruikerstoewijzing op systeemniveau berekent (rekening houdend met uren en beschikbaarheid van FTE) wanneer ze de voorkeuren voor het beheer van bronnen configureren.

Ze kunnen een van de volgende opties kiezen:
...
* Wanneer Workfront automatisch bronnen mag toewijzen, zoals beschreven in het volgende artikel:
...
* Bij het weergeven van toewijzingsindicatoren, zoals beschreven in het volgende artikel:

   * Het gedeelte &quot;Toewijzingsindicatoren&quot; in het artikel  [Gebruikerstoewijzingen beheren in de planningsgebieden](../../resource-mgmt/resource-scheduling/manage-allocations-scheduling-areas.md).
