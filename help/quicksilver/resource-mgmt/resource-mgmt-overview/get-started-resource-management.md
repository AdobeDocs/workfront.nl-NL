...
* Een gebruiker met een Standard- of Plan-licentie.
   ...
   * Bewerk de toegang tot financiële gegevens, waaronder toegang tot weergaven of kostenpercentages bewerken en Algemene financiën weergeven of bewerken, om kosteninformatie weer te geven in de functie voor middelenplanner
   * Toegang tot financiële gegevens weergeven, waaronder toegang tot weergaven of kostenpercentages bewerken en Algemene financiën weergeven, om informatie over kosten en baten weer te geven in het gebruiksrapport (alleen gebruikers met een abonnement of standaardlicentie)
