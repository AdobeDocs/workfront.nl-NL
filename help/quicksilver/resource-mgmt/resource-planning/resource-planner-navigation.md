...
![&#x200B; Planner van het Middel &#x200B;](assets/resource-planner-overview.png)

In de volgende secties worden alle gebieden van de bronnenplanner beschreven.

## Tijdlijn van projecten

![&#x200B; kalender van de Chronologie &#x200B;](assets/calendar-months.png)
...
![&#x200B; selectie Timeframe &#x200B;](assets/timeframe-selection.png)
...
![&#x200B; Mening door project, rol, of gebruiker &#x200B;](assets/view-by-drop-down.png)
...
![&#x200B; prioriteit van de Planning van het Project &#x200B;](assets/project-ranking.png)
...
![&#x200B; Geen sectie van de Gebruiker &#x200B;](assets/no-user.png)

## Filters

Met behulp van filters kunt u de informatie beperken die u weergeeft in de functie Bronnen.

![&#x200B; knoop van de Filter &#x200B;](assets/filter-button.png)
...
![&#x200B; de montagespictogram van de Planner van het Middel &#x200B;](assets/settings-icon.png)
...
* **Prioriteiten van Portfolio van de Vertoning**: Toont de projectprioriteiten volgens Portfolio zij aan worden toegewezen.
  ...
  ![&#x200B; montages van de Planner van het Middel &#x200B;](assets/resource-planner-settings.png)
