...
1. <span class="preview"> (Facultatief) Beweeg over de gebiedsnaam in de lijstmening, klik het drop-down menu rechts van de gebiedsnaam, dan klik **uitgeeft gebied**.</span>
1. <span class="preview"> draai **waarden** het plaatsen tonen om de waarden voor elke keus te tonen. De waarden zijn de namen van elke keuze, zoals deze worden weergegeven in de Workfront-database. </span>

   >[!NOTE]
   >
   >* <span class="preview"> Workfront wijst unieke waarden voor elke keus toe. </span>
   >
   >* <span class="preview"> de Waarden passen de keus naam in het formaat in kleine letters aan. Meerdere woorden worden gescheiden door een onderstrepingsteken. </span>
   >
   >* <span class="preview"> Waarden kunnen tussen veelvoudige gebieden worden herhaald, maar zij moeten voor één gebied uniek zijn.</span>
   >
   ><span class="preview"> ![ toon waardeknevel ](assets/show-values-toggle-and-choices-with-values.png)</span>

1. <span class="preview"> (Optioneel) Gebruik de keuzevelden in uw API-aanroepen en andere integraties. </span>
