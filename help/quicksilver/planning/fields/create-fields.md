...
1. Op het **Nieuwe gebied** lusje, onderzoek naar een gebiedstype op het **type van Gebied** vakje, of selecteer van de volgende gebiedstypes:
   ...
   * <span class="preview">[&#x200B; identiteitskaart van het Verslag &#x200B;](#record-id)</span>
...
>[!TIP]
>
>* Wanneer u de naam van een gebruiker op een gebied van Mensen toevoegt, hun primaire baanrol <span class="preview"> en hun e-mail </span> ook tonen op het gebied. U moet de instelling Contactgegevens weergeven hebben ingeschakeld voor het object Users in uw toegangsniveau om de e-mail van de gebruiker te kunnen zien.
>
