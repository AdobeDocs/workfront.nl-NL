...
1. Op het **Nieuwe gebied** lusje, onderzoek naar een gebiedstype op het **type van Gebied** vakje, of selecteer van de volgende gebiedstypes:
   ...
   * [&#x200B; identiteitskaart van het Verslag &#x200B;](#record-id)
...
Met het veldtype Personen kunt u een gebruiker aan een record toevoegen. Dit is een type-vooruit gebied, en u kunt slechts gebruikers <!--, roles, or teams--> toevoegen die reeds in uw instantie van Workfront bestaan.

>[!TIP]
>
>* Wanneer u de naam van een gebruiker toevoegt in een veld Personen, worden de rol van de primaire taak en de bijbehorende e-mail ook weergegeven in het veld. U moet de instelling Contactgegevens weergeven hebben ingeschakeld voor het object Users in uw toegangsniveau om de e-mail van de gebruiker te kunnen zien.
>
>* Alleen gebruikers die aan de Adobe Admin Console zijn toegevoegd, worden in de velden Personen weergegeven. Workfront-gebruikers worden niet weergegeven wanneer ze proberen ze toe te voegen in het veld Personen.
>
...
U kunt het het gebiedstype van identiteitskaart van het Verslag gebruiken om een systeem-geproduceerde, read-only herkenningsteken voor elke verslag te tonen.

Wanneer het veld Record-id wordt gemaakt, wordt automatisch een alfanumerieke waarde ingevuld. U kunt het in formules gebieden en in API integraties gebruiken om elke verslag uniek te identificeren.

U kunt de waarde van een veld Record-id niet handmatig wijzigen.

1. Begin creërend een gebied zoals die in de sectie [&#x200B; wordt beschreven creeer gebieden van kras &#x200B;](#create-fields-from-scratch) in dit artikel, dan selecteer het **identiteitskaart van het Verslag** gebiedstype.

   ![&#x200B; het gebiedstype van identiteitskaart van het Verslag &#x200B;](assets/record-id-field-type.png)
...
1. Klik **creëren**.
   ...
   Het nieuwe veld Id van record wordt toegevoegd als een kolom aan het recordtype en de waarden ervan worden voorgevuld met een alfanumerieke waarde.
