...
* Velden van de volgende typen worden niet ondersteund en kunnen niet worden toegewezen aan velden op het importblad:
   ...
   * Verbindingsvelden met Workfront, Adobe Experience Manager-objecttypen of GenStudio Brands.
   * Velden opzoeken van verbonden planningsrecords, Workfront-, Adobe Experience Manager-objecten of GenStudio-merken.
   * Formuliervelden
   * Gemaakt op
   * Laatst gewijzigd op
   * Goedgekeurd op
...
1. (Facultatief) klik het **lusje van de Verbinding** om de informatie in de kolom aan een verbonden gebied van andere verslagtypes in kaart te brengen.
   ...
   >[!TIP]
   >
   >U kunt slechts aan gebieden van de Planning van Workfront verbonden verslagen in kaart brengen. U kunt geen velden toewijzen vanuit Workfront-, Adobe Experience Manager- of GenStudio Brands-verbindingen. Voor meer informatie, zie de sectie [ Overwegingen over het invoeren van verslagtypes gebruikend een Excel of Csv- dossier ](#considerations-about-importing-record-types-using-an-excel-or-csv-file) in dit artikel.
