...
* Overweeg het volgende over het verbinden van verslag en objecten types:
   ...
   * In de volgende gevallen wordt automatisch een verbinding tussen entiteiten tot stand gebracht:
      ...
      * Wanneer u aanvraagformulieren configureert voor een recordtype om een record of een object te maken.
        ...
        U kunt het originele verzoek op het gebied van Verzoeken van Workfront <!--, <span class="preview">or in the Original Request connection field in Workfront Planning.</span>--> bekijken.
