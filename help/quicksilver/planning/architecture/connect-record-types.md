...
* In the Production environment, you cannot add Workfront user fields (including fields like Project Owner, or Project Sponsor) as lookup fields. <span class="preview">You can add user fields as lookup fields in the Preview environment.</span>-->
    ...
    >[!TIP] 
    > 
    >* U kunt geen Workfront typeahead of gebruikersgebieden (met inbegrip van gebieden zoals de Eigenaar van het Project, of Sponsor van het Project) als raadplegingsgebieden toevoegen.
    > 
    >* de informatie van het de datumgebied van Workfront voorwerpen toont in 24 uurformaat in de Planning van Workfront, ongeacht hoe het in Workfront toont.
    >
