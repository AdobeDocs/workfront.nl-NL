...
1. Zoek naar een recordtype, of selecteer één van het volgende:
   ...
   * **Experience Manager** van de **Toepassingen van Adobe** sectie, om met AEM Assets of de Fragmenten van de Inhoud te verbinden.
   ...
   * **Merken** van Adobe GenStudio for Performance Marketing van de **Adobe GenStudio** sectie
