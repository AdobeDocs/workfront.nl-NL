...
1. Zoek naar een recordtype, of selecteer één van het volgende:
   ...
   * Een recordtype van een andere werkruimte die werd gevormd om van andere werkruimten te verbinden.
     ...
     >[!TIP]
     >
     ><span class="preview"> u kunt de volgende toetsenbordcombinatie gebruiken om het globale onderzoeksvakje van om het even welke Workfront Plannende pagina en onderzoek naar verslagtypes te openen:</span>
     >
     >* <span class="preview"> CTRL+K voor Vensters </span>
     >* <span class="preview">⌘+K voor Mac </span>
     >
     >![ Globale onderzoeksdoos ](assets/global-search-box.png)
   ...
   * Een **Origineel verzoek** objecten type van de **3} sectie van de Types van Objecten van Workfront.**
   ...
   * **Experience Manager** van de **Toepassingen van Adobe** sectie.

     ![ de verbindingsselectie van AEM Assets ](assets/aem-assets-connection-selection-041326.png)
...
1. Selecteer **creeer corresponderend gebied op verbonden verslagtype**. Als deze optie is geselecteerd, wordt een verbindingsveld gemaakt op het recordtype waarmee u verbinding maakt, naast het verbindingsveld dat aan het huidige recordtype is toegevoegd. Dit is standaard uitgeschakeld.
   ...
   >
   >* Een gekoppeld recordveld wordt niet gemaakt voor objecten uit een andere toepassing in hun respectievelijke toepassingen. Er is bijvoorbeeld geen veld gemaakt voor Workfront-objecten die zijn verbonden met planningsrecords.
   >
   >   
...
1. (Voorwaardelijk) wanneer u om met Experience Manager selecteert te verbinden, kies een bewaarplaats van de **bewaarplaats van Experience Manager** drop-down menu in de **activa van de Verbinding van de volgende bewaarplaats** sectie. Dit is een verplicht veld. Alleen repositories waartoe u toegang hebt in Experience Manager-weergave in dit veld.

   >[!NOTE]
   >
   >Uw Workfront-beheerder kan Workfront-planningsvelden toewijzen aan Experience Manager-velden via de metagegevenstoewijzing in Workfront. Voor meer informatie, zie [ activa meta-gegevensafbeelding tussen Adobe Workfront en Experience Manager Assets ](https://experienceleague.adobe.com/en/docs/experience-manager-cloud-service/content/assets/integrations/configure-asset-metadata-mapping) vormen.


1. (Voorwaardelijk) wanneer u om met Experience Manager, aan een het verslagtype van de Planning van Workfront, of aan een Merk van GenStudio selecteert te verbinden, één van de volgende opties op het **vormgeving van het Verslag** gebied kiezen:
...
1. Selecteer de **Uitgezochte raadplegingsgebieden** om gebieden van het verslagtype toe te voegen u met verbindt. De opzoekvelden zijn velden die zijn gekoppeld aan het record- of objecttype waarnaar u een koppeling maakt. Als u deze koppelt, wordt informatie weergegeven uit de record of het object waarnaar u een koppeling maakt in de record waarvan u een koppeling maakt. Dit is standaard geselecteerd.
   ...
   >[!TIP]
   >
   >* U kunt geen verwijzingsgebieden van een andere toepassing als raadplegingsgebieden toevoegen. Bijvoorbeeld, kunt u niet de Groep of het Bedrijf van het Project als raadplegingsgebied in Planning toevoegen wanneer u met de projecten van Workfront verbindt.
   >
   >* In de productieomgeving kunt u geen Workfront-gebruikersvelden (zoals velden zoals Projecteigenaar of Projectsponsor) toevoegen als opzoekvelden. <span class="preview"> u kunt gebruikersgebieden als raadplegingsgebieden in het milieu van de Voorproef toevoegen.</span>
   >
