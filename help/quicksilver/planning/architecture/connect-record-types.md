...
1. Zoek naar een recordtype, of selecteer één van het volgende:
   ...
   * Een **Origineel verzoek** objecten type van de **3} sectie van de Types van Objecten van Workfront.**
     ...
     Het oorspronkelijke gemaakte aanvraagverbindingsveld geeft de naam weer van het verzonden planningsverzoek waarmee het object is gemaakt.

     >[!NOTE]
     >
     >U moet aanvraagformulieren maken en ze openbaar maken om planningsverzoeken in te dienen om records te maken in Workfront Planning.
     >
