...
U kunt een werkruimte op de volgende manieren bewerken:

* Handmatig.

  In dit artikel wordt beschreven hoe u een werkruimte handmatig kunt bewerken.

* De door AI aangedreven planningsDesigner gebruiken. Deze mogelijkheid is momenteel alleen beschikbaar in een beperkt Beta-programma.
...
1. (Voorwaardelijk) Als u een Workfront-beheerder bent, klikt u op een van de volgende opties:

   * **Werkruimten ik** aan toegangs werkruimten ben u creeerde
   * **Alle werkruimten** om tot werkruimten toegang te hebben die met u of werkruimten worden gedeeld u creeerde
...
of
   * Klik het **pictogram van het 1&rbrace; onderzoek** pictogram van het Onderzoek ![&#x200B; in de hoger-juiste hoek van de pagina van Werkruimten aan onderzoek naar een werkruimte door naam en klik een werkruimtekaart om de werkruimte te openen, dan klik het &#x200B;](assets/search-icon.png) Meer **menu** Meer menu ![&#x200B; aan het recht van de werkruimtenaam.](assets/more-menu.png)
   ...
   >[!TIP]
   >
   ><span class="preview"> u kunt de volgende toetsenbordcombinatie gebruiken om het globale onderzoeksvakje van om het even welke Workfront Plannende pagina en onderzoek naar werkruimten te openen:</span>
   >
