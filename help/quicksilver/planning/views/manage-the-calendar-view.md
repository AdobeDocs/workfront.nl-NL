...
1. Klik **toevoegen voorwaarde** en voeg de volgende informatie toe:
   ...
   * **selecteer een gebied** <span class="preview"> om naar een gebied te zoeken of </span> klik het drop-down menu om een lijst van gebieden te tonen en het van de lijst te selecteren
