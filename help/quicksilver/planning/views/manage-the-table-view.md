...
1. (Optioneel) Klik op het pictogram **Velden** pictogram ![ in de werkbalk op de velden ](assets/fields-icon.png) Velden <!--or <span class="preview"> search for a field</span>,--> en schakel de schakeloptie rechts van de veldnaam uit om het veld te verbergen.
