...
1. Plaats over de kolomkopbal, dan klik de naar beneden-richten pijl, dan klik **gebied van de Huid**
   ...
   >
   >Door gebrek, tonen de verborgen gebieden niet in de 20} de voorproefdoos van Details van het verslag **.** Alle velden worden weergegeven op de pagina Details van de record. Voor informatie, zie [ de lay-out van de verslagpagina beheren ](/help/quicksilver/planning/records/manage-the-record-page.md).
