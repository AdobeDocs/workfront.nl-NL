...
1. Plaats over de kolomkopbal, dan klik de naar beneden-richten pijl, dan klik **gebied van de Huid**
   ...
   >
   ><span class="preview"> door gebrek, tonen de verborgen gebieden niet in de 1&rbrace; 2&rbrace; voorproefdoos van de Details van het verslag &lbrace;. **&#x200B;**&#x200B;Alle velden worden weergegeven op de pagina Details van de record. Voor informatie, zie [&#x200B; de lay-out van de verslagpagina beheren &#x200B;](/help/quicksilver/planning/records/manage-the-record-page.md)</span>
...
1. <span class="preview"> (Optioneel) Kies A-Z of Z-A in het keuzemenu Sorteren rechts van een geselecteerd veld. Hiermee sorteert u de groepen in de tijdlijn op basis hiervan.</span>
...
1. Klik het drop-down menu naast avatars, de draai **toont samenwerkers** het plaatsen. De instelling is standaard ingeschakeld.
...
1. <span class="preview"> (Optioneel) Klik op het driehoekje rechtsboven in de cel dat het veld bevat dat door anderen is bewerkt. Een lijst van gebruikers die momenteel het gebied uitgeven toont.</span>

>[!TIP]
>
><span class="preview"> de aanwezigheidsindicatoren in real time tonen gebruikers die momenteel een gebied in de Planning van Workfront overal uitgeven. Dit omvat of de lijstmening of het gebied van Details van het verslag.</span>
