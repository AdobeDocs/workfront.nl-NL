...
1. Plaats over de kolomkopbal, dan klik de naar beneden-richten pijl, dan klik **gebied van de Huid**
   ...
   >
   >Door gebrek, tonen de verborgen gebieden niet in de 20&rbrace; de voorproefdoos van Details van het verslag **.** Alle velden worden weergegeven op de pagina Details van de record. Voor informatie, zie [&#x200B; de lay-out van de verslagpagina beheren &#x200B;](/help/quicksilver/planning/records/manage-the-record-page.md).
...
1. (Optioneel) Klik op het driehoekje rechtsboven in de cel met het veld dat door anderen is bewerkt. Er wordt een lijst weergegeven met gebruikers die het veld op dat moment bewerken.

>[!TIP]
>
>De indicatoren van de aanwezigheid in real time tonen gebruikers die momenteel een gebied in de Planning van Workfront overal uitgeven. Dit omvat de tabelweergave of het gebied Details van de record.
