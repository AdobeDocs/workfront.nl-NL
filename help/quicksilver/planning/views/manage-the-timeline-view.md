...
1. (Voorwaardelijk) Als uw beheerder aangepaste kwarten heeft toegelaten, en Workfront problemen met de manier ontdekt de douanekwarten worden gevormd, zou u een waarschuwing kunnen ontvangen wanneer het openen van de chronologiemening.
   ...
   * Als er tussenruimten of overlappingen zijn gevonden tussen de datums van de kwartalen, ontvangt u mogelijk een melding dat aangepaste kwartalen nu kunnen worden ingesteld en wellicht moeten worden bewerkt.
     ...
     >[!TIP]
     >
     >Dit bericht moet direct worden weergegeven nadat uw organisatie Planningen en aangepaste kwartalen al waren ingeschakeld voor de aankoop. Overlappingen en tussenruimten zijn niet toegestaan nadat u Workfront Planning voor uw organisatie hebt ingeschakeld.
...
1. Voer een van de volgende handelingen uit om records te maken in de tijdlijnweergave of de datums ervan te bewerken:
   ...
   * Sleep records om de positie en datums in de tijdlijn bij te werken. Als u de balken van de records verplaatst, worden de begin- en einddatum onmiddellijk bijgewerkt.
   ...
   >[!TIP]
   >
   >Vergroten/verkleinen en slepen van records is niet mogelijk in de tijdlijn voor Workfront- en Adobe Experience Manager-objecttypen die in afsplitsingen worden weergegeven.
...
1. <span class="preview"> (Optioneel en voorwaardelijk) Afhankelijk van het veldtype waarop u wilt groeperen, selecteert u een van de volgende sorteeropties om de groepen in oplopende of aflopende volgorde te sorteren: </span>

   <div class="preview">

   * **A -> Z** of **Z -> A** voor Uitgezochte gebieden, de gebieden van de Tekst, de gebieden van de Paragraaf, Verbonden verslagen of voorwerpen, de gebieden van Mensen
   * **0 -> 9** of **9 -> 0** voor Aantal, Valuta, of de gebieden van het Percentage.
   * **vroegst -> recentste** of **laatste -> vroegst** voor de gebieden van de Datum

   </div>

   <span class="preview"> De groepen in de tijdlijnweergave worden dienovereenkomstig gesorteerd. De verslagen binnen de groeperingen worden gesorteerd in de orde van hun **datum van het Begin** die het gebrek sorteren is. </span>
