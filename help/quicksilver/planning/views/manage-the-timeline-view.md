...
1. <span class="preview"> (Facultatief) klik **A -> Z** of **Z -> a** drop-down menu naast de naam van het geselecteerde gebied om een het stijgen of dalende sorteervolgorde voor de groepering te selecteren. De groepen worden weergegeven in de alfabetische volgorde waarin u in de tijdlijnweergave hebt geselecteerd. </span>
