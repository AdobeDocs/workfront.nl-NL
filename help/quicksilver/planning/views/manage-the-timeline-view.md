...
1. (Optioneel en voorwaardelijk) Afhankelijk van het veldtype waarop u wilt groeperen, selecteert u een van de volgende sorteeropties om de groepen in oplopende of aflopende volgorde te sorteren:
   ...
   * **vroegst -> recentste** of **laatste -> vroegst** voor de gebieden van de Datum
   ...
   De groepen in de tijdlijnweergave worden dienovereenkomstig gesorteerd. De verslagen binnen de groeperingen worden gesorteerd in de orde van hun **datum van het Begin** die het gebrek sorteren is.
