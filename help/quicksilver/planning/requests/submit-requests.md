...
* U hebt geen toegang tot de aanvraagformulieren voor Workfront-planningsaanvragen zonder een specifieke koppeling naar de formulieren.
* U kunt een aanvraag niet bewerken nadat u deze hebt verzonden naar Workfront Planning.
* Met elk verzonden verzoek wordt een record gemaakt voor het recordtype dat is gekoppeld aan het formulier dat u gebruikt.
...
1. Werk de velden bij die beschikbaar zijn in het formulier. Velden met een sterretje zijn vereist.
   ...
   >[!TIP]
   >
   >   Als het van het Onderwerp van Workfront **** gebied beschikbaar is, zou het niet in de Planning van Workfront zichtbaar kunnen zijn. Wij adviseren dat u zoveel mogelijk gebieden in uw verzoek bijwerkt om het nieuwe verslag identificeerbaar te maken wanneer het aan het verslagtype wordt toegevoegd.
