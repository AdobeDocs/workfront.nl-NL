...
1. <span class="preview"> (Voorwaardelijk) Als u een systeembeheerder bent, kunt u uit de volgende opties kiezen: </span>
...
1. In de **toegang van de Verlening tot dit werkruimte** gebied, begin de naam van een gebruiker, een groep, een team, een bedrijf, of baanrol te typen dan het te klikken wanneer het in de lijst toont. <!--update screen shot at the release of system-wide permissions for workspaces-->
