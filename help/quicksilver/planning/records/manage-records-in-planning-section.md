...
* Een recordtype wordt alleen weergegeven in het planningsgebied van een Workfront-object wanneer u het selectievakje corresponderend veld maken voor de instelling van het gekoppelde recordtype inschakelt bij het maken van de verbinding tussen twee recordtypen.
...
* Een recordtype wordt alleen in een aangepast veld van een Workfront-object voor een planningsverbinding weergegeven wanneer u het selectievakje corresponderend veld maken voor de instelling van het gekoppelde recordtype inschakelt bij het maken van de verbinding tussen twee recordtypen.
