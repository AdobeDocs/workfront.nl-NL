...
1. Voeg **@** toe die door de naam van een gebruiker of van een team wordt gevolgd om hen in de update te etiketteren. Voor meer informatie, zie de sectie [ Overwegingen over het becommentariëren over een verslag ](#considerations-about-commenting-on-a-record) in dit artikel.
