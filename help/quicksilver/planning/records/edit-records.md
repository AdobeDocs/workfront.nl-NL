...
* De volgende typen velden worden automatisch bijgewerkt en u kunt de waarden ervan niet handmatig bewerken:
   ...
   * Formuliervelden
   * Systeemvelden (Gemaakt door, Gemaakt op, Laatst gewijzigd door, Datum Laatst gewijzigd, Datum goedgekeurd, Datum goedgekeurd door <!--, <span class="preview">Record ID</span>-->)
