...
* De volgende typen velden worden automatisch bijgewerkt en u kunt de waarden ervan niet handmatig bewerken:
   ...
   * Formuliervelden
   * De gebieden van het systeem (die door, Gemaakt datum, Laatst gewijzigd door, Laatste gewijzigde datum, Goedgekeurde datum worden gecreeerd, die door, <span class="preview"> identiteitskaart van het Verslag </span> wordt goedgekeurd)
...
* U kunt een omslagafbeelding aan elke record toevoegen. De afbeelding is uniek voor elke record en is niet van toepassing op alle records van hetzelfde moment. Voor informatie, zie [ een omslagbeeld aan een verslag ](/help/quicksilver/planning/records/add-a-cover-image-to-a-record.md) toevoegen.
* U kunt de volgorde van de velden op de detailpagina van een record bewerken. Voor meer informatie, zie [ de lay-out van de verslagpagina beheren ](/help/quicksilver/planning/records/manage-the-record-page.md).
* U kunt de begin- en einddatums van een record bewerken door de grootte of de positie van de records in de tijdlijn- en de kalenderweergave te wijzigen.
  ...
  U kunt de grootte of positie van records niet wijzigen als de begin- en einddatum die u voor de record hebt gekozen, alleen-lezen zijn. U kunt bijvoorbeeld het formaat of de positie van de record in een tijdlijn en de kalenderweergave niet wijzigen als u opzoekings- of formuleringsvelden gebruikt voor de begin- en einddatum van een record. <!--this also repeats below, for the timeline and the calendar views; also update there, if this changes-->

  Zie een van de volgende secties in dit artikel als u de datums van de records wilt bewerken:

   * [Een record bewerken in de kalenderweergave van een recordtype](#edit-a-record-in-the-calendar-view-of-a-record-type)
   * [Een record bewerken in de tijdlijnweergave van een recordtype](#edit-a-record-in-the-timeline-view-of-a-record-type)
...
1. (Optioneel) Klik op het zoekvak en voeg een trefwoord toe om een record te zoeken die u wilt bewerken.
...
1. Klik op een recordbalk en houd deze ingedrukt en sleep deze naar een andere positie om de tijdlijn en datums bij te werken. De begin- en einddatum van de record worden automatisch bijgewerkt.
   ...
   >[!IMPORTANT]
   >
   >U kunt de uiteinden van een recordbalk niet slepen en neerzetten en u kunt de record niet naar een andere datum slepen wanneer de begin- en einddatum die u voor de record hebt gekozen, alleen-lezen zijn. U kunt bijvoorbeeld het formaat of de positie van de record in een tijdlijnweergave niet wijzigen wanneer u opzoekvelden of formuleringsvelden gebruikt voor de begin- en einddatum van een record. <!--this also repeats in Considerations and in editing in the calendar view; also update there, if this changes-->
...
1. Klik op een recordbalk en houd deze ingedrukt en sleep deze naar een andere positie om de tijdlijn en datums bij te werken. De begin- en einddatum van de record worden automatisch bijgewerkt.
   ...
   >[!IMPORTANT]
   >
   >U kunt de uiteinden van een recordbalk niet slepen en neerzetten en u kunt de record niet naar een andere datum slepen wanneer de begin- en einddatum die u voor de record hebt gekozen, alleen-lezen zijn. U kunt bijvoorbeeld de grootte of positie van de record in een kalenderweergave niet wijzigen wanneer u opzoekvelden of formuleringsvelden gebruikt voor de begin- en einddatum van een record. <!--this also repeats in Considerations and in editing in the timeline view; also update there, if this changes-->
...
1. Typ de naam van de keus u wilt toevoegen, dan klik **kiezen** toevoegen.
   ...
   Aan elke keuze wordt ook een nieuwe keuzevrijheid toegevoegd. U kunt de keuzevelden gebruiken in API-aanroepen of andere integraties. Voor informatie, zie [ gebieden ](/help/quicksilver/planning/fields/create-fields.md) creëren.
