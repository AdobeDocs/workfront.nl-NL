---
title: Objecten maken met Adobe Workfront Planning Record Automations
description: Nadat u automatisering in de Planning van Adobe Workfront vormde en activeerde, kunt u hen gebruiken om voorwerpen in Adobe Workfront of verslagen in de Planning van Adobe Workfront tot stand te brengen. In dit artikel wordt beschreven hoe u records of objecten maakt met behulp van een bestaande automatisering.
...
U kunt bijvoorbeeld een bestaande automatisering gebruiken die een Workfront-planningscampagne voert en een project maakt in Workfront om de voortgang van die campagne te volgen. Het project zou worden verbonden met de campagne van de Planning van Workfront op het Verbonden gebied van het Project op de campagne.
...
<tr> 
   ...
   <td> <p>Draag of hogere toestemmingen aan de werkruimte en aan het verslagtype bij waar u voorwerpen gebruikend bestaande automatiseringen wilt tot stand brengen. </p>  
...
In deze sectie wordt beschreven hoe u objecten maakt met een Button-automatisering.
