...
1. (Optioneel) Als u naar een verbonden record wilt navigeren, klikt u op de naam van die record in de broodkruimel boven aan de detailpagina. <span class="preview"> als u niet de naam van een verslag in breadcrumb kunt zien, klik **Meer**. Hierdoor wordt de broodkruimel op meerdere rijen weergegeven. Klik **Minder** om breadcrumb te verkorten en het op één rij te tonen.</span>
