...
1. <span class="preview"> (Optioneel en voorwaardelijk) Afhankelijk van de velden die u wilt weergeven op de pagina Details voert u een van de volgende handelingen uit: </span>
   ...
   * Selecteer **tonen lijstgebieden** plaatsen om slechts gebieden te bekijken die niet in de de lijstmening van het verslag verborgen zijn. Dit is de standaardinstelling
   * Deselecteer **Tonen lijstgebieden** het plaatsen om gebied alle gebieden van de de lijstmening van het verslag, met inbegrip van de verborgen degenen te bekijken.

   </div>

   >[!TIP]
   >
   ><span class="preview"> het **plaatsen van de Lijst van de Tonen** is beschikbaar slechts in de de voorproefdoos van Details van het verslag. Het is niet beschikbaar in de pagina van de Details van het verslag.</span>
