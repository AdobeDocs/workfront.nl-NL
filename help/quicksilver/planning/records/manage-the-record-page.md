...
1. (Optioneel en voorwaardelijk) Afhankelijk van de velden die u wilt weergeven op de pagina Details voert u een van de volgende handelingen uit:
   ...
   * Deselecteer **tonen alle gebieden** het plaatsen om de gebieden van het verslag uit te sluiten die in de lijstmening van het verslag van de **3&rbrace; pagina van Details &lbrace;verborgen zijn.**
