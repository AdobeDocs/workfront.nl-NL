...
<p>Neem voor meer informatie over wat er in elk planningspakket voor Workfront staat, contact op met uw Workfront-accountvertegenwoordiger. </p> 
  ...
  <tr> 
   ...
   <td><p>Standard</p>
   <p>Systeembeheerder heeft toegang om automatisering te configureren op basis van wijziging van veldwaarde</p>
   </td> 
  </tr> 
  <tr> 
...
1. (Voorwaardelijk) als u **de waardeverandering van het Gebied** selecteerde, doe het volgende in de **sectie van Montages**:
   ...
   1. Kies een veld in de keuzelijst. Dit zijn velden die zijn gekoppeld aan het geselecteerde recordtype.
   1. Ga verder met het definiëren van voorwaarden voor het geselecteerde veld.
   1. Klik **toevoegen voorwaarde** om tot 5 gebieden toe te voegen en hun voorwaarde te bepalen.

      U kunt de volgende typen velden toevoegen:
      ...
      * Datum
      ...
      >[!TIP]
      >
      >De bepaling in elke voorwaarde verandert met het type van gebieden u selecteert.
...
1. (Facultatief) om, een automatisering, van een lijst van automatiseringen te bekijken onbruikbaar te maken of te schrappen, het **Meer** menu ![&#x200B; Meer menu &#x200B;](assets/more-menu.png) aan het recht van de naam van een automatisering, dan één van het volgende doen:
   ...
   * Klik **onbruikbaar maken** om de automatisering uit de de lijstmening van het verslag te verwijderen en gebruikers te verhinderen het te gebruiken om verslagen of voorwerpen tot stand te brengen.
