...
* Adobe Workfront Planning registreert met voorwerpen van andere toepassingen.
   ...
   * Adobe Experience Manager
      ...
      * Assets
        ...
        U kunt de volgende typen elementen verbinden via Workfront Planning:
...
1. Typ de naam van een record in het zoekvak en selecteer de naam wanneer de record in de lijst wordt weergegeven
   ...
   * De gekoppelde velden worden gevuld met de informatie uit de gekoppelde records als u gekoppelde opzoekvelden hebt toegevoegd toen u de recordtypen aansloot.
   ...
   >* U kunt geen Workfront-typeahead-velden toevoegen als opzoekvelden. In de productieomgeving omvat dit velden van het type Mensen, zoals Projecteigenaar of Projectsponsor. <span class="preview"> u kunt mensen-type gebieden als raadplegingsgebieden in het milieu van de Voorproef toevoegen.</span>
   >
...
>[!IMPORTANT]
>
>U moet een Adobe Experience Manager-licentie hebben en het Workfront-exemplaar van uw organisatie moet zijn aangemeld bij het Adobe Business Platform of de Adobe Admin Console om Workfront Planning-records te kunnen verbinden met Adobe Experience Manager.
>
...
Nadat u een verbinding hebt gemaakt tussen een recordtype en Adobe Experience Manager-objecten, kunt u afzonderlijke records verbinden met Experience Manager-objecten. De elementvelden die u vanaf Experience Manager hebt verbonden toen u de verbinding maakte, worden automatisch ingevuld in het recordtype waarvan u een koppeling hebt gemaakt.
...
Records verbinden met Experience Manager-objecten:
...
1. Klik op de kaart van een recordtype om de pagina met recordtypen te openen.
1. Selecteer a **de mening van de Lijst** van de **drop-down menu van de Mening** in de upper-left hoek van de verslagtype pagina.
...
1. (Voorwaardelijk) nadat u het geselecteerde verslagtype met de voorwerpen van Experience Manager verbindt, ga naar het verbonden gebied op een verslag en of klik het gebied, of klik **verbinden** om de voorwerpen van Experience Manager aan het verslag toe te voegen, dan klik **+** pictogram.

   >[!TIP]
   >
   >  U kunt op het pictogram **+** in het gekoppelde objectveld in de detailpagina van de record klikken om elementen aan de record te koppelen.

   Het vak Inhoudsadviseur wordt weergegeven.

   ![&#x200B; de doos van de Adviseur van de Inhoud voor het verslagverbindingen van AEM &#x200B;](assets/content-advisor-assets-nothing-selected.png)
...
1. Van het **Assets** lusje, klik om enkele volgende types van activa te selecteren:
...
1. Wanneer u klaar bent met het kiezen van activa of inhoudsfragmenten, klik **Uitgezocht**. <!-- we might change this to Connect-->
   ...
   * De geselecteerde Experience Manager-elementen of inhoudsfragmenten worden toegevoegd aan het gekoppelde recordveld.
   * In de gekoppelde velden (of opzoekvelden) wordt informatie uit de met Experience Manager verbonden objecten ingevuld.

     Eventuele bestaande informatie uit de velden van de Experience Manager-elementen of inhoudsfragmenten wordt automatisch weergegeven in de gekoppelde of opzoekvelden. <!--verifying of fragments also share lookup fields - not sure from the UI available-->
...
1. (Optioneel en voorwaardelijk) Ga voor elementen naar het recordtype dat u aan Experience Manager hebt gekoppeld en klik op de naam van een element in het gekoppelde recordveld. De Experience Manager-gegevens van het element worden weergegeven in een pop-upvenster. <!--not sure if this is also possible for fragments??-->
...
1. (Facultatief en voorwaardelijk) voor activa, om de pagina van het de activaverslag van Experience Manager in Experience Manager te openen, ga naar de verslagtype pagina van het verslag u van verbindt, klik de naam van een activa op het verbonden verslaggebied om het pop-up venster te openen, dan klik **Open in AEM** pictogram ![&#x200B; Open activa in het pictogram van AEM &#x200B;](assets/open-asset-icon.png) om de activa te openen. <!--not sure if this is also possible for fragments??-->

   Hiermee opent u het Experience Manager-middel in Adobe Experience Manager Assets.

1. (Facultatief en voorwaardelijk) voor activa, van de lijstmening van het verslagtype, houd over de kolomkopbal van de verbonden activa van Experience Manager, en klik het drop-down menu, dan klik **uitgeven raadplegingsgebieden**. <!--not sure if this is also possible for fragments??-->

1. Voeg de objecten van Experience Manager Assets gebieden van het **Niet geselecteerde gebieden** gebied <!--not sure if this is also possible for fragments??--> toe
