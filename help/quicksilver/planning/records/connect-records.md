...
Nadat u een verbinding hebt gemaakt tussen een recordtype en Adobe Experience Manager Assets, kunt u afzonderlijke records verbinden met Experience Manager-elementen. De elementvelden die u vanaf Experience Manager hebt verbonden toen u de verbinding maakte, worden automatisch ingevuld in het recordtype waarvan u een koppeling hebt gemaakt.
...
1. (Voorwaardelijk) Nadat u het geselecteerde verslagtype met Experience Manager verbindt, ga naar het verbonden gebied op een verslag en of klik het gebied, of klik **verbinden** om de activa van Experience Manager aan het verslag toe te voegen, dan klik **+** pictogram.
...
1. Klik om enkele volgende types van activa van het **Assets** gebied te selecteren:
...
1. Klik **de Fragmenten van de Inhoud** om inhoudsfragmenten te selecteren om aan het verbonden verslaggebied toe te voegen.
...
1. (Optioneel) Ga naar het recordtype dat u vanuit Experience Manager hebt gekoppeld en klik op de naam van een element in het gekoppelde recordveld. De Experience Manager-gegevens van het element worden weergegeven in een pop-upvenster.
