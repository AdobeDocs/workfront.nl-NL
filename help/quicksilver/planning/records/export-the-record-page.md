...
description: U kunt de voorvertoning of detailpagina van een record vanuit Adobe Workfront Planning exporteren naar een Microsoft Word-bestand.
...
1. Klik het **menu van de Uitvoer** pictogram van de Uitvoer in verslagdetailpagina ![ of in de voorproef of de pagina van het verslag, dan klik één van het volgende:](assets/export-icon-in-record-details-page.png)
   ...
   * **Adobe PDF**
   ...
   Een Word- (.docx) of PDF-bestand wordt gedownload en opgeslagen op uw computer.
