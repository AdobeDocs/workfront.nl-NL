...
1. (Optioneel en voorwaardelijk) Als u meerdere verbonden velden van het recordtype hebt gemaakt waarvoor u de pagina samenstelt, klikt u op het veld waarvan u de records in de verbonden recordpagina wilt weergeven.
...
1. (Optioneel en voorwaardelijk) Wanneer u een gekoppelde recordpagina maakt voor verbonden planningsrecords, voert u een van de volgende handelingen uit: <!--or AEM Assets--> <!--AEM is not available yet?? see note below-->
   ...
   * Bewerk inline een van de planningsrecords in de tabel op de pagina met verbonden records.
   * Gebruik een van de volgende weergave-elementen op de werkbalk van een verbonden recordpagina om de tabelweergave te beheren:

   * **Filters**
   * **Soort**. Niet beschikbaar voor projecten.
   * **Groepering**. Niet beschikbaar voor projecten.
   * **Gebieden**, om, gebieden te tonen te verbergen of te herschikken
   * **de hoogte van de Rij**. Niet beschikbaar voor projecten.
   * **Onderzoek**
   ...
   <!--No longer possible: 1. (Optional and conditional) When you create a connected records page for the following Workfront object types:
      ...
      * **Disconnect** to disconnect the object from the record you are viewing. 
      ...
      -->
1. (Optioneel en voorwaardelijk) Wanneer u een pagina voor verbonden records maakt voor verbonden Workfront-projecten, voert u een van de volgende handelingen uit:
   ...
   * Klik het van meningsdropdown menu, en klik **Nieuwe mening** om een nieuwe mening voor de pagina toe te voegen, dan doe het volgende:
...
Voor informatie, zie [&#x200B; verslagmeningen van de Schrapping &#x200B;](/help/quicksilver/planning/views/delete-record-views.md).
   ...
   * Klik het **pictogram van de Filter** pictogram ![&#x200B; van de Filter &#x200B;](assets/filter-icon.png), en gebruik de filter om specifieke projecten te tonen.
     ...
     >
   * Klik het **pictogram van Kolommen** pictogram van Kolommen ![&#x200B; &#x200B;](assets/columns-icon.png) om kolommen in de lijst te verbergen of te tonen.
