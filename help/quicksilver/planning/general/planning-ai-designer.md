...
description: Met de Adobe Planning Designer van AI kunt u uw werkruimten en gegevensstructuren eenvoudig configureren. De Planning Designer steunt alles van het creëren van en het vormen van werkruimten tot het bepalen van gebieden en formules, het beheren van verslagen, het herzien van veranderingsgeschiedenis en het bouwen van douanemeningen. Of zij direct of door de Medewerker van AI worden gebruikt, verstrekt de Planning Designer een flexibel, krachtig milieu voor de bouw van en het handhaven van gestructureerde, verbonden informatie.
...
Met de Adobe Planning Designer van AI kunt u uw werkruimten en gegevensstructuren eenvoudig configureren. De Planning Designer steunt alles van het creëren van en het vormen van werkruimten tot het bepalen van gebieden en formules, het beheren van verslagen, het herzien van veranderingsgeschiedenis en het bouwen van douanemeningen.

Of zij direct of door de Medewerker van AI worden gebruikt, verstrekt de Planning Designer een flexibel, krachtig milieu voor de bouw van en het handhaven van gestructureerde, verbonden informatie.

Raadpleeg de volgende artikelen voor informatie over Workfront Planning:

* [Algemene informatie en artikelindex voor Adobe Workfront Planning](/help/quicksilver/planning/planning-information.md)
...
## Inschrijven in het programma Closed Beta voor de planningDesigner
...
## Feedback verzenden over de planningsDesigner

U kunt tijdens het bètaprogramma feedback verzenden over de planningsDesigner.
...
1. Klik **creëren met AI**. <!--update this tag name when they change it-->

   Het **Planning Designer** venster opent.

1. Klik **voorleggen hier** bij de bodem van de pagina terugkoppelt.
1. Voeg uw toe terugkoppelt in de verstrekte ruimte, dan klik **voorleggen**.
Uw feedback wordt verzonden naar de teams Engineering en Product.

## Overwegingen bij de planning van Designer

* Om de Planning Designer te gebruiken, moet u eerst de Medewerker van AI voor uw organisatie aanzetten. De AI-assistent moet als volgt beschikbaar zijn voor iedereen in uw organisatie:
...
* Nadat uw Beheerder van het Systeem de Medewerker van AI voor uw organisatie aanzette, is de Planning Designer beschikbaar voor alle gebruikers, door gebrek, als het voor uw organisatie ter beschikking is gesteld.
...
* Records maken door een document te importeren
  ...
  >[!IMPORTANT]
  >
  >Hoewel wij .XLSX dossiertypes steunen, kunnen zij niet voor grootschalige verslaginvoer door de Planning Designer worden gebruikt.
...
1. Login aan Workfront, dan klik het **pictogram van het Belangrijkste Menu** Belangrijkste menu van Lijnen ![&#x200B; in de upper-left hoek, dan klik &#x200B;](assets/lines-main-menu.png) Planning **.**
   ...
   Het **Planning** gebied opent. <!--update screen shot when they change the name of the button-->

   ![&#x200B; Ontwerp met AI knoop op de pagina van Werkruimten &#x200B;](assets/design-with-ai-button-on-workspaces-page.png)

1. Klik **creeer met AI** of klik **creeer werkruimte**, dan gebruik het snelle venster bij de bovenkant om erop te wijzen welk soort werkruimte u zou willen tot stand brengen. <!--update this when they change it to Generate with AI-->

   Het **Planning Designer** venster opent. <!--remove the Beta tag here when this removes from Beta-->
...
1. (Optioneel) Voer een van de volgende handelingen uit om een werkruimte te bewerken:

   * Open de werkruimte en breng de wijzigingen handmatig aan. Voor informatie, zie [&#x200B; werkruimten &#x200B;](/help/quicksilver/planning/architecture/edit-workspaces.md) uitgeven.
   * Klik **uitgeven met AI**. Dit opent de Planning Designer. Herhaal bovenstaande stappen om AI te gebruiken en breng verdere wijzigingen in de werkruimte aan.
...
1. Draai van de **Planning Onboarding** plaatsen. <!--add new screen shot with info icon and new name of the toggle; ensure you don't show the AI Reviewer if it is not in Prod yet-->
