...
1. (Optioneel en voorwaardelijk) Afhankelijk van de omgeving waarin u de uitgaven bewerkt, voert u een van de volgende handelingen uit om aangepaste expressies voor alle uitgaven opnieuw te berekenen:
   ...
   1. In het milieu van de Productie, in het **gebied van Forms van de Douane 0}, selecteer** opnieuw berekenen de optie van de Uitdrukkingen van de Douane **om ervoor te zorgen dat alle Berekende Gebieden van de Douane die op de Douane Forms in bijlage aan de geselecteerde kwesties zijn bijgewerkt zijn.**
