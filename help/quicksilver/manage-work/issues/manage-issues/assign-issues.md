...
1. Klik **Taken** in het linkerpaneel, en in het **3} gebied van Taken {, begin de naam van een gebruiker, een rol, of team in het** de mensen van het Onderzoek, rollen, of het gebied van teams **, dan klikken het wanneer het in de lijst toont**
...
1. (Facultatief) werk het P **geplande Uren** gebied bij. Voor meer informatie, zie [ kwesties ](/help/quicksilver/manage-work/issues/manage-issues/edit-issues.md) uitgeven.

1. Klik **sparen**.
1. (Facultatief en voorwaardelijk) wanneer **aan** of de **3} gebieden van Taken {in uw lijst van kwesties wordt toegewezen, klik binnen één van deze kolommen voor een kwestie, dan klik het** X pictogram **naast de naam van een ontvanger om het uit de kwestie te verwijderen.**
