...
1. Klik **sparen**.
1. (Facultatief en voorwaardelijk) wanneer **aan** of de **3&rbrace; gebieden van Taken &lbrace;in uw lijst van kwesties wordt toegewezen, klik binnen één van deze kolommen voor een kwestie, dan klik het** X pictogram **naast de naam van een ontvanger om het uit de kwestie te verwijderen.**
