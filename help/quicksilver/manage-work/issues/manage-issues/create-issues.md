...
1. (Voorwaardelijk) Als de projectmaker toestemming heeft verleend voor de **Type probleem** in het veld Nieuw probleem dat u wilt weergeven, selecteert u het type uitgave op basis van de volgende opties:
...
1. (Voorwaardelijk) Als de onderwerpen van de Rij met een douaneformulier worden geassocieerd, zal dat douaneformulier in worden getoond **Nieuw probleem** formulier.\
   of\
   Als het project met een kwestie douaneformulier door het gebied van de Details van de Rij wordt geassocieerd, toont de vorm in **Nieuw probleem** onder de standaard Workfront-velden.
