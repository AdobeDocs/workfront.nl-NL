...
1. (Voorwaardelijk) Afhankelijk van de omgeving waarin u problemen bewerkt, voert u een van de volgende handelingen uit:

   1. In de productieomgeving:

      1. Wijs erop of een ontvanger de primaire ontvanger op de kwestie is, door over de naam van de toegewezen persoon te hangen en **te klikken Primair maken**. Een team kan niet de primaire ontvanger van een kwestie zijn.
   ...
   1. <span class="preview"> (Voorwaardelijk) Voer een van de volgende handelingen uit in de voorvertoningsomgeving: </span>

      * <span class="preview"> klik **toewijzen aan me** om de kwestie aan zich </span> toe te wijzen
      * <span class="preview"> werk het **Geplande Uren** gebied bij.</span>
