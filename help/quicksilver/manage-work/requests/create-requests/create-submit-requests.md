...
Als Workfront-beheerder moet u aanvraagwachtrijen maken en beschikbaar stellen aan gebruikers voordat zij deze functie kunnen gebruiken. Een gebruiker met een Planner-licentie en met de machtiging Bewerken tot projecten en Beheren voor een specifiek project kan ook aanvraagwachtrijen maken. 
...
U moet de volgende componenten van een Rij van het Verzoek tot stand brengen:
...
1. Klikken  **Verzoeken** en klik vervolgens op **Nieuwe aanvraag** in de rechterbovenhoek van de pagina.
...
1. (Voorwaardelijk) Klik binnen **Type aanvraag** en voer een van de volgende handelingen uit:
   ...
   * Voer een trefwoord in dat bij een eerder geopend pad hoort om naar een aanvraagwachtrij te zoeken.
   ...
   >[!TIP]
   >
   >* De eerste 200 verzoeken tonen rijen door gebrek, in alfabetische orde.
...
1. (Optioneel) Als uw aanvraagwachtrij onderwerpgroepen bevat, selecteert u de naam van de onderwerpgroep in het eerste vervolgkeuzeveld. Anders, selecteer een Onderwerp van de Rij.
   ...
   Voor meer informatie over hoe te om de Groepen van het Onderwerp tot stand te brengen, zie het artikel [Onderwerpgroepen maken](../../../manage-work/requests/create-and-manage-request-queues/create-topic-groups.md). Voor meer informatie over het creëren van de Onderwerpen van de Rij, zie het artikel [Werkvoorraadonderwerpen maken](../../../manage-work/requests/create-and-manage-request-queues/create-queue-topics.md).
...
1. Afhankelijk van welke velden de Workfront-beheerder heeft ingeschakeld in het dialoogvenster **Nieuwe probleemvelden** van de **Wachtrij** Subtab op het project, zou u om het even welke volgende gebieden kunnen vinden wanneer u een nieuw verzoek indient:
...
Voor informatie over het voorleggen van verzoeken gebruikend de cliënt van Vooruitzichten, zie het artikel [Een Adobe Workfront-verzoek maken vanuit een Outlook-e-mail](../../../workfront-integrations-and-apps/using-workfront-with-outlook/create-a-wf-request-from-an-outlook-email.md).
...
Voor informatie over het verzenden van aanvragen via de mobiele app raadpleegt u de [Verzoeken](../../../workfront-basics/mobile-apps/using-the-workfront-mobile-app/workfront-for-android.md#requests) in de artikelen:
