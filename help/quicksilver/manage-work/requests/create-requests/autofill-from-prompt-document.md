...
Deze functionaliteit is beschikbaar wanneer u een aanvraag maakt in het gedeelte Workfront Requests en in de Workfront-planning.
...
## Formuliervulling inschakelen, aangedreven door AI voor uw organisatie

>[!NOTE]
>
>Formuliervullingen die worden aangedreven door AI, worden ingeschakeld op organisatieniveau en kunnen niet worden in- of uitgeschakeld voor specifieke gebruikers of toegangsniveaus.
...
1. Klik **Systeem**, dan onder Systeem, klik **Voorkeur**.
1. In de AI voorkeurensectie, zorg ervoor dat **AI** toelaat van een knevel wordt voorzien.
1. Wissel op **AI de Vulling van de Vorm**.
1. Om de Vulling van de Vorm onbruikbaar te maken die door AI wordt aangedreven, knevel van **AI de Vulling van de Vorm**.
