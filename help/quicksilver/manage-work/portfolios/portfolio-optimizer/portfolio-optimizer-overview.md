...
* **[!UICONTROL Portfolio Header]**: Dit gebied bevat financiële informatie die is verzameld voor alle projecten in het portfolio. Deze wordt op elk tabblad van het object Portfolio weergegeven.
