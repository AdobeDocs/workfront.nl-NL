...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>[!UICONTROL Edit] toegang tot [!UICONTROL Portfolios]</p>  </td> 
  </tr> 
  <tr> 
   <td role="rowheader">Objectmachtigingen</td> 
   <td> <p>[!UICONTROL Manage] machtigingen voor een portfolio</p>
   <p>[!UICONTROL Manage] machtigingen voor de projecten in het portfolio om deze toe te voegen aan of te verwijderen uit het portfolio</p>  </td> 
  </tr> 
 </tbody> 
</table>
...
1. Overweeg informatie op te geven in een van de volgende secties:
   ...
   * [Opmerking](#comment)
   ...
   >[!TIP]
   >
   >Om douanevelden voor verscheidene portefeuilles in een tijd opnieuw te berekenen, selecteer veelvoudige portefeuilles in een lijst, en klik **Meer** menu ![&#x200B; Meer menu &#x200B;](assets/more-icon.png) bij de bovenkant van de lijst, dan **herberekenen Uitdrukkingen**.
...
1. Begin typend de naam van een vorm in [!UICONTROL **voeg douanevorm**] gebied toe.
