...
1. Klik **uitgeven**.
   ...
   **geeft de dialoogdoos van Taken** <span class="preview"> in de nieuwe ervaring uit.</span>

1. Ga verder het toewijzen van de taken <span class="preview"> gebruikend de nieuwe ervaring.</span>

   <span class="preview"> voor meer informatie, zie de sectie [ veelvoudige taken in bulk van een lijst in de nieuwe ervaring ](#assign-multiple-tasks-in-bulk-from-a-list-in-the-new-experience) in dit artikel toewijzen.</span>

1. <span class="preview"> (Facultatief) klik **Schakelaar terug naar oude ervaring** bij de bodem van **uitgeven de doos van Taken** om de oude ervaring te openen.</span>

   >[!TIP]
   >
   >Het toewijzen van taken in de productieomgeving is alleen beschikbaar voor de oude ervaring.
...
1. Ga naar een lijst van taken die u in bulk in het milieu van de Voorproef wilt toewijzen.
1. (Voorwaardelijk) zorg ervoor dat de **optie Autosave** wordt geselecteerd als u op een lijst van taken onder een project bent.
...
1. Klik binnen het **gebied van het Type van Duur 0} {en kies een Type van Duur.**
...
1. Klik **sparen**.
1. (Facultatief en voorwaardelijk) wanneer **aan** of de **3} gebieden van Taken {in uw lijst van taken wordt toegewezen, klik binnen één van deze kolommen voor een taak, dan klik het** X pictogram **naast de naam van een ontvanger om het uit de taak te verwijderen.**
