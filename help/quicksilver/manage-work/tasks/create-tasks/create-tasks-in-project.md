...
1. (Voorwaardelijk) als u momenteel de taaklijst in een Gelijke mening bekijkt, klik de **pictogram van de Mening van de Lijst** van de Lijst in Gelijke mening voor taken ![&#x200B; in de hoger-juiste hoek om de taaklijst te tonen.](assets/list-view-in-agile-view-for-tasks.png)
1. (Facultatief) klik het **pictogram van de Wijze van het Plan** pictogram van het Plan voor taaklijst ![&#x200B; en selecteer &#x200B;](assets/nwe-plan-mode-icon-task-list.png) Handboek sparen **, dan selecteren of** Standaard **of** Chronologie Planning **.** Dit maakt **Autosave** optie onbruikbaar die door gebrek wordt toegelaten.
...
1. Maak een nieuwe taak door een van de volgende handelingen uit te voeren:
   ...
   * Klik **toevoegen Meer Taken** bij de bodem van de taaklijst.
   ...
   ![&#x200B; Nieuwe taak of voeg taakknoop in een benadrukte lijst toe &#x200B;](assets/qs-new-task-or-add-task-buttons-in-list-highlighted-350x242.png)
...
1. (Voorwaardelijk) als u **Nieuwe Taak** klikte doe het volgende:
   ...
   1. Specificeer om het even welke gebieden op de beperkte lijst van gebieden binnen de **Nieuwe doos van de Taak**, dan klik **creeer Taak** als u een taak snel wilt creëren.
      ...
      ![&#x200B; creeer taak kleine doos &#x200B;](assets/nwe-create-task-small-screen-350x272.png)

      **creeer de doos van de Taak** opent.

      ![&#x200B; creeer taakgrote doos &#x200B;](assets/create-task-larger-box-nwe-350x244.png)
...
1. (Voorwaardelijk) als u **klikte voeg Meer Taken** in stap 5 toe, begin de taakinformatie gebruikend in-lijn het uitgeven in, dan druk binnengaan.
   ...
   ![&#x200B; voegt meer taken inline toe &#x200B;](assets/add-more-tasks-inline.png)
...
1. Van de taakpagina, klik het **Meer menu** ![&#x200B; Meer pictogram &#x200B;](assets/more-icon.png), dan klik **Beweging**. Voor meer informatie over het bewegen van taken, zie [&#x200B; de taken van de Beweging &#x200B;](/help/quicksilver/manage-work/tasks/manage-tasks/move-tasks.md).
