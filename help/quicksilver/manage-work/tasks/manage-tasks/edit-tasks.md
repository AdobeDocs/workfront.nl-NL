...
1. Klik **Toewijzingen** in het linkerpaneel.
   ...
   &lt;!-inspringing de opsommingstekens onder één keer bij de release om Prod weer te geven en vervolgens een nieuw opsommingsteken voor Voorvertoning:
   1. (Voorwaardelijk) afhankelijk van het milieu waarvan u tot taak toegang hebt, doe het volgende:
...
1. Klik **sparen Veranderingen** <!--<span class="preview"> or **Save** </span> --> of ga met de volgende secties verder.
