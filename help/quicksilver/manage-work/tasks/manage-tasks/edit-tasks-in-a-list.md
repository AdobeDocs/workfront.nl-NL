...
1. <span class="preview"> (Facultatief) klik het **Meer** menu ![ Meer menu ](assets/more-icon.png) bij de bovenkant van de taaklijst, dan **herberekent Uitdrukkingen** om alle informatie op berekende douanegebieden bij te werken.</span>
1. Klik **uitgeven** pictogram ![ uitgeven pictogram ](assets/qs-edit-icon.png). Het **geeft de dialoogvakje van Taken** opent <span class="preview"> in de nieuwe ervaring </span>.
...
1. <span class="preview"> (Voorwaardelijk) Voer in de nieuwe ervaring de volgende handelingen uit: </span>
   ...
   1. <span class="preview"> (Facultatief) klik **Schakelaar terug naar oude ervaring** bij de bodem van de Edit doos van Taken.</span>

1. <span class="preview"> (Voorwaardelijk) Voer in de oude ervaring de volgende handelingen uit: </span>
   ...
   1. (Facultatief) in de **sectie van Forms van de Douane 0}, selecteer de** **optie van de Uitdrukkingen van de Douane opnieuw berekenen om ervoor te zorgen dat alle Berekende Gebieden van de Douane die op de douaneformulieren in bijlage aan de geselecteerde taken zijn bijgewerkt.**
