...
1. Klik **uitgeven** pictogram ![ uitgeven pictogram ](assets/qs-edit-icon.png). Het **geeft de dialoogvakje van Taken** uit opent <!--<span class="preview">in the new experience</span>-->.
...
1. <!--<span class="preview">In the old experience,, do the following:</span> (**********indent the steps below*********)--> Geef de informatie op die u wilt wijzigen voor alle taken die u hebt geselecteerd op een van de volgende gebieden:
