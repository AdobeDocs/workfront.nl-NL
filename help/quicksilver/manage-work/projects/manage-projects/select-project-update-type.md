...
1. Klik op het menu Meer ![](assets/more-icon.png) naast de naam van het project klikt u op **Bewerken** .

1. Klikken  **Project** **Instellingen**.

   ![](assets/update-type-field-on-project-edit-box-nwe-350x378.png)

1. In de **Type update** in het veld selecteert u of u wilt dat Workfront de tijdlijn van het project dagelijks automatisch berekent, wanneer er een wijziging optreedt of dat de projectmanager deze handmatig moet berekenen.
