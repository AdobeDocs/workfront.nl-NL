...
1. Werk de volgende financiële informatie voor het project bij:
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr>
      <td><strong><span class="preview">Datumeffectieve wisselkoersen uit het systeem gebruiken</span></strong></td>
      <td><p><span class="preview">Wanneer deze optie wordt gekozen, worden altijd de op systeemniveau geldende deviezen gebruikt en mogen voor het project geen deviezenoverschrijvingen worden toegepast.</span></p> <p><span class="preview">U moet ook de <strong> Datum van het Tarief van de Uitwisseling </strong> selecteren om van te beginnen, wanneer de optie wordt geselecteerd.</span></p></td> 
     </tr>
     <tr>
      <td><strong><span class="preview">Factureringsgegevens van project behouden</span></strong></td>
      <td><p><span class="preview">Wanneer u deze optie inschakelt, worden alle factureringssnelheden van de toewijzing permanent vastgezet op de hoogste toepasselijke snelheid in de factureringshiërarchie. Dit is een eenmalige selectie en u kunt de optie niet uitschakelen als het project toewijzingen of uren heeft. Na behoud, kunnen de tarief's van de toewijzingsfacturatie niet overal op het project worden veranderd, worden uitgegeven of worden met voeten getreden.</span></p></td>
     </tr>
