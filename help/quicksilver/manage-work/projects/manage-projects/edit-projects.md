...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td> <p>Om wisselkoersen op systeemniveau voor het project in te stellen en de factureringssnelheden van het project te behouden: Workflow Ultimate</p>
      <p>Alle andere instellingen bewerken: elk Workfront- of workflowpakket</p> </td> 
  </tr> 
  <tr> 
...
1. Klik **Forms van de Douane** in het linkerpaneel.
   ...
   ![&#x200B; de vormen van de Douane in uitgeeft projectvakje &#x200B;](assets/nwe-custom-forms-in-edit-project-box-350x170.png)
...
* Als u de toegang van de Mening tot Financiële Gegevens en van de Mening de Algemene toestemmingen van de Financiën op het project hebt, kunt u de gebieden in de sectie van de Financiën slechts bekijken. U kunt de velden in deze sectie niet bewerken.
* Als u toegang tot Financiële gegevens hebt bewerkt en de algemene bevoegdheden van Financiën voor het project hebt bewerkt, kunt u de velden in deze sectie bijwerken.

Wanneer het selecteren van meer dan één project om hen in bulk uit te geven en, bestaan de volgende scenario&#39;s:

* Als u minstens één project selecteert waar u de Toestemmingen van de Financiën van de Mening Algemene (in plaats van Edit Algemene Financiën) hebt, kunt u de gebieden in deze sectie voor alle geselecteerde projecten slechts bekijken. U kunt de velden in de sectie Financiën niet bulksgewijs bewerken.
...
1. Klik **Financiën** in het linkerpaneel.
   ...
   ![&#x200B; het gebied van de Financiën in het project geeft doos uit &#x200B;](assets/edit-project-finance-section.png)
...
1. Werk de volgende financiële informatie voor het project bij:
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr>
      <td><strong>Datumeffectieve wisselkoersen uit het systeem gebruiken</strong></td>
      <td><p>Wanneer deze optie wordt gekozen, worden altijd de op systeemniveau geldende deviezen gebruikt en mogen voor het project geen deviezenoverschrijvingen worden toegepast.</p> <p>U moet ook de <strong> Datum van het Tarief van de Uitwisseling </strong> selecteren om van te beginnen, wanneer de optie wordt geselecteerd.</p></td> 
     </tr>
     <tr>
      <td><strong>Factureringsgegevens van project behouden</strong></td>
      <td><p>Wanneer u deze optie inschakelt, worden alle factureringssnelheden van de toewijzing permanent vastgezet op de hoogste toepasselijke snelheid in de factureringshiërarchie. Dit is een eenmalige selectie en u kunt de optie niet uitschakelen als het project toewijzingen of uren heeft. Na behoud, kunnen de tarief's van de toewijzingsfacturatie niet overal op het project worden veranderd, worden uitgegeven of worden met voeten getreden.</p></td>
     </tr>
     <tr data-mc-conditions=""> 
      <td role="rowheader"><strong> Valuta </strong> </td> 
      <td> <p>Geef de valuta voor het project op als deze afwijkt van de standaardvaluta van uw systeem. U kunt de valuta van een project niet wijzigen als er al financiële informatie over het project beschikbaar is. Dit veld is niet zichtbaar als u alleen de standaardvaluta in het systeem hebt. </p> <p>Voor meer informatie over munt, zie <a href="../../../administration-and-setup/manage-workfront/exchange-rates/set-up-exchange-rates.md" class="MCXref xref"> de wisselkoers van de Opstelling </a>. </p> </td> 
     </tr> 
     <tr> 
