...
Voor informatie over het maken van een sjabloon raadpleegt u [Een projectsjabloon maken](../../../manage-work/projects/create-and-manage-templates/create-template.md).
...
<table style="table-layout:auto"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Toegang tot sjablonen bewerken</p> <p>Opmerking: Als u de juiste toegang hebt maar nog steeds geen sjabloontaak kunt bewerken, vraagt u uw Workfront-beheerder of deze aanvullende beperkingen op uw toegangsniveau heeft ingesteld. Voor informatie over hoe een beheerder van Workfront uw toegangsniveau kan veranderen, zie <a href="../../../administration-and-setup/add-users/configure-and-grant-access/create-modify-access-levels.md" class="MCXref xref">Aangepaste toegangsniveaus maken of wijzigen</a>.</p> </td> 
  </tr> 
  <tr> 
   <td role="rowheader"><strong>Objectmachtigingen</strong> </td> 
   <td> <p>Rechten voor een sjabloon beheren. </p> <p>Contribute of hoger voor de sjabloontaak.</p> <p>Voor informatie over het aanvragen van toegang tot objecten raadpleegt u <a href="../../../workfront-basics/grant-and-request-access-to-objects/request-access.md" class="MCXref xref">Toegang tot objecten aanvragen </a>.</p> </td> 
  </tr> 
 </tbody> 
</table>

&#42;Neem contact op met uw Workfront-beheerder om te weten te komen welk plan, licentietype of toegangsniveau u hebt.
...
1. (Voorwaardelijk) Als u beperkte informatie over de sjabloontaak wilt bewerken, klikt u op **Sjabloontaakdetails** in het linkerpaneel, dan ga naar de gebieden van de sectie van Details om informatie voor elk gebied uit te geven.
1. (Optioneel) Klik op de knop **Alles samenvouwen** pictogram ![](assets/collapse-all-icon.png) om alle gebieden samen te vouwen.
...
1. Begin met het bewerken van een sjabloontaak zoals hierboven beschreven.
1. Klikken **Overzicht**.
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     <tr> 
      ...
      <td>Geef een naam op voor de sjabloontaak.</td> 
     </tr> 
     <tr> 
     ...
     <tr> 
      ...
      <td> <p>Dit is een visuele vlag voor u die u toestaat om aan uw malplaatjetaken voorrang te geven. </p> <p>Selecteer een van de volgende opties:</p> 
       <ul> 
        ...
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Normaal</span> </p> </li> 
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Hoog</span> </p> </li> 
        <li> <p style="font-weight: bold;"><span style="font-weight: normal;">Dringend</span> </p> </li> 
     ...
     <tr> 
      <td role="rowheader"><strong>Duur</strong> </td> 
      <td> <p>Geef de duur van de toekomstige taken op in minuten, uren, dagen, weken of maanden. Voor de toekomstige taak die met deze sjabloon wordt gemaakt, wordt de hier opgegeven duur gebruikt.</p> <p>Workfront meet standaard Duur in dagen. Dit is de hoeveelheid tijd die u toestaat voor de taak om onvolledig te blijven, alvorens het moet worden voltooid. U kunt niet de Duur van een taak specificeren wanneer <strong>Duur</strong> van de taak <strong>Eenvoudig</strong>of wanneer de <strong>Taakbeperking</strong> is <strong>Vaste datums</strong>.</p> <p>Belangrijk: De duur is typisch de hoeveelheid tijd tussen de Geplande Begin en de Geplande Datums van de Voltooiing van een malplaatjetaak, en daarom, beïnvloedt het de chronologie van het malplaatje. Dit bepaalt de chronologie van het toekomstige project dat van het malplaatje wordt gecreeerd. </p> </td> 
     </tr> 
     <tr> 
     ...
     <tr data-mc-conditions=""> 
      ...
      <td> <p><span>De hoeveelheid inspanning die wordt vereist om een taak te voltooien. Uw projectmanager zou kunnen besluiten om dit gebied in plaats van Geplande Uren te gebruiken om de inspanning te schatten nodig om een taak te voltooien. Dit veld is alleen zichtbaar als aan de volgende voorwaarden is voldaan:</span> </p> 
       <ul> 
        <li> <p><span>De malplaatjetaak heeft een Eenvoudig Type van Duur.</span> </p> <p>Tip: <span>Als u het type Duur van de taak bijwerkt, wordt dit gebied verborgen.</span> </p> </li> 
        <li><span>Uw projectmanager heeft de Werkinspanning van het Gebruik toegelaten om het Geplande gebied van Uren op het malplaatje te berekenen.</span> </li> 
       </ul> 
       <div> 
       ...
       </div> <p>Voor informatie over het gebruiken van de Werkinspanning in plaats van Geplande Uren om taakinspanning te schatten, zie <span href="work-effort.md"><a href="../../../manage-work/tasks/task-information/work-effort.md" class="MCXref xref">Overzicht van werkprestaties</a></span>.</p> </td> 
     </tr> 
     <tr> 
      ...
      <td> <p>De taak op het project dat van dit malplaatje wordt gecreeerd zal deze beperking hebben. De Beperkingen van de taak identificeren wanneer een taak moet worden voltooid. </p> <p>Selecteer een van de volgende opties:</p> 
       <ul> 
        ...
        <li><strong>Niet later voltooien dan</strong>. Geef een <strong>Geplande afsluitdatum</strong>.</li> 
     ...
     <tr> 
      ...
      <td> <p> U kunt de Dag van de Voltooiing van een malplaatjetaak slechts specificeren wanneer de Beperking van de Taak één van het volgende is:</p> 
       <ul style="list-style-type: circle;"> 
        ...
        <li>Niet later voltooien dan</li> 
        <li>Vaste datums</li> 
     ...
     <tr> 
      ...
      <td> <p>Geef het type kosten voor de toekomstige taak op. Dit gaat bepalen hoe de Kosten op de taak, gebaseerd op het aantal uren op de taken wordt berekend. </p> <p>Selecteer een van de volgende opties:</p> 
       <ul> 
        ...
        <li> <p style="font-weight: normal;"><span>Vaste uren</span> </p> </li> 
        <li> <p style="font-weight: normal;"><span>Uur gebruiker</span> </p> </li> 
        <li> <p style="font-weight: normal;"><span>Rol Uur</span> </p> </li> 
       </ul> <p>Voor meer informatie over het volgen van kosten, zie <a href="../../../manage-work/projects/project-finances/track-costs.md" class="MCXref xref">Trackkosten</a>.</p> </td> 
     </tr> 
     <tr> 
      ...
      <td> <p>Geef het type inkomsten voor de toekomstige taak op. Dit gaat bepalen hoe de Inkomsten op de taak worden berekend, gebaseerd op het aantal uren op de taken.</p> <p style="font-weight: normal;">Selecteer een van de volgende opties: </p> 
       <ul> 
        <li> <p style="font-weight: normal;">Niet opteerbaar</p> </li> 
        <li> <p style="font-weight: normal;">Uur gebruiker</p> </li> 
        <li> <p style="font-weight: normal;">Rol Uur</p> </li> 
        <li> <p style="font-weight: normal;">Vaste uren</p> </li> 
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td> <p>Selecteer welke herinneringsberichten u aan de malplaatjetaak wilt vastmaken. Zij zullen aan de toekomstige taken op het project worden vastgemaakt dat van dit malplaatje wordt gecreeerd. Uw systeembeheerder moet Meldingen van de Herinnering vormen alvorens u hen op een taak kunt selecteren. Voor meer informatie over het vormen van de Meldingen van de Herinnering, zie <a href="../../../administration-and-setup/manage-workfront/emails/set-up-reminder-notifications.md" class="MCXref xref">Herinneringsmeldingen instellen</a>.</p> </td> 
     </tr> 
    </tbody> 
   </table>
...
1. (Optioneel) Selecteer een rol in het menu **Rol van de gemachtigde** vervolgkeuzemenu. Dit is de rol die de ontvanger kan vervullen bij deze toekomstige taak. Alleen de functies die aan elke toegewezen persoon in het profiel zijn gekoppeld, worden weergegeven in het vervolgkeuzemenu.
1. (Optioneel) Ga door met het bewerken van de volgende secties, afhankelijk van de gegevens die u wilt wijzigen.
...
1. (Voorwaardelijk en optioneel) Als u een aangepast formulier aan de sjabloontaak hebt gekoppeld, bewerkt u alle velden op het formulier. U moet alle vereiste velden opgeven voordat u de sjabloontaak kunt opslaan.
   ...
   >Voor informatie over het instellen van machtigingen voor secties in een aangepast formulier raadpleegt u [Een aangepast formulier delen](../../../administration-and-setup/customize-workfront/create-manage-custom-forms/share-access-to-a-custom-form.md).\
   >Voor informatie over het instellen van taakmachtigingen raadpleegt u [Een taak delen](../../../workfront-basics/grant-and-request-access-to-objects/share-a-task.md).\
   >Voor informatie over het instellen van sjabloonmachtigingen raadpleegt u [Een sjabloon delen](../../../workfront-basics/grant-and-request-access-to-objects/share-a-template.md).
