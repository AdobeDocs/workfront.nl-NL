...
1. (Voorwaardelijk) In het milieu van de Productie, denk na specificerend informatie in om het even welke volgende secties:
...
1. <span class="preview"> (Voorwaardelijk) In de milieu van de Voorproef, opent het Edit vakje van de Taak van het Malplaatje in de nieuwe ervaring. Ga het uitgeven van de malplaatjetaak zoals die in [&#x200B; wordt beschreven een malplaatjetaak uit gebruikend de nieuwe ervaring &#x200B;](#edit-a-template-task-using-the-new-experience) sectie in dit artikel.</span>
1. <span class="preview"> (Facultatief) klik **Schakelaar terug naar oude ervaring** bij de bodem van **geef de Taakdoos van het Malplaatje uit** om **te openen geef de Taak van het Malplaatje** doos in de oude ervaring uit. Ga verder het uitgeven van de malplaatjetaak zoals die in [&#x200B; wordt beschreven geef een malplaatjetaak uit gebruikend de oude ervaring &#x200B;](#edit-a-template-task-using-the-old-experience) sectie in dit artikel.</span>
...
1. Typ in het veld Zoeken in personen, rollen of teams de naam van een toegewezen persoon en selecteer deze vervolgens wanneer deze in de lijst wordt weergegeven
