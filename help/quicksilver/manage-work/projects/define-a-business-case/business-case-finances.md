...
<table border="1" cellspacing="15" cellpadding="1"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p>Dit zijn de potentiële kosten van alle risico's voor het project. </p> <p>Dit wordt berekend met behulp van de volgende formule:</p> <p><code>Potential Risk = SUM(Potential Cost * Probability of Risk) </code></p> <p>Zie voor meer informatie over risico's van het project <a href="../../../manage-work/projects/define-a-business-case/create-edit-risks-on-projects.md" class="MCXref xref">Risico's maken en bewerken voor projecten</a>.</p> <p>Dit gebied toont in het Van Bedrijfs Geval Summiere gebied.</p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td> <p>De kosten van het mitigatieplan voor de risico's die u schat zouden op het project kunnen voorkomen.<br>Zie voor meer informatie over risico's van het project <a href="../../../manage-work/projects/define-a-business-case/create-edit-risks-on-projects.md" class="MCXref xref">Risico's maken en bewerken voor projecten</a>.</p> <p>Dit gebied toont op het gebied van Risks voor elk risico dat op het project wordt gespecificeerd.</p> </td> 
  </tr> 
  <tr> 
