...
In de aanvankelijke fasen van een project, kunt u nog niet bepaald hebben als u eigenlijk het project zou moeten doen. Het kan niet kosteneffectief zijn, of u kunt niet de middelen hebben. In dit stadium van planning, kunt u een project in Workfront tot stand brengen zonder enige taken toe te voegen en zijn status aan Planning te plaatsen.

U kunt ook een projectverzoek indienen om uw Portfolio Manager te vragen of het haalbaar is om het project überhaupt te maken. Dit staat u toe om een BedrijfsGeval voor het project voor te leggen waar u kunt schatten wat nodig zal zijn om het project te voltooien. Dit leidt tot een project met een status van Gevraagd.
...
Voor informatie over het creëren van een projectverzoek, zie [ Verzoek om een project ](/help/quicksilver/manage-work/projects/create-projects/request-project.md).
...
Voor meer informatie over het bepalen van een BedrijfsGeval voor een project, zie het artikel [ een BedrijfsGeval voor een project ](../../../manage-work/projects/define-a-business-case/create-business-case.md) creëren.
...
Wanneer u een project plant, is één van de eerste dingen die u moet bepalen de chronologie: bepaal wanneer het project kan beginnen en tegen welk tijdstip het moet voltooien.

Bepaal of er een vastgestelde termijn voor wanneer het project moet worden gebeëindigd, of of u een uitgangspunt en het werk uit daar zou moeten plaatsen.
...
Een programma bepaalt welke tijd de gebruikers beschikbaar hebben om aan het project te werken.
...
U kunt veelvoudige programma&#39;s in uw instantie van Workfront tot stand brengen, en een standaardprogramma toepassen dat voor alle projecten zal worden gebruikt. U kunt ook aanvullende aangepaste schema&#39;s maken om deze aan verschillende personen te koppelen.
...
Voor meer informatie over het creëren van taken op een project, zie de sectie [ taken ](#define-tasks) in dit artikel bepalen.
...
* Wijs taken toe aan individuen of teams, zodat weet u wie voor hun voltooiing verantwoordelijk is. U kunt taken aan baanrollen, maar slechts voor de aanvankelijke planningsfase van het project toewijzen, wanneer u niet zeker bent wie aan de taken kan worden toegewezen. Nadat u het project lanceert, is het beter om de baanrollen met gebruiker of teamtaken te vervangen.
...
* Houd rekening met de belangrijkste doelstellingen van uw project en markeer deze als mijlpaal.
...
* Voeg taken aan een project manueel toe, aangezien u inline de lijst van Taken op het project uitgeeft.
...
* Zijn er gegevens die u nodig hebt om bij te houden en waarin geen veld in Workfront staat om het in te slaan?

  Als dat het geval is, maakt u een aangepaste Forms voor projecten of taken waarin u deze gegevens kunt opslaan.
...
* Moet u processen documenteren en werkt u met activa die of deel van het dagelijkse werk uitmaken of de resolutie van het project bepalen? Als dat het geval is, maakt u een opslagsysteem voor documenten.

  Voor informatie, zie [ Documenten: artikelindex ](/help/quicksilver/documents/documents-overview.md).

* Zijn er controlepunten voor goedkeuring die moeten worden toegekend voordat de werkzaamheden aan een project kunnen worden voortgezet? Als ja, creeer goedkeuringsprocessen voor projecten of taken die u kunt gebruiken aangezien u uw project bouwt en neem een overzicht van welke documenten of proefdrukken moeten worden goedgekeurd alvorens het werk kan verdergaan.

  Raadpleeg de volgende artikelen voor meer informatie over goedkeuringen:
   ...
   * [Werk beoordelen en goedkeuren](/help/quicksilver/review-and-approve-work/review-and-approve-work.md)
   * [ Beschikbare functionaliteit voor verenigde documentgoedkeuringen ](/help/quicksilver/review-and-approve-work/document-reviews-and-approvals/asset-review-and-approval.md)
