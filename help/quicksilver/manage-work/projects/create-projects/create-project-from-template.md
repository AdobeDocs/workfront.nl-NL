...
1. Klik de naam van een malplaatje in de **Favoriete malplaatjes** lijst.
   ...
   1. (Facultatief) op het **gebied van de Malplaatjes van het Onderzoek**, begin de naam van een malplaatje te typen en het te klikken wanneer het in de lijst toont.
   1. Klik op de naam van een van de volgende typen sjablonen om deze te kiezen:

      * Een Workfront-opslagsjabloon

        Workfront-opslagmalplaatjes tonen een erfenis-opslag pictogram ![ Verouderd opslagpictogram ](assets/legacy-storage-project-icon.png) naast hun naam.

        Documenten over het model en over toekomstige projecten worden opgeslagen in Workfront-opslag.
      * Een Adobe-opslagsjabloon

        Documenten over het sjabloon en over toekomstige projecten worden opgeslagen in Adobe Enterprise storage.

      >[!NOTE]
      >
      >* Met een Adobe-sjabloon voor bedrijfsopslag wordt een Adobe-project voor bedrijfsopslag gemaakt.
      >
      >* Met een Workfront-opslagsjabloon maakt u een Workfront-opslagproject.
      >
      >* Als u een Adobe-sjabloon voor bedrijfsopslag gebruikt vanuit een Workfront-opslagportfolio of -programma, is het project een Adobe Enterprise-storage-project en wordt het portfolio of programma ook geconverteerd naar Adobe Enterprise-storage-objecten. Alle andere Workfront-opslagprojecten in hetzelfde portfolio of programma blijven ongewijzigd.
      >
      > Niet alle klanten hebben beide typen documentopslag.
      >
   ...
   1. Bekijk de volgende sjabloondetails aan de rechterkant:
   ...
   1. (Facultatief) Beweeg over de naam van een malplaatjenaam in het linkerpaneel en klik de **Favorieten** **pictogram** ![ pictogram van Favorieten ](assets/favorites-icon-small.png) om het als favoriet voor toekomstig gebruik te merken.
...
1. Klik **tot project** leiden.
   ...
   Er wordt automatisch een documentmap met dezelfde naam als het project gemaakt voor Adobe-opslagprojecten in de sectie Documenten van het project.
...
>[!NOTE]
>
>Met sjablonen die zijn gekoppeld aan Workfront-documentopslag worden verouderde Workfront-opslagprojecten gemaakt. Met sjablonen die zijn gekoppeld aan de opslag van Adobe-bedrijfsdocumenten worden Adobe-opslagprojecten gemaakt. Niet alle klanten hebben beide soorten opslag.
>
>Voor meer informatie, zie [ het beheeroverzicht van het Document voor projecten en verwante voorwerpen ](/help/quicksilver/manage-work/projects/manage-projects/manage-documents-on-projects.md).
