...
* Indien effectieve data worden toegepast op een valuta en de wisselkoersen ervan, zou de wisselkoers tijdens de looptijd van het project kunnen veranderen. Voor informatie over effectief-gedateerde wisselkoersen, zie [ de wisselkoers van de Opstelling ](/help/quicksilver/administration-and-setup/manage-workfront/exchange-rates/set-up-exchange-rates.md).
...
1. (Voorwaardelijk) Als u een andere valuta dan de standaardvaluta selecteert die voor uw Workfront-systeem is ingesteld, geeft u de wisselkoers op voor de valuta die u hebt geselecteerd, aangezien deze betrekking heeft op de valuta die is ingesteld als de basisvaluta in het systeem.
   ...
   >[!NOTE]
   >
   >Als het **gebruik datum-efficiënte wisselkoersen van het systeem** plaatsen voor dit project wordt aangezet, dan worden de wisselkoersoverschrijvingen niet toegelaten. Voor meer informatie, zie [ projecten ](/help/quicksilver/manage-work/projects/manage-projects/edit-projects.md) uitgeven.
