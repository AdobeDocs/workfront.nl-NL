...
* **Gepland Voordeel**: Dit is een handingang die door de Eigenaar van het Project wordt gespecificeerd wanneer de voltooiing van het **Info van het Project** gebied van het BedrijfsGeval.\
  Voor meer informatie over het Geplande Voordeel van een project, zie de [ sectie van Info van het 0} Project {in artikel ](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md#project-info) Overzicht van de Gebieden van het BedrijfsGeval [.](../../../manage-work/projects/define-a-business-case/areas-of-business-case.md)
