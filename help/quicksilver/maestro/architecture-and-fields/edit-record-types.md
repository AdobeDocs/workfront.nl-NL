...
Recordtypen zijn de objecttypen van Adobe Maestro. U kunt de weergave van recordtypen bewerken die u of iemand anders heeft gemaakt. Voor informatie over het maken van Maestro-recordtypen raadpleegt u [Recordtypen maken](../architecture-and-fields/create-record-types.md).
