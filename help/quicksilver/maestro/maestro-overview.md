---
title: Overzicht van Adobe Maestro
...
Adobe Maestro is een nieuw aanbod van Adobe Workfront. Het doel van Maestro is om uitgebreide zichtbaarheid in de operationele details van een organisatie te ontsluiten, en kritieke bedrijfsvragen in elke fase van de levenscyclus van het werkbeheer te beantwoorden.
...
Hieronder volgen enkele van de belangrijkste mogelijkheden van Maestro:
...
Hoewel Maestro deel uitmaakt van Workfront, wordt het geleverd met eigen begrippen en terminologie. Zorg ervoor dat u bekend bent met de Maestro-concepten voordat u begint met het instellen van Maestro voor uw organisatie.

Het kader voor Maestro is volledig aanpasbaar. U kunt alle recordtypen, hun kenmerken en alle bijbehorende velden maken op basis van de exacte behoeften van uw organisatie.

Hier volgen de belangrijkste Maestro-objecten en -concepten:
...
* **Recordtype**: Het hoofdobjecttype Maestro.
  ...
  In Workfront waar de objecttypen vooraf zijn gedefinieerd, kunt u in Maestro uw eigen objecttypen maken.
   ...
   * **Taxonomie**: Een recordtype waarmee kenmerken van een operationeel recordtype worden vastgelegd.
     ...
     Hoewel het creëren van taxonomieën met het creëren van operationele verslagtypes identiek is, maakt Maestro onderscheid tussen een operationeel verslagtype en een type van taxonomie verslag. Het doel van taxonomieën is het verbeteren van de types van operationele verslagen. <!--this is no longer true, but might be later?!: A taxonomy is a record without dates, like a static list of attributes.-->
...
## Beperkingen van Maestro-objecten

In de volgende tabel staan de limieten voor het aantal objecten dat u kunt maken in Maestro. De beperkingen zijn aan verandering onderhevig naarmate we overgaan op de volgende ontwikkelingsfasen van Maestro.
...
Ga voor meer informatie over het verlenen van toegang tot en het mogelijk maken van gebruik van Maestro naar [Toegang verlenen tot Adobe Maestro](../maestro/access/grant-access.md).
...
1. Klikken **Maestro** ![](assets/maestro-icon.png).
   ...
   Het gebied Maestro Workspaces wordt geopend.

1. (Optioneel en aanbevolen) Ga door met een aantal van de volgende acties om uw werkstructuur in Maestro te maken:
...
| Toegangsniveaus en machtigingen | | ✓ |  |
| Verzoeken verzenden |                               |                                  | ✓ |
| Creatief overzicht |                               |                                  | ✓ |
...
We geven regelmatig nieuwe functies aan Maestro. Voor een actuele lijst met vrijgegeven functies raadpleegt u [Adobe Maestro-releaseactiviteit](../maestro/release-activity.md).
