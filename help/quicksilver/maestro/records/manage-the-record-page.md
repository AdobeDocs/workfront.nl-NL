...
description: U kunt de lay-out van de recorddoos en de pagina in de Planning van Adobe Workfront uitgeven.
hidefromtoc: true
hide: true
...
U kunt de lay-out van de recorddoos en de pagina in de Planning van Adobe Workfront uitgeven. U kunt het recordvak weergeven in een recordweergave.

Het recordvak is een kleinere weergave van de recordpagina die wordt weergegeven in de weergave van een recordtype.

Wanneer u de indeling van een recordvak en pagina wijzigt, veranderen de vak- en paginawijzigingen voor alle records van hetzelfde type.
...
1. Klik in het recordvak of op de pagina op het pictogram Vastleggen ![](assets/grab-icon.png) links van een veldnaam, en sleep het op een gewenste plaats.
