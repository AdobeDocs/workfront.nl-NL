...
1. Klik op de knop **Hoofdmenu** ![](assets/main-menu-workfront.png) in de rechterbovenhoek, <!--or the **Main Menu** ![](assets/main-menu-shell.png) in the upper-left corner, if it is available,--> klik vervolgens op **Maestro**.
...
1. Klik met de rechtermuisknop op een recordrij
   ...
   Houd de muisaanwijzer boven de naam van een record en klik vervolgens op het menu Meer ![](assets/more-menu.png)en klik vervolgens op **Koppeling kopiëren**.
