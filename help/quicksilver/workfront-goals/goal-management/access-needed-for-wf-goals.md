...
* Uw organisatie moet een Workfront Ultimate-pakket hebben.
  ...
  Workfront Goals is niet beschikbaar voor Workfront Workflow packages.

  Neem contact op met uw Workfront-accountvertegenwoordiger als u Workfront op dit moment vernieuwt en u de doelstellingen van Workfront wilt behouden.

  Als u een nieuwe klant bent, kunnen Workfront Goals niet meer worden aangeschaft.
...
* Wijs u een Malplaatje van de Lay-out toe dat het gebied van Doelen in het Belangrijkste Menu omvat.
