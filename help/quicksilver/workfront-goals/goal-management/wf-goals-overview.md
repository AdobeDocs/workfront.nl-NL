...
>* Nieuw:
>   * Ultimate, of
>   * Selecteer of primeer, en een licentie voor Adoben als aanvulling op een Workfront-licentie
>* Huidig: Een licentie voor Adobe richt zich naast een Workfront-licentie
>
...
* Resultaten en activiteiten maken voor doelen om de voortgang van het doel aan te geven.
  ...
  Zie voor informatie over resultaten en activiteiten [Aan de slag met resultaten en activiteiten in Adobe Workfront Goals](../../workfront-goals/results-and-activities/get-started-with-results-and-activities.md).
...
* Bouw objectrapporten en vertoningsdoelinformatie in projectrapporten voor projecten die aan doelstellingen worden geassocieerd. Voor informatie over de plaats bepalen van doelinformatie over projecten, zie [Projecten toevoegen aan doelen in Adobe Workfront-doelen](../../workfront-goals/results-and-activities/connect-projects-to-goals-overview.md).
