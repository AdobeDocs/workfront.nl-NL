...
1. Voer in de volgende velden gegevens in:
   * **Goederennaam**: Voer een naam in voor het doel. Dit is een verplicht veld.
   * **Periode**: Selecteer een vooraf gedefinieerd kwartaal of jaar in het menu **Periode** vervolgkeuzelijst

      of

      Selecteer **Aangepaste datums inschakelen** selecteert u vervolgens een **Start** en **Einddatum** voor het doel.
...
1. Klikken **Doel maken**.
   ...
   * Een resultaat toevoegen
      ...
      Voor informatie over het toevoegen van resultaten raadpleegt u [Resultaten toevoegen aan doelen in Adobe Workfront-doelen](../results-and-activities/add-results-to-goals.md).
   * Een activiteit toevoegen

      Voor informatie over het toevoegen van activiteiten, zie [Activiteiten toevoegen aan doelen in Adobe Workfront](../results-and-activities/add-activities-to-goals.md).
...
U kunt een doel maken door een bestaand doel te kopiëren.
