...
1. Klik het **pictogram van het 1&rbrace; Belangrijkste Menu** Belangrijkste menupictogram ![&#x200B; in de hoger-juiste hoek van uw scherm, dan klik &#x200B;](../goal-alignment/assets/dots-main-menu-icon.png) Doelen **.**
   ...
   <table style="table-layout:auto"> 
    ...
    <tbody> 
     ...
     <tr> 
      ...
      <td>De naam van de gebruiker, het team, de groep, of de organisatie die als doelEigenaar wordt aangewezen. </td> 
     </tr> 
     <tr> 
      <td role="rowheader">Doelnaam</td> 
