...
1. Klik het **pictogram van het 1&rbrace; pictogram van het Belangrijkste Menu** ![&#x200B; in de hoger-juiste hoek, dan klik &#x200B;](assets/lines-main-menu.png) Doelen **.**
...
1. Selecteer een doel in de lijst en klik op een van de volgende opties boven aan de lijst:
   ...
   * **pictogram van het Aandeel** ![&#x200B; het pictogram van het 1&rbrace; Aandeel &lbrace;om het doel met andere mensen te delen. &#x200B;](assets/share-icon.png) Voor informatie, zie [&#x200B; een doel in de Doelen van Adobe Workfront delen &#x200B;](../workfront-goals-settings/share-a-goal.md).
   ...
   * **pictogram van de Schrapping** ![&#x200B; om het doel te schrappen, dan &#x200B;](assets/delete-icon.png) Schrapping **te klikken om te bevestigen.**  Voor informatie, zie [&#x200B; Schrapping en deactiveer doelstellingen in de Doelen van Adobe Workfront &#x200B;](../goal-management/delete-and-deactivate-goals.md).
