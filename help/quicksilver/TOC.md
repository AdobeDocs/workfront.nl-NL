...
* Productaankondigingen {#product-announcements}
   ...
   * Productintroducties {#product-releases}
      ...
      * 23.1 Release {#release-23-1}
         ...
         * [23.1 Verbeteringen op het gebied van project- en hulpbronnenbeheer](product-announcements/product-releases/23.1-release-activity/23-1-project-enhancements.md)
      ...
      * 21.1 Release {#release-21-1}
         ...
         * [21.1 Verbeteringen in projectbeheer](product-announcements/product-releases/21.1-release-activity/21-1-project-mgt-enhancements.md)
      ...
      * Workfront Proefrelease-activiteit {#proof-release}
      ...
      * Archief met driemaandelijkse release {#quarterly-release}
         * [Archief met driemaandelijkse release](product-announcements/product-releases/quarterly-release-archive/quarterly-release-archive.md)
         ...
         * release 2019.2 {#release-19-2}
            ...
            * [2019.2 Verbeteringen voor hulpbronnenbeheer](product-announcements/product-releases/quarterly-release-archive/2019.2-release-activity/2019.2-resource-management-enhancements.md)
         ...
         * release 2017.3 {#release-17-3}
            ...
            * [2017.3 Beta Slotactiviteit](product-announcements/product-releases/quarterly-release-archive/2017.3-release-activity/2017.3-beta-final-release-activity.md)
         ...
         * Workfront R1-release {#r1-release}
            ...
            * [Functionaliteit beschikbaar gesteld in Voorvertoning in 2016](product-announcements/product-releases/quarterly-release-archive/r1-release-activity/available-in-preview-in-2016.md)
   ...
   * Aankondigingen {#announcements}
      ...
      * Aankondigingsarchief {#announcement-archive}
         ...
         * [E-mailspoofing en antwoordverwijdering](product-announcements/announcements/announcement-archive/email-spoofing-pop-reply-message.md)
...
* Beheer en installatie {#administration-and-setup}
   ...
   * Aan de slag met het beheer {#get-started-administration}
      * [Aan de slag](administration-and-setup/get-started-wf-administration/get-started-with-wf-administration.md)
   ...
   * Adobe Workfront aanpassen {#customize}
      ...
      * Aangepaste formulieren {#custom-forms}
         ...
         * [Een afbeeldings- of andere middelenwidget toevoegen aan een aangepast formulier](administration-and-setup/customize-workfront/create-manage-custom-forms/add-widget-or-edit-its-properties-in-a-custom-form.md)
         * [Sectie-einde toevoegen](administration-and-setup/customize-workfront/create-manage-custom-forms/add-a-section-break-to-a-custom-form.md)
         ...
         * [Berekende gegevens toevoegen](administration-and-setup/customize-workfront/create-manage-custom-forms/add-calculated-data-to-custom-form.md)
         * [Een bestaand berekend aangepast veld opnieuw gebruiken](administration-and-setup/customize-workfront/create-manage-custom-forms/use-existing-calc-field-new-custom-form.md)
         * [Aangepaste velden en widgets plaatsen](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
         * [Delen voor aangepaste velden en widgets](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
         * [Een aangepast veld of aangepaste widget opnieuw gebruiken](administration-and-setup/customize-workfront/create-manage-custom-forms/reuse-an-existing-field.md)
         * [Weergavelogica toevoegen en logica overslaan](administration-and-setup/customize-workfront/create-manage-custom-forms/display-or-skip-logic-custom-form.md)
         ...
         * [Objecttypen verwijderen op een aangepast formulier](administration-and-setup/customize-workfront/create-manage-custom-forms/delete-object-type-on-a-custom-form.md)
      * Statussen en prioriteitslabels {#statuses-priority-labels}
   ...
   * Adobe Workfront beheren {#manage-wf}
      ...
      * Proofingfunctionaliteit configureren {#configure-proofing}
         ...
         * [Gebruikerssync tussen Workfront en Workfront Proef](administration-and-setup/manage-workfront/configure-proofing/user-sync-proofing.md)
         ...
         * [Delen van proefdrukken](administration-and-setup/manage-workfront/configure-proofing/configure-sharing-settings-users.md)
   ...
   * Groepen beheren {#manage-groups}
      ...
      * Groepen maken en beheren {#create-manage-groups}
         ...
         * [Configuratie van subgroepvoorkeuren ontgrendelen](administration-and-setup/manage-groups/create-and-manage-groups/lock-or-unlock-a-group-preference.md)
   ...
   * Integraties configureren {#configure-integrations}
      ...
      * [Help voor Adobe Workfront DAM openen](administration-and-setup/configure-integrations/access-help-workfront-dam.md)
   ...
   * Beheer in de Adobe Admin Console {#admin-in-admin-console}
      ...
      * [Voorbereiden op de Adobe Admin Console](administration-and-setup/adobe-admin-console/prep-for-admin-console.md)
...
* Basisbegrippen voor Adobe Workfront {#basics}
   ...
   * Navigeren door Adobe Workfront {#navigate}
      ...
      * [Overzicht van de project-, taak- en uitgiftedatums in Adobe Workfront](workfront-basics/navigate-workfront/workfront-navigation/definitions-pti-dates.md)
   * Home {#home}
   ...
   * Meldingen gebruiken {#use-notifications}
      ...
      * [Adobe Workfront-berichten](workfront-basics/using-notifications/wf-notifications.md)
      ...
      * [Waarschuwingen: Delegatie](workfront-basics/using-notifications/notifications-delegation.md)
   ...
   * Uw account en profiel beheren {#manage-account-profile}
      ...
      * Gebruikersprofiel configureren {#configure-user-profile}
         ...
         * [Persoonlijke tijd in Adobe Workfront configureren](workfront-basics/manage-your-account-and-profile/configuring-your-user-profile/personal-time-overview.md)
   ...
   * Mobiele apps {#mobile-apps}
      ...
      * Mobiele Adobe Workfront-apps gebruiken {#use-workfront-mobile-app}
         ...
         * [Virtuele assistent voor Adobe Workfront Mobile-app](workfront-basics/mobile-apps/using-the-workfront-mobile-app/wf-mobile-virtual-assistant.md)
      ...
      * Adobe Workfront-weergave gebruiken {#use-workfront-view}
         ...
         * [Projecten weergeven in de Adobe Workfront-weergave](workfront-basics/mobile-apps/using-workfront-view/display-projects-in-wokrfont-view.md)
      ...
      * Tips, trucs en probleemoplossing voor Adobe Workfront Mobile Apps {#tips-tricks-for-mobile-apps}
         ...
         * [Foutbericht op de Adobe Workfront Mobile-app: &quot;Uw account is niet API ingeschakeld.&quot;](workfront-basics/mobile-apps/tips-tricks-and-troubleshooting/error-message-on-mobile-app.md)
   * Tips, trucs en probleemoplossing voor Adobe Workfront Basics {#tips-tricks-for-basics}
      ...
      * [Problemen met Workfront Proofing Manager-machtigingen oplossen](workfront-basics/tips-tricks-and-troubleshooting/wp-manager-permissions-troubleshooting.md)
...
* Werk beheren {#manage-work}
   ...
   * Projecten {#projects}
      ...
      * Projectfinanciën {#project-finances}
         ...
         * [Projectfinancieringvelden](manage-work/projects/project-finances/project-finances-overview-1.md)
...
* Werk beoordelen en goedkeuren {#review-and-approve-work}
   ...
   * Proofing {#proofing}
      ...
      * Proefversies bekijken in Adobe Workfront {#review-proofs-in-workfront}
         ...
         * Een bewijs controleren {#review-a-proof}
            * [Een bewijs controleren](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/review-a-proof.md)
            ...
            * [Sneltoetsen in de testviewer](review-and-approve-work/proofing/reviewing-proofs-within-workfront/review-a-proof/keyboard-shortcuts-proof.md)
...
* Timesheets {#timesheets}
   ...
   * Configureren hoe tijd wordt vastgelegd {#configure-timesheet-preferences}
...
* Adobe Workfront Fusion {#adobe-workfront-fusion}
   ...
   * Basisbegrippen van Adobe Workfront Fusion {#workfront-fusion-basics}
      ...
      * [Gebruikersgegevens verwijderen uit Adobe Workfront Fusion](workfront-fusion/workfront-fusion-basics/delete-user-data.md)
      * [Veelgestelde vragen over Adobe Workfront Fusion](workfront-fusion/workfront-fusion-basics/faq.md)
   ...
   * Fouten in Adobe Workfront Fusion {#errors-in-fusion}
      * [Fouten in Adobe Workfront Fusion](workfront-fusion/errors/errors.md)
      * [Fout bij verwerking in Adobe Workfront Fusion](workfront-fusion/errors/error-processing.md)
      * [Foutafhandeling in Adobe Workfront Fusion](workfront-fusion/errors/error-handling.md)
      * [Richtlijnen voor foutafhandeling in Adobe Workfront Fusion](workfront-fusion/errors/directives-for-error-handling.md)
      * [Foutafhandeling opnieuw uitvoeren in Adobe Workfront Fusion](workfront-fusion/errors/retry.md)
      * [Foutafhandeling genereren in Adobe Workfront Fusion](workfront-fusion/errors/throw.md)
      * [Geavanceerde foutafhandeling in Adobe Workfront Fusion](workfront-fusion/errors/advanced-error-handling.md)
   * Functies in Adobe Workfront Fusion {#functions-in-fusion}
      * [Functies in Adobe Workfront Fusion](workfront-fusion/functions/functions.md)
      * [Algemene functies in Adobe Workfront Fusion](workfront-fusion/functions/general-functions.md)
      * [Items toewijzen met behulp van functies in Adobe Workfront Fusion](workfront-fusion/functions/map-using-functions.md)
      * [Datum- en tijdfuncties in Adobe Workfront Fusion](workfront-fusion/functions/date-and-time-functions.md)
      * [Tekenreeksfuncties in Adobe Workfront Fusion](workfront-fusion/functions/string-functions.md)
      * [Wiskundige functies in Adobe Workfront Fusion](workfront-fusion/functions/math-functions.md)
      * [Wiskundige variabelen in Adobe Workfront Fusion](workfront-fusion/functions/math-variables.md)
      * [Arrayfuncties in Adobe Workfront Fusion](workfront-fusion/functions/array-functions.md)
      * [Tokens voor datum- en tijdnotaties in Adobe Workfront Fusion](workfront-fusion/functions/tokens-for-date-and-time-formatting.md)
   ...
   * Toewijzing in Adobe Workfront Fusion {#mapping-in-fusion}
      * [Toewijzing in Adobe Workfront Fusion](workfront-fusion/mapping/mapping.md)
      * [Informatie van de ene module toewijzen aan de andere in Adobe Workfront Fusion](workfront-fusion/mapping/map-information-between-modules.md)
      * [Over het toewijzen van bestanden in Adobe Workfront Fusion](workfront-fusion/mapping/about-mapping-files.md)
      * [Gegevenstypen item in Adobe Workfront Fusion](workfront-fusion/mapping/item-data-types.md)
      * [Een array toewijzen in Adobe Workfront Fusion](workfront-fusion/mapping/map-an-array.md)
      * [Typedruk in Adobe Workfront Fusion](workfront-fusion/mapping/type-coercion.md)
   * Modules in Adobe Workfront Fusion {#modules-in-fusion}
      ...
      * [De instellingen van een module configureren in Adobe Workfront Fusion](workfront-fusion/modules/configure-a-modules-settings.md)
      * [Kies waar een triggermodule begint in Adobe Workfront Fusion](workfront-fusion/modules/choose-where-trigger-module-starts.md)
      * [Gegevensopslag in Adobe Workfront Fusion](workfront-fusion/modules/data-stores.md)
      * [Gegevensstructuren in Adobe Workfront Fusion](workfront-fusion/modules/data-structures.md)
      * [Samenvoegmodule in Adobe Workfront Fusion](workfront-fusion/modules/aggregator-module.md)
      * [Router module in Adobe Workfront Fusion](workfront-fusion/modules/router-module.md)
      * [Iteratormodule in Adobe Workfront Fusion](workfront-fusion/modules/iterator-module.md)
      * [HTTP-aanvraagmethoden in Adobe Workfront Fusion](workfront-fusion/modules/http-request-methods.md)
      * [Problemen met tekstparser oplossen in Adobe Workfront Fusion](workfront-fusion/modules/text-parser-troubleshooting.md)
   * Organisaties in Adobe Workfront Fusion {#organizations-in-fusion}
      * [Organisaties in Adobe Workfront Fusion](workfront-fusion/organizations/organizations.md)
      * [Adobe Workfront Fusion-organisaties en -teams](workfront-fusion/organizations/organizations-and-teams.md)
   ...
   * Scenario&#39;s in Adobe Workfront Fusion {#scenarios-in-fusion}
      ...
      * Adobe Workfront Fusion-scenario-sjablonen {#fusion-scenario-templates}
         ...
         * [Adobe Workfront Fusion-sjablonen publiceren en delen](workfront-fusion/scenarios/templates/publish-and-share-fusion-templates.md)
         * [Scènes maken met Adobe Workfront Fusion-sjablonen](workfront-fusion/scenarios/templates/create-scenarios-with-fusion-templates.md)
         * [Adobe Workfront Fusion-sjablonen weergeven, bewerken en verwijderen](workfront-fusion/scenarios/templates/view-edit-and-delete-fusion-templates.md)
         * [Adobe Workfront Fusion Templates-beheer](workfront-fusion/scenarios/templates/fusion-templates-adminstration.md)
         * [Veelgestelde vragen over Adobe Workfront Fusion-sjablonen](workfront-fusion/scenarios/templates/fusion-templates-faqs.md)
         * [Momenteel beschikbare Adobe Workfront Fusion-sjablonen](workfront-fusion/scenarios/templates/currently-available-fusion-templates.md)
      * [Voorbeeld van Adobe Workfront Fusion-scenario: E-mail-, Text Parser- en Google-werkbladen verbinden](workfront-fusion/scenarios/example-connect-email-text-parser-gsheets.md)
      * [Een scenario-versie herstellen in Adobe Workfront Fusion](workfront-fusion/scenarios/restore-a-scenario-version.md)
      * [Modules of scenario&#39;s kopiëren in Adobe Workfront Fusion](workfront-fusion/scenarios/copy-modules-or-scenarios.md)
   * Workfront Fusion Apps en hun modules {#fusion-apps-and-modules}
      ...
      * [Workfront Proofing-modules](workfront-fusion/apps-and-their-modules/workfront-proof-modules.md)
      ...
      * [Allocadia](workfront-fusion/apps-and-their-modules/allocadia-modules.md)
      * [Anaplan Modules](workfront-fusion/apps-and-their-modules/anaplan-modules.md)
      * [Archiefmodules](workfront-fusion/apps-and-their-modules/archive-modules.md)
      ...
      * [Byndermodules](workfront-fusion/apps-and-their-modules/bynder-modules.md)
      ...
      * [Cilummodules](workfront-fusion/apps-and-their-modules/cvent-modules.md)
      ...
      * [Google-kalendermodules](workfront-fusion/apps-and-their-modules/google-calendar-modules.md)
      ...
      * HTTP-modules {#fusion-http-modules}
         ...
         * [HTTP > Een aanvraagmodule maken](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-request.md)
         * [HTTP > Een module voor basisautorisatieverzoeken maken](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-basic-auth-request.md)
         * [HTTP > Een OAuth 2.0-aanvraagmodule maken](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-oauth-2-request.md)
         * [HTTP > Een aanvraagmodule voor een clientcertificaat maken](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-a-client-cert-auth-request.md)
         * [HTTP > Een aanvraag voor een API-sleutelautorisatie indienen](workfront-fusion/apps-and-their-modules/http-modules/http-module-make-an-api-key-auth-request.md)
         * [HTTP > Overige modules](workfront-fusion/apps-and-their-modules/http-modules/http-modules.md)
         * [Wederzijdse TLS gebruiken in HTTP-modules in Adobe Workfront Fusion](workfront-fusion/apps-and-their-modules/http-modules/use-mtls-in-http-modules.md)
      ...
      * [Intaccingmodules](workfront-fusion/apps-and-their-modules/intacct-modules.md)
      * [Jira-softwaremodules](workfront-fusion/apps-and-their-modules/jira-software-modules.md)
      ...
      * [Microsoft OneDrive voor Bedrijven](workfront-fusion/apps-and-their-modules/microsoft-onedrive-for-business-modules.md)
      ...
      * [Microsoft Word-sjabloonmodules](workfront-fusion/apps-and-their-modules/microsoft-word-templates-modules.md)
      ...
      * [Qualtriciteitsmodules](workfront-fusion/apps-and-their-modules/qualtrics-modules.md)
      ...
      * [Door SDL beheerde vertaalmodules](workfront-fusion/apps-and-their-modules/sdl-managed-translation-modules.md)
      ...
      * [Gereedschappen](workfront-fusion/apps-and-their-modules/tools-modules.md)
      ...
      * [Breidingsmodules](workfront-fusion/apps-and-their-modules/widen-modules.md)
   ...
   * Webhaken in Adobe Workfront Fusion {#webhooks-in-fusion}
      * [Webhaken in Adobe Workfront Fusion](workfront-fusion/webhooks/webhooks.md)
      * [Instant triggers (webhaken) in Adobe Workfront Fusion](workfront-fusion/webhooks/instant-triggers-webhooks.md)
* Adobe Workfront-integratie {#adobe-workfront-integrations}
   ...
   * Adobe Workfront for G Suite {#workfront-for-g-suite}
      ...
      * [Adobe Workfront for G Suite installeren](workfront-integrations-and-apps/workfront-for-g-suite/install-workfront-for-gsuite.md)
      * [Aanmelden bij en uit Adobe Workfront for G Suite](workfront-integrations-and-apps/workfront-for-g-suite/log-in-and-out-wf-for-gsuite.md)
      * [Adobe Workfront Home-inhoud openen vanuit G Suite](workfront-integrations-and-apps/workfront-for-g-suite/access-wf-home-content-from-g-suite.md)
      * [Een Adobe Workfront-object bijwerken vanuit G Suite](workfront-integrations-and-apps/workfront-for-g-suite/update-a-workfront-object-in-gsuite.md)
      * [Documenten van G Suite weergeven en beheren](workfront-integrations-and-apps/workfront-for-g-suite/view-and-manage-documents-in-gsuite.md)
      * [Adobe Workfront-objectgegevens weergeven en beheren vanuit G Suite](workfront-integrations-and-apps/workfront-for-g-suite/view-manage-work-item-details-in-gsuite.md)
      * [Adobe Workfront-objectupdates weergeven vanuit G Suite](workfront-integrations-and-apps/workfront-for-g-suite/view-object-updates-in-gsuite.md)
      * [Adobe Workfront-meldingsgegevens beheren vanuit G Suite](workfront-integrations-and-apps/workfront-for-g-suite/manage-wf-email-notification-details-in-gsuite.md)
      * [Reageren op een Adobe Workfront-updatemelding van G Suite](workfront-integrations-and-apps/workfront-for-g-suite/reply-to-wf-update-notification-from-gsuite.md)
      * [E-mailberichten van de Intel Health Care Management Suite omzetten in Adobe Workfront-objecten en -updates](workfront-integrations-and-apps/workfront-for-g-suite/turn-gsuite-emails-into-wf-objects-and-updates.md)
      * [Een Adobe Workfront-taak maken in G Suite met e-mailinhoud](workfront-integrations-and-apps/workfront-for-g-suite/create-wf-task-in-gsuite-using-email-content.md)
      * [Een Adobe Workfront-uitgave in G Suite maken met e-mailinhoud](workfront-integrations-and-apps/workfront-for-g-suite/create-wf-issue-in-g-suite-using-email-content.md)
   ...
   * Adobe Workfront for Outlook {#workfront-for-outlook}
      ...
      * [Een Adobe Workfront-verzoek maken vanuit een Outlook-e-mail](workfront-integrations-and-apps/using-workfront-with-outlook/create-a-wf-request-from-an-outlook-email.md)
...
* Workfront Proof {#workfront-proof}
   ...
   * Aan de slag met Workfront Proof {#get-started-wf-proof}
      ...
      * Workflowvoorbeelden {#workflow-examples}
         ...
         * [Proefdrukproces in Workfront-proefdrukken](workfront-proof/wp-getstarted/workflow-examples/basic-proof-process.md)
         * [Interne en externe revisie in Workfront Proef](workfront-proof/wp-getstarted/workflow-examples/internal-external-review.md)
      ...
      * Persoonlijke instellingen in Workfront Proef {#personal-settings-in-wf-proof}
         * [Persoonlijke instellingen in Workfront Proef](workfront-proof/wp-getstarted/personal-settings/personal-settings.md)
         * [Aanwijzing van eigenaars van tijdelijke bewijzen in Workfront Proef](workfront-proof/wp-getstarted/personal-settings/designate-temp-proof-owners.md)
         * [Integraties - Gebruikersinstellingen](workfront-proof/wp-getstarted/personal-settings/integrations-user-setup.md)
      * Systeeminformatie in Workfront Proef {#system-info-wf-proof}
         * [Systeeminformatie in Workfront Proef](workfront-proof/wp-getstarted/system-information/system-information.md)
         * [Testomgeving voor sandbox voorvertonen - Workfront-proefdruk](workfront-proof/wp-getstarted/system-information/preview-sandbox.md)
         * [Taalinstellingen in Workfront Proof](workfront-proof/wp-getstarted/system-information/language-settings.md)
         * [Codecs in Workfront-proefdrukken](workfront-proof/wp-getstarted/system-information/codecs.md)
      * Veelgestelde vragen over Workfront Proof {#wf-proof-faq}
         ...
         * [Veelgestelde vragen - Workfront Proofing-account](workfront-proof/wp-getstarted/faqs/faq-wp-account.md)
         * [Aanmelden en uw wachtwoord en e-mail wijzigen voor Workfront Proof](workfront-proof/wp-getstarted/faqs/log-in-change-password.md)
         * [Tijdzones instellen in Workfront Proef](workfront-proof/wp-getstarted/faqs/set-timezones-in-wp.md)
   * Werken met proefdrukken en bestanden in Workfront Proof {#work-with-proofs-in-wf-proof}
      ...
      * Geautomatiseerde workflow in Workfront Proof {#automated-workflow-in-wf-proof}
         ...
         * [Een proefdruk maken met een automatische workflow in Workfront Proof](workfront-proof/wp-work-proofsfiles/automated-workflow/set-up-proof-auto-workflow.md)
      ...
      * Basisfuncties in Workfront Proof {#basic-features-in-wf-proof}
         ...
         * [Het dashboard in Workfront Proef](workfront-proof/wp-work-proofsfiles/basic-features/dashboard.md)
         * [Pagina-indeling op het tabblad Weergaven in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/basic-features/page-layout-view.md)
         * [Workfront-proefexemplaar zoeken](workfront-proof/wp-work-proofsfiles/basic-features/search.md)
         * [Workfront ProefActiviteit Audit Trail](workfront-proof/wp-work-proofsfiles/basic-features/activity-audit-trail.md)
      * Proefdrukken en bestanden maken {#create-proofs-and-files}
         ...
         * [Proefdrukken genereren in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/generate-proofs.md)
         * [Proefdrukken kopiëren in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/create-proofs-and-files/copy-proofs.md)
      ...
      * Uw werk beheren {#manage-your-work}
         ...
         * [Bestanden beheren in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-files.md)
         * [Items op de weergavepagina beheren in Workfront Proof](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-items-on-views-page.md)
         * [Proefversies beheren in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/manage-your-work/manage-proof-versions.md)
         ...
         * [Aangepaste weergaven maken en beheren in proefdrukken van Workfront](workfront-proof/wp-work-proofsfiles/manage-your-work/create-and-manage-custom-views.md)
         ...
         * [De voortgang en status van een proefdruk in Workfront bekijken](workfront-proof/wp-work-proofsfiles/manage-your-work/view-progress-and-status-of-proof.md)
         * [Proef van staat in Workfront](workfront-proof/wp-work-proofsfiles/manage-your-work/proof-state.md)
         * [Een proef verwijderen in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/manage-your-work/delete-proof.md)
         * [De prullenmand herstellen en leegmaken in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/manage-your-work/restore-and-empty-trash.md)
      ...
      * Uw werk organiseren {#organize-your-work}
         ...
         * [Mappen in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/organize-your-work/folders.md)
         * [Mappen maken in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/organize-your-work/create-folders.md)
         * [Mappen beheren in Workfront Proef](workfront-proof/wp-work-proofsfiles/organize-your-work/manage-folders.md)
         * [Mappen en de inhoud ervan beheren in Workfront Proef](workfront-proof/wp-work-proofsfiles/organize-your-work/manage-folders-and-contents.md)
         * [Mappen delen in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/organize-your-work/share-folders.md)
         * [Mapmachtigingen begrijpen in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/organize-your-work/folder-permissions.md)
         * [Tags maken en beheren in Workfront Proef](workfront-proof/wp-work-proofsfiles/organize-your-work/create-and-manage-tags.md)
         * [Archief in Workfront Proof](workfront-proof/wp-work-proofsfiles/organize-your-work/archive.md)
         * [Back-ups maken van uw Workfront-proefgegevens](workfront-proof/wp-work-proofsfiles/organize-your-work/back-up-data.md)
         * [Opmerkingen afdrukken en exporteren in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/organize-your-work/print-and-export-comments.md)
      ...
      * Proefdrukken bekijken in de webproefdrukweergave {#review-proofs-web-proofing-viewer}
         ...
         * [Proefdrukken openen in Workfront Proof](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/open-proof.md)
         ...
         * [Sneltoetsen in de Workfront Proofing-viewer](workfront-proof/wp-work-proofsfiles/review-proofs-wpv/keyboard-shortcuts.md)
      ...
      * Proefdrukken en bestanden delen {#share-proofs-and-files}
         ...
         * [Een proefexemplaar delen in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof.md)
         * [Proofingkoppelingen delen in Workfront Proef](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-proof-links.md)
         * [De openbare URL delen in Workfront Proof](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-public-url.md)
         * [Bestanden delen in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/share-files.md)
         ...
         * [Abonneren op een proefexemplaar in Workfront](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/subscribe-to-proof.md)
         ...
         * [Proefdrukrollen beheren in Workfront-proefdrukken](workfront-proof/wp-work-proofsfiles/share-proofs-and-files/manage-proof-roles.md)
   * Workfront Proof account Administration {#wf-proof-account-admin}
      ...
      * Accountinstellingen in Workfront Proof {#account-settings-in-wf-proof}
         ...
         * [Workfront Proefgebruikers beheren](workfront-proof/wp-acct-admin/account-settings/manage-wp-users.md)
         * [Een machtigingsprofiel voor proefdrukken van een gebruiker configureren in Workfront Proof](workfront-proof/wp-acct-admin/account-settings/config-user-pref-in-wp.md)
         * [Aangepaste profielen configureren in Workfront Proef](workfront-proof/wp-acct-admin/account-settings/configure-custom-profiles.md)
         ...
         * [Proefmachtigingenprofielen in Workfront Proef](workfront-proof/wp-acct-admin/account-settings/proof-perm-profiles-in-wp.md)
         * [Opties voor goedkeuringsbeslissingen configureren in Workfront Proef](workfront-proof/wp-acct-admin/account-settings/configure-approval-decision-in-wp.md)
         ...
         * [De dropzone configureren in Workfront Proof](workfront-proof/wp-acct-admin/account-settings/configure-dropzone-in-wp.md)
         ...
         * [De Workfront Proof Administrator-accountgeschiedenis van uw organisatie weergeven](workfront-proof/wp-acct-admin/account-settings/view-org-wp-acct-history.md)
         * [Controleer uw Workfront Proofing-opslag](workfront-proof/wp-acct-admin/account-settings/check-workfront-proof-storage.md)
      ...
      * Branding Workfront Proof {#branding-wf-proof}
         ...
         * [De Workfront Proof-site plaatsen](workfront-proof/wp-acct-admin/branding/brand-wp-site.md)
      ...
      * Beveiliging beheren {#manage-security}
         ...
         * [Werken met elektronische handtekeningen in Workfront Proef](workfront-proof/wp-acct-admin/managing-security/electronic-sigs-in-wp.md)
      * Partneraccounts in Workfront Proof {#partner-accounts-in-wf-proof}
         ...
         * [Een partnerrelatie beheren tussen Workfront Proof-accounts](workfront-proof/wp-acct-admin/partner-accounts/manage-partner-relationship-between-wp-accts.md)
      ...
      * Tips, trucs en probleemoplossing voor Workfront Proof-accountbeheer {#ttt-wf-proof-account-admin}
         ...
         * [Veelgestelde vragen: Workfront Proof - migratie van VS naar EMEA](workfront-proof/wp-acct-admin/tips-tricks-and-troubleshooting/faq-wp-us-to-emea-mig.md)
   * Factureringsinstellingen Workfront Proof {#wf-proof-billing-settings}
      * [Factureringsinstellingen Workfront Proof](workfront-proof/wp-billingsettings/wp-billing-settings.md)
      * Uw facturering beheren {#manage-billing}
         ...
         * [Factureringspagina voor Workfront-proefdrukken](workfront-proof/wp-billingsettings/manage-your-billing/wp-billing-page.md)
         * [Je betalingsmethode kiezen in Workfront Proef](workfront-proof/wp-billingsettings/manage-your-billing/choose-payment-method-in-wp.md)
         * [Uw Workfront-proeffactuur downloaden](workfront-proof/wp-billingsettings/manage-your-billing/download-wp-invoice.md)
   ...
   * Meldingen en herinneringen controleren {#proof-notifications-and-reminders}
      ...
      * Spamfilters vermijden {#avoid-spam-filters}
         ...
         * [E-mails met Workfront-proefdrukken configureren om spamfilters te voorkomen](workfront-proof/wp-emailsntfctns/avoiding-spam-filters/configure-wp-emails-avoid-spam-filters.md)
   ...
   * E-mailwaarschuwingen {#email-alerts}
      ...
      * [Instellingen voor e-mailwaarschuwingen wijzigen voor een proefdruk in Workfront Proef](workfront-proof/wp-emailsntfctns/email-alerts/change-email-alert-settings-wp.md)
   * Gebruikers en contactpersonen beheren in Workfront Proof {#managing-users-in-wf-proof}
      ...
      * Gebruikers {#users}
         ...
         * [Gebruikers maken met Workfront Proef](workfront-proof/wp-mnguserscontacts/users/create-users.md)
         * [Gebruikersgegevens configureren met Workfront Proef](workfront-proof/wp-mnguserscontacts/users/configure-user-info.md)
         ...
         * [Gebruikers tussen accounts verplaatsen met Workfront-proefafdruk](workfront-proof/wp-mnguserscontacts/users/move-users-between-accounts.md)
      * Groepen {#groups}
         ...
         * [Proofinggroepen maken met Workfront-proefdrukken](workfront-proof/wp-mnguserscontacts/groups/create-proofing-groups.md)
         * [Groepen privé maken met Workfront-proefdruk](workfront-proof/wp-mnguserscontacts/groups/make-groups-private.md)
         * [Groepen beheren met Workfront Proef](workfront-proof/wp-mnguserscontacts/groups/manage-groups.md)
      * Contactpersonen {#contacts}
         * [Contactpersonen](workfront-proof/wp-mnguserscontacts/contacts/contacts.md)
         * [Een gast toevoegen aan een Workfront-proefexemplaar](workfront-proof/wp-mnguserscontacts/contacts/add-guest.md)
         * [Uw contactpersonen beheren in Workfront Proof](workfront-proof/wp-mnguserscontacts/contacts/manage-contacts.md)
         * [Gebruikers, leden en gasten in Workfront-proefdrukken](workfront-proof/wp-mnguserscontacts/contacts/use-members-guests.md)
   ...
   * Workfront Proof mobile {#wf-proof-mobile}
      ...
      * Workfront Proof mobile-apps {#wf-proof-mobile-apps}
         ...
         * [Workfront Proof mobile-app voor tablets](workfront-proof/wp-mobile/wp-mobile-apps/wp-mobile-app-tablet.md)
      * Tips, trucs en probleemoplossing voor de Workfront Proof mobile-app {#ttt-wf-proof-mobile-apps}
         * [Tips, trucs en probleemoplossing voor de Workfront Proof mobile-app](workfront-proof/wp-mobile/tips-tricks-and-troubleshooting/tips-tricks-troubleshooting-wp-mobile.md)
         * [Aanmelden bij de Workfront Proof Mobile-app is mislukt](workfront-proof/wp-mobile/tips-tricks-and-troubleshooting/unable-to-log-in.md)
   * Workfront Proof tech corner {#wf-proof-tech-corner}
      ...
      * Problemen oplossen in Workfront Proef {#troubleshooting-wf-proof}
         * [Problemen oplossen in Workfront Proef](workfront-proof/wp-tech-corner/troubleshooting/troubleshooting.md)
   ...
   * Workfront Proof-integratie {#wf-proof-integrations}
      ...
      * Box {#box}
         ...
         * [Inleiding tot de integratie van Workfront Proof and Box](workfront-proof/wp-integrations/box/introduction-to-box.md)
         * [Een proefafdruk maken via je Box-account](workfront-proof/wp-integrations/box/create-proof-box-account.md)
         * [Mappen synchroniseren met Workfront-proefdruk](workfront-proof/wp-integrations/box/sycn-box-folder.md)
      ...
      * Basecamp {#basecamp}
         ...
         * [Begrijp de Basecamp Integratie met het Bewijs van Workfront](workfront-proof/wp-integrations/basecamp/basecamp-integration-overview.md)
...
* Adobe Workfront API {#adobe-workfront-api}
   ...
   * API-notities {#api-notes}
      ...
      * [Beschikbare tijd van gebruiker ophalen](wf-api/api/api-user-available-time.md)
   ...
   * Document Webhooks-API {#document-webhooks-api}
      * [API-artikelen voor documentwebhaken](wf-api/doc-wbhks-api/document-webhooks-api.md)
...
* [Verborgen bestand](hidden-test.md)
