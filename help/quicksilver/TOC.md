...
* Basisbegrippen voor Adobe Workfront {#basics}
   ...
   * Home {#home}
      ...
      * Het gebied Home gebruiken {#use-home-area}
         ...
         * [ gebruik Mijn widget van Verzoeken ](workfront-basics/using-home/using-the-home-area/my-requests-widget.md)
...
* Adobe Workfront Planning {#adobe-workfront-planning}
   ...
   * Adobe Workfront-planningsarchitectuur {#adobe-workfront-planning-architecture}
      ...
      * [Recordtypen voor meerdere werkruimten toevoegen](planning/architecture/add-cross-workspace-record-types.md)
...
* Adobe Workfront-integratie {#adobe-workfront-integrations}
   ...
   * Integratie van revisie en goedkeuring {#review-approval-integrations}
      * [Integraties voor revisie en goedkeuring: artikelindex](/help/quicksilver/workfront-integrations-and-apps/review-and-approval-integrations/review-approval-integrations-toc.md)
