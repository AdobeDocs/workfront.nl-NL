...
* Productaankondigingen {#product-announcements}
   ...
   * Productintroducties {#product-releases}
      ...
      * 23.3 Release {#release-23-3}
         ...
         * [23.3 releaseactiviteitweek van 10 april 2023](product-announcements/product-releases/23.3-release-activity/23-3-apr-10.md)
         * [23.3 releaseactiviteitweek van 17 april 2023](product-announcements/product-releases/23.3-release-activity/23-3-apr-17.md)
         * [23.3 releaseactiviteitweek van 24 april 2023](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-apr-24.md)
         ...
         * [23.3 releaseactiviteit week van 12 juni 2023](/help/quicksilver/product-announcements/product-releases/23.3-release-activity/23-3-jun-12.md)
      ...
      * Aangepaste formulieren {#custom-forms}
         ...
         * Verouderde aangepaste formulierbuilder {#custom-form-builder}
            * De aangepaste formulierbuilder gebruiken {#use-the-custom-form-builder}
               ...
               * [Een aangepast formulier maken of bewerken met de verouderde builder](administration-and-setup/customize-workfront/create-manage-custom-forms/create-or-edit-a-custom-form.md)
               ...
               * [Aangepaste velden en widgets positioneren met de oudere builder](administration-and-setup/customize-workfront/create-manage-custom-forms/position-fields-in-a-custom-form.md)
               * [Delen voor aangepaste velden en widgets met de verouderde builder](administration-and-setup/customize-workfront/create-manage-custom-forms/configure-sharing-for-a-custom-field.md)
...
* Adobe Workfront-integratie {#adobe-workfront-integrations}
   ...
   * Adobe Workfront for Creative Cloud {#workfront-for-creative-cloud}
      ...
      * Werken beheren met de Adobe Workfront-insteekmodule voor Creative Cloud-toepassingen {#manage-wf-cc}
         ...
         * [Beheren [!DNL Adobe Workfront] meldingen van Adobe Creative Cloud](/help/quicksilver/workfront-integrations-and-apps/adobe-workfront-for-creative-cloud/wf-cc-notifications.md)
