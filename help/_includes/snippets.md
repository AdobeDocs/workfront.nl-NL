...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront.

## Stap 1 - klik slechts de Hoofdshell van het Menu {#step1-click-main-menu-shell-only}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek.

## Stap 1 - klik dan het Belangrijkste Menu - {#step1-click-mm-then-click}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik

## Stap 1 - Klik op uw profielafbeelding - {#step1-click-profile-pic}

1. Klik op de profielafbeelding in het bovenste navigatiegebied van Adobe Workfront en klik vervolgens op **[!UICONTROL Workfront Profile]** .

<!-- Notes for Workflow packaging -->

## Opmerking voor Workflow Ultimate {#ultimate-package}

>[!IMPORTANT]
>
>U moet beschikken over het Workflow Ultimate-pakket om deze functie te kunnen gebruiken.

## Opmerking voor Workflow Prime/Ultimate {#prime-or-ultimate-package}

>[!IMPORTANT]
>
>U moet beschikken over de Workflow Prime of het Workflow Ultimate-pakket om deze functie te kunnen gebruiken.

## Nota voor het Pakket van het Werkschema voor de kosten/het facturerings verdeling {#workflow-package-for-cost-billing}

>[!IMPORTANT]
>
>U moet beschikken over het pakket Workflow Select, Prime of Ultimate om aparte facturerings- en kostenmachtigingen te kunnen bekijken.

<!-- Admin and Setup -->

## Stap 1 - het krijgen aan Opstelling {#step-1-to-setup}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Setup]** ![ pictogram van de Opstelling ](/help/_includes/assets/gear-icon-setup.png).
...
>
>Als uw organisatie aan Adobe Admin Console is bezet, zie [ verschillen van het Beleid tussen Adobe Workfront en Adobe Bedrijfs Platform ](/help/quicksilver/administration-and-setup/get-started-wf-administration/actions-in-admin-console.md).

## Stap 1 - Aan gebruikers worden {#step-1-to-users}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Users]** ![ pictogram van Gebruikers ](/help/_includes/assets/users-icon-in-main-menu.png).
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Boards]**.

<!-- Blueprints -->

## Stap 1 - Aan blauwdrukken komen - {#step1-to-blueprints}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Blueprints]**.

<!-- Calendars -->

## Stap 1 - Aan kalenders komen - {#step1-to-calendars}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Calendars]**.

<!-- Documents -->

## Stap 1 - Aan documenten worden onderworpen - {#step1-to-documents}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Documents]**.
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Home]**.
...
## Stap 1 - Voorrang krijgen - {#step1-to-priorities}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Priorities]**.
...
1. (Optioneel) Instellingen voor automatische proefdrukwerkstromen aanpassen
   ...
   <tr>
      ...
      <td>
      <ol>
      <li>In het Add nieuwe ontvankelijke vakje, begin typend de naam van de gebruiker.</li>
      <li>Geef de proefdrukrol op.</li>
      <li>Kies het type e-mailwaarschuwingen voor de ontvanger.</li>
      </ol>
      </td>
   </tr>
   <tr>
   ...
   <tr>
      ...
      <td>
      <ol>
      <li>Schakel het selectievakje in om gebruikers te waarschuwen wanneer de proefdruk wordt gemaakt.</li>
      </ol>
      </td>
   </tr>
   <tr>
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Planning]**.
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Portfolios]**.

## Stap 1 - Aan Programma&#39;s worden - {#step1-to-programs}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Programs]**.

## Stap 1 - Aan Projecten worden - {#step1-to-projects}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Projects]**.

## Stap 1 - Aan Verzoeken worden - {#step1-to-requests}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Requests]**.

## Stap 1 - Aan Malplaatjes worden - {#step1-to-templates}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Templates]**.
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL My Updates]**.
...
1. Van Workfront, klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek, dan klik **[!UICONTROL Proofing]** om tot Workfront Proof toegang te hebben.

## Laatste DPV-versie {#latest-version}

**Meest recente versie**:

* Mac: 2.1.54 sinds 11-12-2025
* Windows: 2.1.54 van 12-11-2025
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Reports]**.

## Stap 1 - Getting to Dashboards - {#step1-to-dashboards}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Dashboards]**.

## Stap 1 - Aan Analyses worden onderworpen - {#step1-to-analytics}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Analytics]**.

<!-- Resource Management -->

## Stap 1 - Aan de bron komen - {#step1-to-resourcing}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Resourcing]**.

## Stap 1 - Aan het gebruiksrapport worden onderworpen - {#step1-to-utilization-report}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Resourcing]**, dan [!UICONTROL **Gebruik**] in het linkerpaneel.
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Scenarios]**.

<!-- Teams -->

## Stap 1 - Een team ophalen - {#step1-to-team}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Teams]**.
...
1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Timesheets]**.

<!-- Workfront Goals -->

## Stap 1 - Doelen - {#step1-to-goals}

1. Klik het **[!UICONTROL Main Menu]** pictogram ![ Belangrijkste Menu ](/help/_includes/assets/main-menu-icon-left-nav.png) in de upper-left hoek van Adobe Workfront, dan klik **[!UICONTROL Goals]**.
